...
class MicrosoftGraphIncidentReportRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[MicrosoftGraphIncidentReportRequestBuilderGetRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[MicrosoftGraphIncidentReportRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke function incidentReport
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
