...
microsoft_graph_incident_report_request_builder = lazy_import('msgraph.generated.admin.service_announcement.health_overviews.item.issues.item.microsoft_graph_incident_report.microsoft_graph_incident_report_request_builder')
...
class ServiceHealthIssueItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_incident_report(self) -> microsoft_graph_incident_report_request_builder.MicrosoftGraphIncidentReportRequestBuilder:
        """
        Provides operations to call the incidentReport method.
        """
        return microsoft_graph_incident_report_request_builder.MicrosoftGraphIncidentReportRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[service_health_issue.ServiceHealthIssue] = None, request_configuration: Optional[ServiceHealthIssueItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property issues in admin
        Args:
            body: The request body
