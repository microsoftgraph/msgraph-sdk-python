...
class ServiceHealthItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, service_health_id: Optional[str] = None) -> None:
        """
        Instantiates a new ServiceHealthItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            serviceHealthId: key: id of serviceHealth
        """
        ...
        url_tpl_params["serviceHealth%2Did"] = serviceHealthId
    ...
    def to_patch_request_information(self,body: Optional[service_health.ServiceHealth] = None, request_configuration: Optional[ServiceHealthItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property healthOverviews in admin
        Args:
            body: 
