...
class IssuesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[IssuesRequestBuilderGetRequestConfiguration] = None) -> Optional[service_health_issue_collection_response.ServiceHealthIssueCollectionResponse]:
        ...
        from ....models import service_health_issue_collection_response
    ...
    def to_post_request_information(self,body: Optional[service_health_issue.ServiceHealthIssue] = None, request_configuration: Optional[IssuesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to issues for admin
        Args:
            body: The request body
