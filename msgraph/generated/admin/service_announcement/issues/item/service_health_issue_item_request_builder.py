...
incident_report_request_builder = lazy_import('msgraph.generated.admin.service_announcement.issues.item.microsoft_graph_incident_report.incident_report_request_builder')
