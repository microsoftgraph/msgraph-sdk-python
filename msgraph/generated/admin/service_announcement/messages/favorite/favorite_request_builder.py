...
class FavoriteRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[FavoritePostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[FavoritePostResponse]:
        """
    ...
    def to_post_request_information(self,body: Optional[FavoritePostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Change the status of a list of serviceUpdateMessages to favorite for the signed in user.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> FavoriteRequestBuilder:
        """
