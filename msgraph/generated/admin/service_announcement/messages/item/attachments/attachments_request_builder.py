...
class AttachmentsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[service_announcement_attachment.ServiceAnnouncementAttachment] = None, request_configuration: Optional[AttachmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
