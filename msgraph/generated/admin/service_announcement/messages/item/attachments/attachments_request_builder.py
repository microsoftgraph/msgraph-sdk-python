...
class AttachmentsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ServiceAnnouncementAttachmentCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[ServiceAnnouncementAttachment] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ServiceAnnouncementAttachment]:
        """
    ...
    def to_post_request_information(self,body: Optional[ServiceAnnouncementAttachment] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to attachments for admin
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
