...
class AppCatalogsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AppCatalogs]:
        """
        Get appCatalogs
    ...
    async def patch(self,body: Optional[AppCatalogs] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[AppCatalogs]:
        """
        Update appCatalogs
    ...
    def to_patch_request_information(self,body: Optional[AppCatalogs] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update appCatalogs
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
