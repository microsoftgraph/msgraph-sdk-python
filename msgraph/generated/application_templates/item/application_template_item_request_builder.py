...
from ...models import application_template
from ...models.o_data_errors import o_data_error
from .instantiate import instantiate_request_builder
...
class ApplicationTemplateItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[ApplicationTemplateItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ApplicationTemplateItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[application_template.ApplicationTemplate] = None, request_configuration: Optional[ApplicationTemplateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class ApplicationTemplateItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
