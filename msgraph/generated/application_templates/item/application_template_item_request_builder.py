...
microsoft_graph_instantiate_request_builder = lazy_import('msgraph.generated.application_templates.item.microsoft_graph_instantiate.microsoft_graph_instantiate_request_builder')
...
class ApplicationTemplateItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_instantiate(self) -> microsoft_graph_instantiate_request_builder.MicrosoftGraphInstantiateRequestBuilder:
        """
        Provides operations to call the instantiate method.
        """
        return microsoft_graph_instantiate_request_builder.MicrosoftGraphInstantiateRequestBuilder(self.request_adapter, self.path_parameters)
