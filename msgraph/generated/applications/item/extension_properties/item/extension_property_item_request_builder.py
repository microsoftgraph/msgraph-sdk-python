...
class ExtensionPropertyItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, extension_property_id: Optional[str] = None) -> None:
        """
        ...
        url_tpl_params["extensionProperty%2Did"] = extensionPropertyId
