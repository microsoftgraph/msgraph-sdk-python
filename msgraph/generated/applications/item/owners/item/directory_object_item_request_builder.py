...
app_role_assignment_request_builder = lazy_import('msgraph.generated.applications.item.owners.item.microsoft_graph_app_role_assignment.app_role_assignment_request_builder')
endpoint_request_builder = lazy_import('msgraph.generated.applications.item.owners.item.microsoft_graph_endpoint.endpoint_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.applications.item.owners.item.microsoft_graph_service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.applications.item.owners.item.microsoft_graph_user.user_request_builder')
