...
app_role_assignment_request_builder = lazy_import('msgraph.generated.applications.item.owners.item.app_role_assignment.app_role_assignment_request_builder')
endpoint_request_builder = lazy_import('msgraph.generated.applications.item.owners.item.endpoint.endpoint_request_builder')
ref_request_builder = lazy_import('msgraph.generated.applications.item.owners.item.ref.ref_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.applications.item.owners.item.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.applications.item.owners.item.user.user_request_builder')
