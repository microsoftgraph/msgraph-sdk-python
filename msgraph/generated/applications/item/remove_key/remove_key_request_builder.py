...
remove_key_post_request_body = lazy_import('msgraph.generated.applications.item.remove_key.remove_key_post_request_body')
...
class RemoveKeyRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/applications/{application%2Did}/removeKey"
