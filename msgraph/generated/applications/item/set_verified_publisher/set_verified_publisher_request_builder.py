...
class SetVerifiedPublisherRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> SetVerifiedPublisherRequestBuilder:
        """
    ...
    @dataclass
    class SetVerifiedPublisherRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
