...
count_request_builder = lazy_import('msgraph.generated.applications.item.token_lifetime_policies.count.count_request_builder')
ref_request_builder = lazy_import('msgraph.generated.applications.item.token_lifetime_policies.ref.ref_request_builder')
