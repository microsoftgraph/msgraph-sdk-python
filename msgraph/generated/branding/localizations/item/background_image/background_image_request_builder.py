...
class BackgroundImageRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/branding/localizations/{organizationalBrandingLocalization%2Did}/backgroundImage"
    ...
    async def put(self,body: bytes, request_configuration: Optional[BackgroundImageRequestBuilderPutRequestConfiguration] = None) -> None:
        """
        Image that appears as the background of the sign-in page. The allowed types are PNG or JPEG not smaller than 300 KB and not larger than 1920 × 1080 pixels. A smaller image will reduce bandwidth requirements and make the page load faster.
        Args:
