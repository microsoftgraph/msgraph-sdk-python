...
count_request_builder = lazy_import('msgraph.generated.certificate_based_auth_configuration.count.count_request_builder')
certificate_based_auth_configuration = lazy_import('msgraph.generated.models.certificate_based_auth_configuration')
certificate_based_auth_configuration_collection_response = lazy_import('msgraph.generated.models.certificate_based_auth_configuration_collection_response')
...
class CertificateBasedAuthConfigurationRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[certificate_based_auth_configuration.CertificateBasedAuthConfiguration] = None, request_configuration: Optional[CertificateBasedAuthConfigurationRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
