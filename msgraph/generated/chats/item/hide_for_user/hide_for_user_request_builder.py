...
hide_for_user_post_request_body = lazy_import('msgraph.generated.chats.item.hide_for_user.hide_for_user_post_request_body')
...
class HideForUserRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/chats/{chat%2Did}/hideForUser"
