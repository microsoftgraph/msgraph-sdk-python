...
class LastMessagePreviewRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/chats/{chat%2Did}/lastMessagePreview{?%24select,%24expand}", path_parameters)
    ...
    class LastMessagePreviewRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[LastMessagePreviewRequestBuilderGetQueryParameters] = None
