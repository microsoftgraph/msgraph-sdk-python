...
class GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, from_date_time: Optional[datetime] = None, to_date_time: Optional[datetime] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/communications/callRecords/microsoft.graph.callRecords.getPstnCalls(fromDateTime={fromDateTime},toDateTime={toDateTime}){?%24top,%24skip,%24search,%24filter,%24count}"
    ...
    class GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilder.GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilderGetQueryParameters] = None
