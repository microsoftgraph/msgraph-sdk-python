...
if TYPE_CHECKING:
    from .....models.call_records.participant import Participant
    from .....models.call_records.participant_collection_response import ParticipantCollectionResponse
    from .....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.participant_item_request_builder import ParticipantItemRequestBuilder

class Participants_v2RequestBuilder(BaseRequestBuilder):
    """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[Participants_v2RequestBuilderGetQueryParameters]] = None) -> Optional[ParticipantCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[Participants_v2RequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get the list of participant objects associated with a callRecord.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/communications/callRecords/{callRecord%2Did}/participants_v2{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: Participant, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/communications/callRecords/{callRecord%2Did}/participants_v2', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> Participants_v2RequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: Participants_v2RequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return Participants_v2RequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class Participants_v2RequestBuilderGetRequestConfiguration(RequestConfiguration[Participants_v2RequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class Participants_v2RequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
