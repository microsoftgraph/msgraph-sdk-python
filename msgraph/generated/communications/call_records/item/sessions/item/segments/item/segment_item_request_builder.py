...
class SegmentItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[SegmentItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[segment.Segment] = None, request_configuration: Optional[SegmentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property segments in communications
        Args:
            body: The request body
