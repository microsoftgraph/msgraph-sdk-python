...
segments_request_builder = lazy_import('msgraph.generated.communications.call_records.item.sessions.item.segments.segments_request_builder')
segment_item_request_builder = lazy_import('msgraph.generated.communications.call_records.item.sessions.item.segments.item.segment_item_request_builder')
...
class SessionItemRequestBuilder():
    ...
    def segments(self) -> segments_request_builder.SegmentsRequestBuilder:
        ...
        """
        return segments_request_builder.SegmentsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/communications/callRecords/{callRecord%2Did}/sessions/{session%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[SessionItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[SessionItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[session.Session] = None, request_configuration: Optional[SessionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
