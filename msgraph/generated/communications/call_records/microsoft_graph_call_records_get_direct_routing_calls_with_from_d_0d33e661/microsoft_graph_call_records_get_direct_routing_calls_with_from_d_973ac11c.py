...
class MicrosoftGraphCallRecordsGetDirectRoutingCallsWithFromD_973ac11c(BaseRequestBuilder):
    """
    Provides operations to call the getDirectRoutingCalls method. Original name: MicrosoftGraphCallRecordsGetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], from_date_time: Optional[datetime.datetime] = None, to_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphCallRecordsGetDirectRoutingCallsWithFromD_973ac11c and sets the default values.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphCallRecordsGetDirectRoutingCallsWithFromD_973ac11c:
        """
        ...
        return MicrosoftGraphCallRecordsGetDirectRoutingCallsWithFromD_973ac11c(self.request_adapter, raw_url)
