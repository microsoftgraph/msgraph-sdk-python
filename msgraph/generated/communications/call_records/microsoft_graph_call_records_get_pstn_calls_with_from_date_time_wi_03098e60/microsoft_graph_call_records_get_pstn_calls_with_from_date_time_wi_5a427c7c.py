...
class MicrosoftGraphCallRecordsGetPstnCallsWithFromDateTimeWi_5a427c7c(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], from_date_time: Optional[datetime.datetime] = None, to_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphCallRecordsGetPstnCallsWithFromDateTimeWi_5a427c7c and sets the default values.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphCallRecordsGetPstnCallsWithFromDateTimeWi_5a427c7c:
        """
        ...
        return MicrosoftGraphCallRecordsGetPstnCallsWithFromDateTimeWi_5a427c7c(self.request_adapter, raw_url)
