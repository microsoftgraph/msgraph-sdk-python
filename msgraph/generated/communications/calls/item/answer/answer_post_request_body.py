...
class AnswerPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "accepted_modalities": lambda n : setattr(self, 'accepted_modalities', n.get_collection_of_enum_values(Modality)),
            "call_options": lambda n : setattr(self, 'call_options', n.get_object_value(IncomingCallOptions)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_enum_values("accepted_modalities", self.accepted_modalities)
        ...
        writer.write_int_value("participant_capacity", self.participant_capacity)
