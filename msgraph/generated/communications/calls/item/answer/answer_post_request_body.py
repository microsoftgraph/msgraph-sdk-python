...
if TYPE_CHECKING:
    ...
    from .answer_post_request_body_accepted_modalities import AnswerPostRequestBody_acceptedModalities
...
class AnswerPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    accepted_modalities: Optional[List[AnswerPostRequestBody_acceptedModalities]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "acceptedModalities": lambda n : setattr(self, 'accepted_modalities', n.get_collection_of_enum_values(AnswerPostRequestBody_acceptedModalities)),
