...
stop_hold_music_post_request_body = lazy_import('msgraph.generated.communications.calls.item.participants.item.microsoft_graph_stop_hold_music.stop_hold_music_post_request_body')
