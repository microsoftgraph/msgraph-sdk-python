...
microsoft_graph_invite_request_builder = lazy_import('msgraph.generated.communications.calls.item.participants.microsoft_graph_invite.microsoft_graph_invite_request_builder')
...
class ParticipantsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/communications/calls/{call%2Did}/participants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def to_post_request_information(self,body: Optional[participant.Participant] = None, request_configuration: Optional[ParticipantsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to participants for communications
        Args:
            body: The request body
    ...
    @dataclass
    class ParticipantsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
