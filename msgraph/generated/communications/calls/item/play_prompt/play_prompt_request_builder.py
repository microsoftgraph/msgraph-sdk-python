...
class PlayPromptRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: PlayPromptPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PlayPromptOperation]:
        """
    ...
    def to_post_request_information(self,body: PlayPromptPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Play a prompt in the call. For more information about how to handle operations, see commsOperation
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> PlayPromptRequestBuilder:
        """
    ...
    @dataclass
    class PlayPromptRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
