...
class RepliesRequestBuilder(BaseRequestBuilder):
    ...
    def by_engagement_conversation_message_id1(self,engagement_conversation_message_id1: str) -> EngagementConversationMessageItemRequestBuilder:
        """
        Provides operations to manage the replies property of the microsoft.graph.engagementConversationMessage entity.
        param engagement_conversation_message_id1: The unique identifier of engagementConversationMessage
        Returns: EngagementConversationMessageItemRequestBuilder
        """
        if engagement_conversation_message_id1 is None:
            raise TypeError("engagement_conversation_message_id1 cannot be null.")
        from .item.engagement_conversation_message_item_request_builder import EngagementConversationMessageItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["engagementConversationMessage%2Did1"] = engagement_conversation_message_id1
        return EngagementConversationMessageItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[RepliesRequestBuilderGetQueryParameters]] = None) -> Optional[EngagementConversationMessageCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[RepliesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/messages/{engagementConversationMessage%2Did}/replies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: EngagementConversationMessage, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/communications/onlineMeetingConversations/{onlineMeetingEngagementConversation%2Did}/messages/{engagementConversationMessage%2Did}/replies', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
