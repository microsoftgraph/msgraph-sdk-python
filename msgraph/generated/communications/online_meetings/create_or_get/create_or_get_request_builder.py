...
create_or_get_post_request_body = lazy_import('msgraph.generated.communications.online_meetings.create_or_get.create_or_get_post_request_body')
...
class CreateOrGetRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/communications/onlineMeetings/createOrGet"
