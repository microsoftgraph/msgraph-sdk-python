...
attendance_records_request_builder = lazy_import('msgraph.generated.communications.online_meetings.item.attendance_reports.item.attendance_records.attendance_records_request_builder')
attendance_record_item_request_builder = lazy_import('msgraph.generated.communications.online_meetings.item.attendance_reports.item.attendance_records.item.attendance_record_item_request_builder')
...
class MeetingAttendanceReportItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, meeting_attendance_report_id: Optional[str] = None) -> None:
        """
        Instantiates a new MeetingAttendanceReportItemRequestBuilder and sets the default values.
        Args:
            meetingAttendanceReportId: key: id of meetingAttendanceReport
        ...
        self.url_template: str = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/{meetingAttendanceReport%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["meetingAttendanceReport%2Did"] = meetingAttendanceReportId
