...
class PresencesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[PresencesRequestBuilderGetRequestConfiguration] = None) -> Optional[presence_collection_response.PresenceCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, presence_collection_response.PresenceCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[presence.Presence] = None, request_configuration: Optional[PresencesRequestBuilderPostRequestConfiguration] = None) -> Optional[presence.Presence]:
        """
