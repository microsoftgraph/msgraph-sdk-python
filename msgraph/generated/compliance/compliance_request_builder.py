...
compliance = lazy_import('msgraph.generated.models.compliance')
...
class ComplianceRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/compliance{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[ComplianceRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get compliance
        Args:
    ...
    def create_patch_request_information(self,body: Optional[compliance.Compliance] = None, request_configuration: Optional[ComplianceRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update compliance
        Args:
            body: 
    ...
    @dataclass
    class ComplianceRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
