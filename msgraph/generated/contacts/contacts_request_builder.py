...
delta_request_builder = lazy_import('msgraph.generated.contacts.delta.delta_request_builder')
get_available_extension_properties_request_builder = lazy_import('msgraph.generated.contacts.get_available_extension_properties.get_available_extension_properties_request_builder')
get_by_ids_request_builder = lazy_import('msgraph.generated.contacts.get_by_ids.get_by_ids_request_builder')
validate_properties_request_builder = lazy_import('msgraph.generated.contacts.validate_properties.validate_properties_request_builder')
...
class ContactsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[org_contact.OrgContact] = None, request_configuration: Optional[ContactsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
