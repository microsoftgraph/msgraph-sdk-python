...
check_member_groups_post_request_body = lazy_import('msgraph.generated.contracts.item.microsoft_graph_check_member_groups.check_member_groups_post_request_body')
check_member_groups_response = lazy_import('msgraph.generated.contracts.item.microsoft_graph_check_member_groups.check_member_groups_response')
