...
class DataPolicyOperationItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[DataPolicyOperationItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[DataPolicyOperationItemRequestBuilderGetRequestConfiguration] = None) -> Optional[data_policy_operation.DataPolicyOperation]:
        """
