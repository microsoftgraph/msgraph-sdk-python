...
microsoft_graph_target_apps_request_builder = lazy_import('msgraph.generated.device_app_management.managed_app_policies.item.microsoft_graph_target_apps.microsoft_graph_target_apps_request_builder')
...
class ManagedAppPolicyItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceAppManagement/managedAppPolicies/{managedAppPolicy%2Did}{?%24select,%24expand}"
    ...
    def to_patch_request_information(self,body: Optional[managed_app_policy.ManagedAppPolicy] = None, request_configuration: Optional[ManagedAppPolicyItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property managedAppPolicies in deviceAppManagement
        Args:
            body: The request body
