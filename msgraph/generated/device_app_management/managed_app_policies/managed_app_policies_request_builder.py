...
class ManagedAppPoliciesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[managed_app_policy.ManagedAppPolicy] = None, request_configuration: Optional[ManagedAppPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to managedAppPolicies for deviceAppManagement
        Args:
            body: The request body
