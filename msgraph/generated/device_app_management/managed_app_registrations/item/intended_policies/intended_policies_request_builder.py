...
class IntendedPoliciesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[IntendedPoliciesRequestBuilderGetRequestConfiguration] = None) -> Optional[managed_app_policy_collection_response.ManagedAppPolicyCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[managed_app_policy.ManagedAppPolicy] = None, request_configuration: Optional[IntendedPoliciesRequestBuilderPostRequestConfiguration] = None) -> Optional[managed_app_policy.ManagedAppPolicy]:
        """
    ...
    def to_post_request_information(self,body: Optional[managed_app_policy.ManagedAppPolicy] = None, request_configuration: Optional[IntendedPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to intendedPolicies for deviceAppManagement
        Args:
            body: The request body
