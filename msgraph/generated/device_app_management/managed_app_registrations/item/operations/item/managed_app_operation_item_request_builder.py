...
class ManagedAppOperationItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[ManagedAppOperationItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[ManagedAppOperationItemRequestBuilderGetRequestConfiguration] = None) -> Optional[managed_app_operation.ManagedAppOperation]:
        """
    ...
    async def patch(self,body: Optional[managed_app_operation.ManagedAppOperation] = None, request_configuration: Optional[ManagedAppOperationItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[managed_app_operation.ManagedAppOperation]:
        """
