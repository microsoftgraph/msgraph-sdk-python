...
class UserStateSummaryRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[user_install_state_summary.UserInstallStateSummary] = None, request_configuration: Optional[UserStateSummaryRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to userStateSummary for deviceAppManagement
        Args:
            body: The request body
