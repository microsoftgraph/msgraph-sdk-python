...
count_request_builder = lazy_import('msgraph.generated.device_app_management.managed_e_books.item.user_state_summary.count.count_request_builder')
user_install_state_summary = lazy_import('msgraph.generated.models.user_install_state_summary')
user_install_state_summary_collection_response = lazy_import('msgraph.generated.models.user_install_state_summary_collection_response')
...
class UserStateSummaryRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/userStateSummary{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[UserStateSummaryRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[user_install_state_summary.UserInstallStateSummary] = None, request_configuration: Optional[UserStateSummaryRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class UserStateSummaryRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
