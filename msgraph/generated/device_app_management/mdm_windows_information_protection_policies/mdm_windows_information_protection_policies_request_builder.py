...
class MdmWindowsInformationProtectionPoliciesRequestBuilder(BaseRequestBuilder):
    ...
    def by_mdm_windows_information_protection_policy_id(self,mdm_windows_information_protection_policy_id: str) -> MdmWindowsInformationProtectionPolicyItemRequestBuilder:
        ...
        Provides operations to manage the mdmWindowsInformationProtectionPolicies property of the microsoft.graph.deviceAppManagement entity.
        Args:
            mdm_windows_information_protection_policy_id: The unique identifier of mdmWindowsInformationProtectionPolicy
    ...
    class MdmWindowsInformationProtectionPoliciesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[MdmWindowsInformationProtectionPoliciesRequestBuilderGetQueryParameters] = None
