...
count_request_builder = lazy_import('msgraph.generated.device_app_management.mobile_app_categories.count.count_request_builder')
mobile_app_category = lazy_import('msgraph.generated.models.mobile_app_category')
mobile_app_category_collection_response = lazy_import('msgraph.generated.models.mobile_app_category_collection_response')
...
class MobileAppCategoriesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[MobileAppCategoriesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[mobile_app_category.MobileAppCategory] = None, request_configuration: Optional[MobileAppCategoriesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
