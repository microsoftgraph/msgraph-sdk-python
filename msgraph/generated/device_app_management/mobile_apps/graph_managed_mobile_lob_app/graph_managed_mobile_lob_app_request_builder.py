...
count_request_builder = lazy_import('msgraph.generated.device_app_management.mobile_apps.graph_managed_mobile_lob_app.count.count_request_builder')
managed_mobile_lob_app_collection_response = lazy_import('msgraph.generated.models.managed_mobile_lob_app_collection_response')
...
class GraphManagedMobileLobAppRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceAppManagement/mobileApps/graph.managedMobileLobApp{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
