...
if TYPE_CHECKING:
    from ....models.microsoft_store_for_business_app_collection_response import MicrosoftStoreForBusinessAppCollectionResponse
...
class GraphMicrosoftStoreForBusinessAppRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.microsoftStoreForBusinessApp{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    async def get(self,request_configuration: Optional[GraphMicrosoftStoreForBusinessAppRequestBuilderGetRequestConfiguration] = None) -> Optional[MicrosoftStoreForBusinessAppCollectionResponse]:
        """
        ...
        Returns: Optional[MicrosoftStoreForBusinessAppCollectionResponse]
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GraphMicrosoftStoreForBusinessAppRequestBuilder:
        ...
        return GraphMicrosoftStoreForBusinessAppRequestBuilder(raw_url, self.request_adapter)
