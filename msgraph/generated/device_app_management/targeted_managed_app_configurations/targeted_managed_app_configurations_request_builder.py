...
count_request_builder = lazy_import('msgraph.generated.device_app_management.targeted_managed_app_configurations.count.count_request_builder')
targeted_managed_app_configuration = lazy_import('msgraph.generated.models.targeted_managed_app_configuration')
targeted_managed_app_configuration_collection_response = lazy_import('msgraph.generated.models.targeted_managed_app_configuration_collection_response')
...
class TargetedManagedAppConfigurationsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[TargetedManagedAppConfigurationsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[targeted_managed_app_configuration.TargetedManagedAppConfiguration] = None, request_configuration: Optional[TargetedManagedAppConfigurationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class TargetedManagedAppConfigurationsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
