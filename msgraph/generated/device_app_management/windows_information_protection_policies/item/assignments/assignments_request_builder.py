...
class AssignmentsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy%2Did}/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_targeted_managed_app_policy_assignment_id(self,targeted_managed_app_policy_assignment_id: str) -> TargetedManagedAppPolicyAssignmentItemRequestBuilder:
        ...
        Provides operations to manage the assignments property of the microsoft.graph.windowsInformationProtection entity.
        Args:
            targeted_managed_app_policy_assignment_id: The unique identifier of targetedManagedAppPolicyAssignment
