...
count_request_builder = lazy_import('msgraph.generated.device_app_management.windows_information_protection_policies.count.count_request_builder')
windows_information_protection_policy = lazy_import('msgraph.generated.models.windows_information_protection_policy')
windows_information_protection_policy_collection_response = lazy_import('msgraph.generated.models.windows_information_protection_policy_collection_response')
...
class WindowsInformationProtectionPoliciesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[WindowsInformationProtectionPoliciesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[windows_information_protection_policy.WindowsInformationProtectionPolicy] = None, request_configuration: Optional[WindowsInformationProtectionPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
