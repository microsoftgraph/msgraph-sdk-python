...
if TYPE_CHECKING:
    from ...models import windows_information_protection_policy, windows_information_protection_policy_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import windows_information_protection_policy_item_request_builder

class WindowsInformationProtectionPoliciesRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceAppManagement/windowsInformationProtectionPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_windows_information_protection_policy_id(self,windows_information_protection_policy_id: str) -> windows_information_protection_policy_item_request_builder.WindowsInformationProtectionPolicyItemRequestBuilder:
        """
        Provides operations to manage the windowsInformationProtectionPolicies property of the microsoft.graph.deviceAppManagement entity.
        Args:
        ...
        if windows_information_protection_policy_id is None:
            raise Exception("windows_information_protection_policy_id cannot be undefined")
        from .item import windows_information_protection_policy_item_request_builder
    ...
    async def get(self,request_configuration: Optional[WindowsInformationProtectionPoliciesRequestBuilderGetRequestConfiguration] = None) -> Optional[windows_information_protection_policy_collection_response.WindowsInformationProtectionPolicyCollectionResponse]:
        ...
        from ...models import windows_information_protection_policy_collection_response
    ...
    def to_post_request_information(self,body: Optional[windows_information_protection_policy.WindowsInformationProtectionPolicy] = None, request_configuration: Optional[WindowsInformationProtectionPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to windowsInformationProtectionPolicies for deviceAppManagement
        Args:
            body: The request body
    ...
    @dataclass
    class WindowsInformationProtectionPoliciesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
