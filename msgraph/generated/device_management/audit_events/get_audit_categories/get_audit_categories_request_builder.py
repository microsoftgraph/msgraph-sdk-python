...
class GetAuditCategoriesRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetAuditCategoriesRequestBuilder:
        """
    ...
    @dataclass
    class GetAuditCategoriesRequestBuilderGetRequestConfiguration(RequestConfiguration[GetAuditCategoriesRequestBuilderGetQueryParameters]):
        """
