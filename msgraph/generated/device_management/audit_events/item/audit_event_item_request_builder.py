...
class AuditEventItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[AuditEventItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[AuditEventItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        The Audit Events
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def create_patch_request_information(self,body: Optional[audit_event.AuditEvent] = None, request_configuration: Optional[AuditEventItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class AuditEventItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class AuditEventItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
