...
count_request_builder = lazy_import('msgraph.generated.device_management.compliance_management_partners.count.count_request_builder')
compliance_management_partner = lazy_import('msgraph.generated.models.compliance_management_partner')
compliance_management_partner_collection_response = lazy_import('msgraph.generated.models.compliance_management_partner_collection_response')
...
class ComplianceManagementPartnersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/complianceManagementPartners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[ComplianceManagementPartnersRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[compliance_management_partner.ComplianceManagementPartner] = None, request_configuration: Optional[ComplianceManagementPartnersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class ComplianceManagementPartnersRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class ComplianceManagementPartnersRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
