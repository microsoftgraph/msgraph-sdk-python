...
if TYPE_CHECKING:
    ...
    from .item import device_compliance_device_status_item_request_builder
...
class DeviceStatusesRequestBuilder():
    ...
    def by_device_compliance_device_status_id(self,device_compliance_device_status_id: str) -> device_compliance_device_status_item_request_builder.DeviceComplianceDeviceStatusItemRequestBuilder:
        """
        Provides operations to manage the deviceStatuses property of the microsoft.graph.deviceCompliancePolicy entity.
        Args:
        ...
        if device_compliance_device_status_id is None:
            raise Exception("device_compliance_device_status_id cannot be undefined")
        from .item import device_compliance_device_status_item_request_builder
    ...
    async def get(self,request_configuration: Optional[DeviceStatusesRequestBuilderGetRequestConfiguration] = None) -> Optional[device_compliance_device_status_collection_response.DeviceComplianceDeviceStatusCollectionResponse]:
        ...
        from .....models import device_compliance_device_status_collection_response
    ...
    def to_post_request_information(self,body: Optional[device_compliance_device_status.DeviceComplianceDeviceStatus] = None, request_configuration: Optional[DeviceStatusesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to deviceStatuses for deviceManagement
        Args:
            body: The request body
