...
class DeviceComplianceUserStatusItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_compliance_user_status_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceComplianceUserStatusItemRequestBuilder and sets the default values.
        Args:
            deviceComplianceUserStatusId: key: id of deviceComplianceUserStatus
        ...
        url_tpl_params["deviceComplianceUserStatus%2Did"] = deviceComplianceUserStatusId
    ...
    def to_patch_request_information(self,body: Optional[device_compliance_user_status.DeviceComplianceUserStatus] = None, request_configuration: Optional[DeviceComplianceUserStatusItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property userStatuses in deviceManagement
        Args:
            body: The request body
