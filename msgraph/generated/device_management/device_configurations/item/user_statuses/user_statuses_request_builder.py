...
class UserStatusesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/userStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_device_configuration_user_status_id(self,device_configuration_user_status_id: str) -> DeviceConfigurationUserStatusItemRequestBuilder:
        ...
        Provides operations to manage the userStatuses property of the microsoft.graph.deviceConfiguration entity.
        Args:
            device_configuration_user_status_id: The unique identifier of deviceConfigurationUserStatus
    ...
    class UserStatusesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[UserStatusesRequestBuilderGetQueryParameters] = None
