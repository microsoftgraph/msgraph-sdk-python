...
if TYPE_CHECKING:
    ...
    from .get_effective_permissions_with_scope_response import GetEffectivePermissionsWithScopeResponse
...
class GetEffectivePermissionsWithScopeRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[GetEffectivePermissionsWithScopeRequestBuilderGetRequestConfiguration] = None) -> Optional[GetEffectivePermissionsWithScopeResponse]:
        ...
        return await self.request_adapter.send_async(request_info, GetEffectivePermissionsWithScopeResponse, error_mapping)
