...
class ImportRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[ImportPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ImportPostResponse]:
        """
        Not yet documented
    ...
    def to_post_request_information(self,body: Optional[ImportPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Not yet documented
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
