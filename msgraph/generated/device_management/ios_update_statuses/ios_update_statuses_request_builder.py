...
class IosUpdateStatusesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[ios_update_device_status.IosUpdateDeviceStatus] = None, request_configuration: Optional[IosUpdateStatusesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to iosUpdateStatuses for deviceManagement
        Args:
            body: The request body
