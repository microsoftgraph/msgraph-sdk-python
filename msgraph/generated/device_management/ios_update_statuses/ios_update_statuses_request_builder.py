...
count_request_builder = lazy_import('msgraph.generated.device_management.ios_update_statuses.count.count_request_builder')
ios_update_device_status = lazy_import('msgraph.generated.models.ios_update_device_status')
ios_update_device_status_collection_response = lazy_import('msgraph.generated.models.ios_update_device_status_collection_response')
...
class IosUpdateStatusesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/iosUpdateStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[IosUpdateStatusesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[ios_update_device_status.IosUpdateDeviceStatus] = None, request_configuration: Optional[IosUpdateStatusesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class IosUpdateStatusesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
