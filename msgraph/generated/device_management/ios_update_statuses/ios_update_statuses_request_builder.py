...
class IosUpdateStatusesRequestBuilder(BaseRequestBuilder):
    ...
    def by_ios_update_device_status_id(self,ios_update_device_status_id: str) -> IosUpdateDeviceStatusItemRequestBuilder:
        ...
        Provides operations to manage the iosUpdateStatuses property of the microsoft.graph.deviceManagement entity.
        Args:
            ios_update_device_status_id: The unique identifier of iosUpdateDeviceStatus
    ...
    class IosUpdateStatusesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[IosUpdateStatusesRequestBuilderGetQueryParameters] = None
