...
class IosUpdateDeviceStatusItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[IosUpdateDeviceStatusItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[IosUpdateDeviceStatusItemRequestBuilderGetRequestConfiguration] = None) -> Optional[ios_update_device_status.IosUpdateDeviceStatus]:
        """
    ...
    async def patch(self,body: Optional[ios_update_device_status.IosUpdateDeviceStatus] = None, request_configuration: Optional[IosUpdateDeviceStatusItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[ios_update_device_status.IosUpdateDeviceStatus]:
        """
    ...
    def to_patch_request_information(self,body: Optional[ios_update_device_status.IosUpdateDeviceStatus] = None, request_configuration: Optional[IosUpdateDeviceStatusItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property iosUpdateStatuses in deviceManagement
        Args:
            body: The request body
