...
class DeviceCompliancePolicyStatesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/deviceCompliancePolicyStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_device_compliance_policy_state_id(self,device_compliance_policy_state_id: str) -> DeviceCompliancePolicyStateItemRequestBuilder:
        ...
        Provides operations to manage the deviceCompliancePolicyStates property of the microsoft.graph.managedDevice entity.
        Args:
            device_compliance_policy_state_id: The unique identifier of deviceCompliancePolicyState
    ...
    class DeviceCompliancePolicyStatesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[DeviceCompliancePolicyStatesRequestBuilderGetQueryParameters] = None
