...
class LocalizedNotificationMessageItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[LocalizedNotificationMessageItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    @dataclass
    class LocalizedNotificationMessageItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
