...
count_request_builder = lazy_import('msgraph.generated.device_management.notification_message_templates.item.localized_notification_messages.count.count_request_builder')
localized_notification_message = lazy_import('msgraph.generated.models.localized_notification_message')
localized_notification_message_collection_response = lazy_import('msgraph.generated.models.localized_notification_message_collection_response')
...
class LocalizedNotificationMessagesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[LocalizedNotificationMessagesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[localized_notification_message.LocalizedNotificationMessage] = None, request_configuration: Optional[LocalizedNotificationMessagesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
