...
class LocalizedNotificationMessagesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/notificationMessageTemplates/{notificationMessageTemplate%2Did}/localizedNotificationMessages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def by_localized_notification_message_id(self,localized_notification_message_id: str) -> LocalizedNotificationMessageItemRequestBuilder:
        """
        Provides operations to manage the localizedNotificationMessages property of the microsoft.graph.notificationMessageTemplate entity.
        param localized_notification_message_id: The unique identifier of localizedNotificationMessage
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[LocalizedNotificationMessageCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[LocalizedNotificationMessage] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[LocalizedNotificationMessage]:
        """
    ...
    def to_post_request_information(self,body: Optional[LocalizedNotificationMessage] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create a new localizedNotificationMessage object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/deviceManagement/notificationMessageTemplates/{notificationMessageTemplate%2Did}/localizedNotificationMessages', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: Optional[str] = None) -> LocalizedNotificationMessagesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: LocalizedNotificationMessagesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return LocalizedNotificationMessagesRequestBuilder(self.request_adapter, raw_url)
