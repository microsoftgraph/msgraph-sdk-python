...
microsoft_graph_send_test_message_request_builder = lazy_import('msgraph.generated.device_management.notification_message_templates.item.microsoft_graph_send_test_message.microsoft_graph_send_test_message_request_builder')
...
class NotificationMessageTemplateItemRequestBuilder():
    ...
    @property
    def microsoft_graph_send_test_message(self) -> microsoft_graph_send_test_message_request_builder.MicrosoftGraphSendTestMessageRequestBuilder:
        """
        Provides operations to call the sendTestMessage method.
        """
        return microsoft_graph_send_test_message_request_builder.MicrosoftGraphSendTestMessageRequestBuilder(self.request_adapter, self.path_parameters)
