...
class RemoteAssistancePartnerItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[RemoteAssistancePartner]:
        """
    ...
    async def patch(self,body: Optional[RemoteAssistancePartner] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[RemoteAssistancePartner]:
        """
    ...
    def to_patch_request_information(self,body: Optional[RemoteAssistancePartner] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the properties of a remoteAssistancePartner object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
