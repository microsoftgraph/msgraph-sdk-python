...
count_request_builder = lazy_import('msgraph.generated.device_management.remote_assistance_partners.count.count_request_builder')
remote_assistance_partner = lazy_import('msgraph.generated.models.remote_assistance_partner')
remote_assistance_partner_collection_response = lazy_import('msgraph.generated.models.remote_assistance_partner_collection_response')
...
class RemoteAssistancePartnersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/remoteAssistancePartners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[RemoteAssistancePartnersRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[remote_assistance_partner.RemoteAssistancePartner] = None, request_configuration: Optional[RemoteAssistancePartnersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class RemoteAssistancePartnersRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
