...
@dataclass
class GetDeviceManagementIntentPerSettingContributingProfiles_8b73545b(AdditionalDataHolder, BackedModel, Parsable):
    """
    Original name: GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetDeviceManagementIntentPerSettingContributingProfiles_8b73545b:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: GetDeviceManagementIntentPerSettingContributingProfiles_8b73545b
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return GetDeviceManagementIntentPerSettingContributingProfiles_8b73545b()
