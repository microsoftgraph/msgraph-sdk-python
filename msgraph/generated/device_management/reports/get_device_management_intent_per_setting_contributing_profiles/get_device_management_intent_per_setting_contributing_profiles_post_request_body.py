...
@dataclass
class GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody:
        """
        ...
        return GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody()
