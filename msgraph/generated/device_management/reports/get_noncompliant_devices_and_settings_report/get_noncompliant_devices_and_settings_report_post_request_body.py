...
@dataclass
class GetNoncompliantDevicesAndSettingsReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetNoncompliantDevicesAndSettingsReportPostRequestBody:
        """
        ...
        return GetNoncompliantDevicesAndSettingsReportPostRequestBody()
