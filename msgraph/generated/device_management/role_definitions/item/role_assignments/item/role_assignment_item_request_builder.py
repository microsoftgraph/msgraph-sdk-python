...
class RoleAssignmentItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, role_assignment_id: Optional[str] = None) -> None:
        """
        Instantiates a new RoleAssignmentItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            roleAssignmentId: key: id of roleAssignment
        """
        ...
        url_tpl_params["roleAssignment%2Did"] = roleAssignmentId
