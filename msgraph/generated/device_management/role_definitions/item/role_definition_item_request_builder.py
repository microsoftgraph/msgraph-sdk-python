...
class RoleDefinitionItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[role_definition.RoleDefinition] = None, request_configuration: Optional[RoleDefinitionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property roleDefinitions in deviceManagement
        Args:
            body: The request body
