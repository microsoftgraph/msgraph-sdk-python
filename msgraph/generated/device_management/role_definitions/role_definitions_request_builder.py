...
if TYPE_CHECKING:
    ...
    from ...models.role_definition_collection_response import RoleDefinitionCollectionResponse
...
class RoleDefinitionsRequestBuilder(BaseRequestBuilder):
    ...
    def by_role_definition_id(self,role_definition_id: str) -> RoleDefinitionItemRequestBuilder:
        ...
        return RoleDefinitionItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[RoleDefinitionCollectionResponse]:
        """
        ...
        return await self.request_adapter.send_async(request_info, RoleDefinitionCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[RoleDefinition] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[RoleDefinition]:
        """
    ...
    def to_post_request_information(self,body: Optional[RoleDefinition] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create a new roleDefinition object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/deviceManagement/roleDefinitions', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
