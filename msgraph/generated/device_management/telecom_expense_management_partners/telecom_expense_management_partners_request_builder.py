...
count_request_builder = lazy_import('msgraph.generated.device_management.telecom_expense_management_partners.count.count_request_builder')
telecom_expense_management_partner = lazy_import('msgraph.generated.models.telecom_expense_management_partner')
telecom_expense_management_partner_collection_response = lazy_import('msgraph.generated.models.telecom_expense_management_partner_collection_response')
...
class TelecomExpenseManagementPartnersRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[TelecomExpenseManagementPartnersRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[telecom_expense_management_partner.TelecomExpenseManagementPartner] = None, request_configuration: Optional[TelecomExpenseManagementPartnersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
