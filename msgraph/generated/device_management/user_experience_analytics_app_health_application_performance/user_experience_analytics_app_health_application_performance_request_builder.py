...
class UserExperienceAnalyticsAppHealthApplicationPerformanceRequestBuilder(BaseRequestBuilder):
    ...
    def by_user_experience_analytics_app_health_application_performance_id(self,user_experience_analytics_app_health_application_performance_id: str) -> UserExperienceAnalyticsAppHealthApplicationPerformanceItemRequestBuilder:
        ...
        """
        if user_experience_analytics_app_health_application_performance_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[UserExperienceAnalyticsAppHealthApplicationPerformanceRequestBuilderGetQueryParameters]] = None) -> Optional[UserExperienceAnalyticsAppHealthApplicationPerformanceCollectionResponse]:
        """
    ...
    async def post(self,body: UserExperienceAnalyticsAppHealthApplicationPerformance, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UserExperienceAnalyticsAppHealthApplicationPerformance]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[UserExperienceAnalyticsAppHealthApplicationPerformanceRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        User experience analytics appHealth Application Performance
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: UserExperienceAnalyticsAppHealthApplicationPerformance, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to userExperienceAnalyticsAppHealthApplicationPerformance for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> UserExperienceAnalyticsAppHealthApplicationPerformanceRequestBuilder:
        """
    ...
    @dataclass
    class UserExperienceAnalyticsAppHealthApplicationPerformanceRequestBuilderGetRequestConfiguration(RequestConfiguration[UserExperienceAnalyticsAppHealthApplicationPerformanceRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class UserExperienceAnalyticsAppHealthApplicationPerformanceRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
