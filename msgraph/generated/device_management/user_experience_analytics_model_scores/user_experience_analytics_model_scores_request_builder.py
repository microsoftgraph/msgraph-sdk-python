...
class UserExperienceAnalyticsModelScoresRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsModelScores{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_user_experience_analytics_model_scores_id(self,user_experience_analytics_model_scores_id: str) -> UserExperienceAnalyticsModelScoresItemRequestBuilder:
        ...
        Provides operations to manage the userExperienceAnalyticsModelScores property of the microsoft.graph.deviceManagement entity.
        Args:
            user_experience_analytics_model_scores_id: The unique identifier of userExperienceAnalyticsModelScores
    ...
    class UserExperienceAnalyticsModelScoresRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[UserExperienceAnalyticsModelScoresRequestBuilderGetQueryParameters] = None
