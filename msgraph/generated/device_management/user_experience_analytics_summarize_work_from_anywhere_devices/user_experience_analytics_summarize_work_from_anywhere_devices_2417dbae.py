...
class UserExperienceAnalyticsSummarizeWorkFromAnywhereDevices_2417dbae(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> UserExperienceAnalyticsSummarizeWorkFromAnywhereDevices_2417dbae:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: UserExperienceAnalyticsSummarizeWorkFromAnywhereDevices_2417dbae
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return UserExperienceAnalyticsSummarizeWorkFromAnywhereDevices_2417dbae(self.request_adapter, raw_url)
