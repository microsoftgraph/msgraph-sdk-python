...
if TYPE_CHECKING:
    ...
    from .update_ad_domain_password_post_request_body import UpdateAdDomainPasswordPostRequestBody
...
class UpdateAdDomainPasswordRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> UpdateAdDomainPasswordRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: UpdateAdDomainPasswordRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return UpdateAdDomainPasswordRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class UpdateAdDomainPasswordRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
