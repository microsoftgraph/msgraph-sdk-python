...
class RetrieveCloudPcRecommendationReportsPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    report_type: Optional[CloudPcRecommendationReportType] = None
    # The search property
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "reportType": lambda n : setattr(self, 'report_type', n.get_enum_value(CloudPcRecommendationReportType)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_enum_value("reportType", self.report_type)
