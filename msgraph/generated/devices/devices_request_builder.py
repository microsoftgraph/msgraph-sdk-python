...
delta_request_builder = lazy_import('msgraph.generated.devices.delta.delta_request_builder')
get_available_extension_properties_request_builder = lazy_import('msgraph.generated.devices.get_available_extension_properties.get_available_extension_properties_request_builder')
get_by_ids_request_builder = lazy_import('msgraph.generated.devices.get_by_ids.get_by_ids_request_builder')
validate_properties_request_builder = lazy_import('msgraph.generated.devices.validate_properties.validate_properties_request_builder')
