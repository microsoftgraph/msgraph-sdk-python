...
class AdministrativeUnitItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, administrative_unit_id: Optional[str] = None) -> None:
        """
        ...
        url_tpl_params["administrativeUnit%2Did"] = administrativeUnitId
