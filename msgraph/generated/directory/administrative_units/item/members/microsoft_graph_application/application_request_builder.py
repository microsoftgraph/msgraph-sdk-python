...
count_request_builder = lazy_import('msgraph.generated.directory.administrative_units.item.members.microsoft_graph_application.count.count_request_builder')
