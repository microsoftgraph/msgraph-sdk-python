...
@dataclass
class AvailableProviderTypesGetResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[str]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AvailableProviderTypesGetResponse:
        """
