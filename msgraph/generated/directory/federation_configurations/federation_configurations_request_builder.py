...
class FederationConfigurationsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[FederationConfigurationsRequestBuilderGetQueryParameters]] = None) -> Optional[IdentityProviderBaseCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[FederationConfigurationsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Configure domain federation with organizations whose identity provider (IdP) supports either the SAML or WS-Fed protocol.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/directory/federationConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def with_url(self,raw_url: str) -> FederationConfigurationsRequestBuilder:
        """
    ...
    @dataclass
    class FederationConfigurationsRequestBuilderGetRequestConfiguration(RequestConfiguration[FederationConfigurationsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class FederationConfigurationsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
