...
class FederationConfigurationsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[identity_provider_base.IdentityProviderBase] = None, request_configuration: Optional[FederationConfigurationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to federationConfigurations for directory
        Args:
            body: The request body
