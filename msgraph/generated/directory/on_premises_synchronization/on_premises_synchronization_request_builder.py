...
count_request_builder = lazy_import('msgraph.generated.directory.on_premises_synchronization.count.count_request_builder')
on_premises_directory_synchronization = lazy_import('msgraph.generated.models.on_premises_directory_synchronization')
on_premises_directory_synchronization_collection_response = lazy_import('msgraph.generated.models.on_premises_directory_synchronization_collection_response')
...
class OnPremisesSynchronizationRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/directory/onPremisesSynchronization{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    @dataclass
    class OnPremisesSynchronizationRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
