...
if TYPE_CHECKING:
    ...
    from ....models.certificate_based_auth_pki_collection_response import CertificateBasedAuthPkiCollectionResponse
...
class CertificateBasedAuthConfigurationsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def by_certificate_based_auth_pki_id(self,certificate_based_auth_pki_id: str) -> CertificateBasedAuthPkiItemRequestBuilder:
        """
        Provides operations to manage the certificateBasedAuthConfigurations property of the microsoft.graph.publicKeyInfrastructureRoot entity.
        param certificate_based_auth_pki_id: The unique identifier of certificateBasedAuthPki
        Returns: CertificateBasedAuthPkiItemRequestBuilder
        """
        if certificate_based_auth_pki_id is None:
            raise TypeError("certificate_based_auth_pki_id cannot be null.")
        from .item.certificate_based_auth_pki_item_request_builder import CertificateBasedAuthPkiItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["certificateBasedAuthPki%2Did"] = certificate_based_auth_pki_id
        return CertificateBasedAuthPkiItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[CertificateBasedAuthConfigurationsRequestBuilderGetQueryParameters]] = None) -> Optional[CertificateBasedAuthPkiCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, CertificateBasedAuthPkiCollectionResponse, error_mapping)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CertificateBasedAuthConfigurationsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/directory/publicKeyInfrastructure/certificateBasedAuthConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: CertificateBasedAuthPki, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/directory/publicKeyInfrastructure/certificateBasedAuthConfigurations', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> CertificateBasedAuthConfigurationsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: CertificateBasedAuthConfigurationsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return CertificateBasedAuthConfigurationsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class CertificateBasedAuthConfigurationsRequestBuilderGetRequestConfiguration(RequestConfiguration[CertificateBasedAuthConfigurationsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class CertificateBasedAuthConfigurationsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
