...
if TYPE_CHECKING:
    ...
    from ......models.certificate_authority_detail_collection_response import CertificateAuthorityDetailCollectionResponse
    from ......models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.certificate_authority_detail_item_request_builder import CertificateAuthorityDetailItemRequestBuilder
...
class CertificateAuthoritiesRequestBuilder(BaseRequestBuilder):
    ...
    def by_certificate_authority_detail_id(self,certificate_authority_detail_id: str) -> CertificateAuthorityDetailItemRequestBuilder:
        """
        Provides operations to manage the certificateAuthorities property of the microsoft.graph.certificateBasedAuthPki entity.
        param certificate_authority_detail_id: The unique identifier of certificateAuthorityDetail
        Returns: CertificateAuthorityDetailItemRequestBuilder
        """
        if certificate_authority_detail_id is None:
            raise TypeError("certificate_authority_detail_id cannot be null.")
        from .item.certificate_authority_detail_item_request_builder import CertificateAuthorityDetailItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["certificateAuthorityDetail%2Did"] = certificate_authority_detail_id
        return CertificateAuthorityDetailItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[CertificateAuthoritiesRequestBuilderGetQueryParameters]] = None) -> Optional[CertificateAuthorityDetailCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, CertificateAuthorityDetailCollectionResponse, error_mapping)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CertificateAuthoritiesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki%2Did}/certificateAuthorities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: CertificateAuthorityDetail, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki%2Did}/certificateAuthorities', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> CertificateAuthoritiesRequestBuilder:
        """
    ...
    @dataclass
    class CertificateAuthoritiesRequestBuilderGetRequestConfiguration(RequestConfiguration[CertificateAuthoritiesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class CertificateAuthoritiesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
