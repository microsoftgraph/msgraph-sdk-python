...
class GovernanceRequestsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/directory/tenantGovernance/governanceRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def by_governance_request_id(self,governance_request_id: str) -> GovernanceRequestItemRequestBuilder:
        ...
        """
        if governance_request_id is None:
            raise TypeError("governance_request_id cannot be null.")
        from .item.governance_request_item_request_builder import GovernanceRequestItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["governanceRequest%2Did"] = governance_request_id
        return GovernanceRequestItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    def with_url(self,raw_url: str) -> GovernanceRequestsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GovernanceRequestsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return GovernanceRequestsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class GovernanceRequestsRequestBuilderGetRequestConfiguration(RequestConfiguration[GovernanceRequestsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class GovernanceRequestsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
