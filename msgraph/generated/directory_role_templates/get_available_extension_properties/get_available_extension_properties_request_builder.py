...
class GetAvailableExtensionPropertiesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/directoryRoleTemplates/getAvailableExtensionProperties", path_parameters)
    
    async def post(self,body: Optional[GetAvailableExtensionPropertiesPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[GetAvailableExtensionPropertiesPostResponse]:
        """
    ...
    def to_post_request_information(self,body: Optional[GetAvailableExtensionPropertiesPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Return all directory extension definitions that have been registered in a directory, including through multi-tenant apps. The following entities support extension properties:
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
