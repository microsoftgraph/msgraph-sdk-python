...
class ScopedMembersRequestBuilder():
    ...
    async def post(self,body: Optional[scoped_role_membership.ScopedRoleMembership] = None, request_configuration: Optional[ScopedMembersRequestBuilderPostRequestConfiguration] = None) -> Optional[scoped_role_membership.ScopedRoleMembership]:
        """
    ...
    def to_post_request_information(self,body: Optional[scoped_role_membership.ScopedRoleMembership] = None, request_configuration: Optional[ScopedMembersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to scopedMembers for directoryRoles
        Args:
            body: The request body
