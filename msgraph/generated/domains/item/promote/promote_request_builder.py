...
promote_response = lazy_import('msgraph.generated.domains.item.promote.promote_response')
...
class PromoteRequestBuilder():
    ...
    def create_post_request_information(self,request_configuration: Optional[PromoteRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class PromoteRequestBuilderPostRequestConfiguration():
        """
