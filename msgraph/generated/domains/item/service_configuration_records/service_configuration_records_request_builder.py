...
class ServiceConfigurationRecordsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/domains/{domain%2Did}/serviceConfigurationRecords{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[ServiceConfigurationRecordsRequestBuilderGetRequestConfiguration] = None) -> Optional[DomainDnsRecordCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[DomainDnsRecord] = None, request_configuration: Optional[ServiceConfigurationRecordsRequestBuilderPostRequestConfiguration] = None) -> Optional[DomainDnsRecord]:
        """
    ...
    def to_post_request_information(self,body: Optional[DomainDnsRecord] = None, request_configuration: Optional[ServiceConfigurationRecordsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to serviceConfigurationRecords for domains
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ServiceConfigurationRecordsRequestBuilder:
        ...
        return ServiceConfigurationRecordsRequestBuilder(raw_url, self.request_adapter)
    ...
    @dataclass
    class ServiceConfigurationRecordsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class ServiceConfigurationRecordsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
