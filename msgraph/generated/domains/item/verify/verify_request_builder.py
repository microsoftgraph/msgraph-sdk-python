...
class VerifyRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[Domain]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> VerifyRequestBuilder:
        """
