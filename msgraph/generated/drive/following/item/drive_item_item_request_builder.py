...
content_request_builder = lazy_import('msgraph.generated.drive.following.item.content.content_request_builder')
...
class DriveItemItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drive/following/{driveItem%2Did}{?%24select,%24expand}"
