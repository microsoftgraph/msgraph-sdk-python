...
class BundlesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/bundles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[BundlesRequestBuilderGetRequestConfiguration] = None) -> Optional[DriveItemCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[DriveItem] = None, request_configuration: Optional[BundlesRequestBuilderPostRequestConfiguration] = None) -> Optional[DriveItem]:
        """
    ...
    def to_post_request_information(self,body: Optional[DriveItem] = None, request_configuration: Optional[BundlesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to bundles for drives
        Args:
            body: The request body
    ...
    @dataclass
    class BundlesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[BundlesRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class BundlesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
