...
content_request_builder = lazy_import('msgraph.generated.drives.item.items.item.children.item.content.content_request_builder')
...
class DriveItemItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, drive_item_id1: Optional[str] = None) -> None:
        """
        Instantiates a new DriveItemItemRequestBuilder and sets the default values.
        Args:
            driveItemId1: key: id of driveItem
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/children/{driveItem%2Did1}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["driveItem%2Did1"] = driveItemId1
