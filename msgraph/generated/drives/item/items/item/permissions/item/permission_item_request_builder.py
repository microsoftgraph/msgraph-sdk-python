...
microsoft_graph_grant_request_builder = lazy_import('msgraph.generated.drives.item.items.item.permissions.item.microsoft_graph_grant.microsoft_graph_grant_request_builder')
