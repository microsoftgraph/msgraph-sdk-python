...
@dataclass
class PreviewPostRequestBody_zoom(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PreviewPostRequestBody_zoom:
        """
        ...
        try:
            ...
            mapping_value = None
        result = PreviewPostRequestBody_zoom()
