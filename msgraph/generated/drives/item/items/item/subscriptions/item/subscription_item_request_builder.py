...
reauthorize_request_builder = lazy_import('msgraph.generated.drives.item.items.item.subscriptions.item.microsoft_graph_reauthorize.reauthorize_request_builder')
