...
class WorkbookCommentReplyItemRequestBuilder():
    """
    ...
    async def delete(self,request_configuration: Optional[WorkbookCommentReplyItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def patch(self,body: Optional[workbook_comment_reply.WorkbookCommentReply] = None, request_configuration: Optional[WorkbookCommentReplyItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[workbook_comment_reply.WorkbookCommentReply]:
        """
    ...
    def to_patch_request_information(self,body: Optional[workbook_comment_reply.WorkbookCommentReply] = None, request_configuration: Optional[WorkbookCommentReplyItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property replies in drives
        Args:
            body: The request body
    ...
    @dataclass
    class WorkbookCommentReplyItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class WorkbookCommentReplyItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
