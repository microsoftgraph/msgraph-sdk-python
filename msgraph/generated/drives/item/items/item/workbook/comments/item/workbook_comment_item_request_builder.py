...
replies_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.comments.item.replies.replies_request_builder')
workbook_comment_reply_item_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.comments.item.replies.item.workbook_comment_reply_item_request_builder')
...
class WorkbookCommentItemRequestBuilder():
    ...
    def replies_by_id(self,id: str) -> workbook_comment_reply_item_request_builder.WorkbookCommentReplyItemRequestBuilder:
        """
        Provides operations to manage the replies property of the microsoft.graph.workbookComment entity.
        Args:
