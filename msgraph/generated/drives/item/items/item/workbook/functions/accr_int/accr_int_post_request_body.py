...
class AccrIntPostRequestBody(AdditionalDataHolder, Parsable):
    ...
    @property
    def calc_method(self,) -> Optional[json.Json]:
        """
    ...
    @calc_method.setter
    def calc_method(self,value: Optional[json.Json] = None) -> None:
        """
    ...
    @property
    def first_interest(self,) -> Optional[json.Json]:
        """
        Gets the firstInterest property value. The firstInterest property
        Returns: Optional[json.Json]
        """
        return self._first_interest
    
    @first_interest.setter
    def first_interest(self,value: Optional[json.Json] = None) -> None:
        """
        Sets the firstInterest property value. The firstInterest property
        Args:
            value: Value to set for the first_interest property.
        """
        self._first_interest = value
    ...
    @property
    def par(self,) -> Optional[json.Json]:
        """
    ...
    @par.setter
    def par(self,value: Optional[json.Json] = None) -> None:
        """
