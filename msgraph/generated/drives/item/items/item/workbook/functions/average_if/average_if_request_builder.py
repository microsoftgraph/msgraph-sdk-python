...
if TYPE_CHECKING:
    ...
    from .average_if_post_request_body import AverageIfPostRequestBody

class AverageIfRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AverageIfRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AverageIfRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return AverageIfRequestBuilder(raw_url, self.request_adapter)
