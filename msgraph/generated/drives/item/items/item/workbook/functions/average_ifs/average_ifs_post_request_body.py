...
class AverageIfsPostRequestBody(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        ...
        self._average_range: Optional[json.Json] = None
        # The values property
    ...
    @property
    def average_range(self,) -> Optional[json.Json]:
        """
    ...
    @average_range.setter
    def average_range(self,value: Optional[json.Json] = None) -> None:
        """
        Sets the averageRange property value. The averageRange property
        Args:
            value: Value to set for the average_range property.
        """
        self._average_range = value
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AverageIfsPostRequestBody:
        """
        ...
        return AverageIfsPostRequestBody()
