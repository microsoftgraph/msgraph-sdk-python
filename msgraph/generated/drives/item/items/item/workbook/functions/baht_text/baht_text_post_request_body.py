...
class BahtTextPostRequestBody(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        """
        Instantiates a new bahtTextPostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> BahtTextPostRequestBody:
        """
        ...
        return BahtTextPostRequestBody()
