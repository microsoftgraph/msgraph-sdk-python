...
@dataclass
class BitlshiftPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    shift_amount: Optional[Json] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> BitlshiftPostRequestBody:
        """
