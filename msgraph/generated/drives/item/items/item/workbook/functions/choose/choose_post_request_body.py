...
@dataclass
class ChoosePostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    index_num: Optional[Json] = None
    # The values property
    values: Optional[Json] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ChoosePostRequestBody:
        """
