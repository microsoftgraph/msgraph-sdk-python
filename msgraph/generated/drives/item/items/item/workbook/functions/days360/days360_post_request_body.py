...
class Days360PostRequestBody(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        ...
        # The method property
        self._method: Optional[json.Json] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "method": lambda n : setattr(self, 'method', n.get_object_value(json.Json)),
            "startDate": lambda n : setattr(self, 'start_date', n.get_object_value(json.Json)),
        }
        return fields
    
    @property
    def method(self,) -> Optional[json.Json]:
        """
    ...
    @method.setter
    def method(self,value: Optional[json.Json] = None) -> None:
        """
