...
@dataclass
class DollarFrPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    decimal_dollar: Optional[Json] = None
    # The fraction property
    fraction: Optional[Json] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DollarFrPostRequestBody:
        """
