...
@dataclass
class Expon_DistPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    # The lambda property
    lambda_: Optional[Json] = None
    # The x property
    x: Optional[Json] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Expon_DistPostRequestBody:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "lambda": lambda n : setattr(self, 'lambda_', n.get_object_value(Json)),
