...
class Expon_DistPostRequestBody(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        ...
        # The lambda property
        self._lambda_: Optional[json.Json] = None
        # The x property
    ...
    @property
    def lambda_(self,) -> Optional[json.Json]:
        """
    ...
    @lambda_.setter
    def lambda_(self,value: Optional[json.Json] = None) -> None:
        """
        Sets the lambda property value. The lambda property
        Args:
            value: Value to set for the lambda_ property.
        """
        self._lambda_ = value
