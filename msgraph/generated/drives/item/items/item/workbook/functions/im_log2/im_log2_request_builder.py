...
class ImLog2RequestBuilder(BaseRequestBuilder):
    ...
    def to_post_request_information(self,body: Optional[ImLog2PostRequestBody] = None, request_configuration: Optional[ImLog2RequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action imLog2
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ImLog2RequestBuilder:
        ...
        return ImLog2RequestBuilder(raw_url, self.request_adapter)
