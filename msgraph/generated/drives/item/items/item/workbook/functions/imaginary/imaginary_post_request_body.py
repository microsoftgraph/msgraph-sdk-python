...
class ImaginaryPostRequestBody(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        """
        Instantiates a new imaginaryPostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ImaginaryPostRequestBody:
        """
        ...
        return ImaginaryPostRequestBody()
