...
class Ceiling_PrecisePostRequestBody(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        """
        Instantiates a new ceiling_PrecisePostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> Ceiling_PrecisePostRequestBody:
        """
        ...
        return Ceiling_PrecisePostRequestBody()
