...
class LogNorm_DistPostRequestBody(AdditionalDataHolder, Parsable):
    @property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> LogNorm_DistPostRequestBody:
        """
        ...
        return LogNorm_DistPostRequestBody()
