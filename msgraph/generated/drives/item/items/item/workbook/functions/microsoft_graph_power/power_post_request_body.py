...
class PowerPostRequestBody(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        ...
        self._power: Optional[json.Json] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> PowerPostRequestBody:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "power": lambda n : setattr(self, 'power', n.get_object_value(json.Json)),
        }
        return fields
    ...
    @property
    def power(self,) -> Optional[json.Json]:
        """
    ...
    @power.setter
    def power(self,value: Optional[json.Json] = None) -> None:
        """
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("power", self.power)
