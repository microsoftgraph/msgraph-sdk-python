...
class ModPostRequestBody(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        ...
        self._divisor: Optional[json.Json] = None
        # The number property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ModPostRequestBody:
        """
    ...
    @property
    def divisor(self,) -> Optional[json.Json]:
        """
    ...
    @divisor.setter
    def divisor(self,value: Optional[json.Json] = None) -> None:
        """
        Sets the divisor property value. The divisor property
        Args:
            value: Value to set for the divisor property.
        """
        self._divisor = value
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "divisor": lambda n : setattr(self, 'divisor', n.get_object_value(json.Json)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("divisor", self.divisor)
