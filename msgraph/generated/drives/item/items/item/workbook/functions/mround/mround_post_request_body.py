...
class MroundPostRequestBody(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        ...
        self._multiple: Optional[json.Json] = None
        # The number property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> MroundPostRequestBody:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "multiple": lambda n : setattr(self, 'multiple', n.get_object_value(json.Json)),
            "number": lambda n : setattr(self, 'number', n.get_object_value(json.Json)),
        }
        return fields
    
    @property
    def multiple(self,) -> Optional[json.Json]:
        """
    ...
    @multiple.setter
    def multiple(self,value: Optional[json.Json] = None) -> None:
        """
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("multiple", self.multiple)
