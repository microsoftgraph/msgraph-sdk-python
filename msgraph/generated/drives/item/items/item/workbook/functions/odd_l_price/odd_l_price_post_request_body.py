...
class OddLPricePostRequestBody(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        ...
        self._last_interest: Optional[json.Json] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> OddLPricePostRequestBody:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "lastInterest": lambda n : setattr(self, 'last_interest', n.get_object_value(json.Json)),
    ...
    @property
    def last_interest(self,) -> Optional[json.Json]:
        """
    ...
    @last_interest.setter
    def last_interest(self,value: Optional[json.Json] = None) -> None:
        """
        Sets the lastInterest property value. The lastInterest property
        Args:
            value: Value to set for the last_interest property.
        """
        self._last_interest = value
