...
class PermutationaPostRequestBody(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        """
        Instantiates a new permutationaPostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> PermutationaPostRequestBody:
        """
        ...
        return PermutationaPostRequestBody()
