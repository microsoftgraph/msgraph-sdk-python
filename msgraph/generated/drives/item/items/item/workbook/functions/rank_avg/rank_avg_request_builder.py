...
if TYPE_CHECKING:
    ...
    from .rank_avg_post_request_body import Rank_AvgPostRequestBody

class Rank_AvgRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> Rank_AvgRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: Rank_AvgRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return Rank_AvgRequestBuilder(raw_url, self.request_adapter)
