...
class RomanPostRequestBody(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        ...
        # The form property
        self._form: Optional[json.Json] = None
        # The number property
    ...
    @property
    def form(self,) -> Optional[json.Json]:
        """
    ...
    @form.setter
    def form(self,value: Optional[json.Json] = None) -> None:
        """
        Sets the form property value. The form property
        Args:
            value: Value to set for the form property.
        """
        self._form = value
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "form": lambda n : setattr(self, 'form', n.get_object_value(json.Json)),
