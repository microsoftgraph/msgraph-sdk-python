...
@dataclass
class TrimMeanPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    percent: Optional[Json] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TrimMeanPostRequestBody:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "percent": lambda n : setattr(self, 'percent', n.get_object_value(Json)),
        }
        return fields
