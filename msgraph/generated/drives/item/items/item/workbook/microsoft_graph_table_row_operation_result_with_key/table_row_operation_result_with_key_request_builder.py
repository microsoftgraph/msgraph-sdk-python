...
class TableRowOperationResultWithKeyRequestBuilder():
    """
    ...
    async def get(self,request_configuration: Optional[TableRowOperationResultWithKeyRequestBuilderGetRequestConfiguration] = None) -> Optional[workbook_table_row.WorkbookTableRow]:
        """
    ...
    @dataclass
    class TableRowOperationResultWithKeyRequestBuilderGetRequestConfiguration():
        """
