...
microsoft_graph_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.names.item.microsoft_graph_range.microsoft_graph_range_request_builder')
