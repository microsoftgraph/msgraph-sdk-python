...
range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.names.item.microsoft_graph_range.range_request_builder')
worksheet_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.names.item.worksheet.worksheet_request_builder')
...
class WorkbookNamedItemItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, workbook_named_item_id: Optional[str] = None) -> None:
        """
        ...
        url_tpl_params["workbookNamedItem%2Did"] = workbookNamedItemId
