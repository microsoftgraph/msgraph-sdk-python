...
add_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.names.microsoft_graph_add.add_request_builder')
add_formula_local_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.names.microsoft_graph_add_formula_local.add_formula_local_request_builder')
