...
class SessionInfoResourceWithKeyRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, key: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/sessionInfoResource(key='{key}')"
    ...
    async def get(self,request_configuration: Optional[SessionInfoResourceWithKeyRequestBuilderGetRequestConfiguration] = None) -> Optional[workbook_session_info.WorkbookSessionInfo]:
        """
