...
microsoft_graph_add_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.charts.microsoft_graph_add.microsoft_graph_add_request_builder')
microsoft_graph_count_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.charts.microsoft_graph_count.microsoft_graph_count_request_builder')
microsoft_graph_item_at_with_index_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.charts.microsoft_graph_item_at_with_index.microsoft_graph_item_at_with_index_request_builder')
microsoft_graph_item_with_name_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.charts.microsoft_graph_item_with_name.microsoft_graph_item_with_name_request_builder')
...
class ChartsRequestBuilder():
    ...
    def microsoft_graph_item_with_name(self,name: Optional[str] = None) -> microsoft_graph_item_with_name_request_builder.MicrosoftGraphItemWithNameRequestBuilder:
        """
        Provides operations to call the item method.
        Args:
            name: Usage: name='{name}'
        Returns: microsoft_graph_item_with_name_request_builder.MicrosoftGraphItemWithNameRequestBuilder
        """
        if name is None:
            raise Exception("name cannot be undefined")
        return microsoft_graph_item_with_name_request_builder.MicrosoftGraphItemWithNameRequestBuilder(self.request_adapter, self.path_parameters, name)
