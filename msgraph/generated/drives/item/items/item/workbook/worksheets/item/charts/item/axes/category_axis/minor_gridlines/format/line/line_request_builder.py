...
if TYPE_CHECKING:
    from ...............models import workbook_chart_line_format
...
class LineRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[LineRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
