...
format_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.charts.item.axes.category_axis.minor_gridlines.format.format_request_builder')
workbook_chart_gridlines = lazy_import('msgraph.generated.models.workbook_chart_gridlines')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class MinorGridlinesRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/categoryAxis/minorGridlines{?%24select,%24expand}"
    ...
    @dataclass
    class MinorGridlinesRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class MinorGridlinesRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
