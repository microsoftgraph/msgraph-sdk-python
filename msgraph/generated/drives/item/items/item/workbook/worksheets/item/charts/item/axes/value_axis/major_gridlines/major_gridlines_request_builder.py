...
class MajorGridlinesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/valueAxis/majorGridlines{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[MajorGridlinesRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[MajorGridlinesRequestBuilderGetRequestConfiguration] = None) -> Optional[workbook_chart_gridlines.WorkbookChartGridlines]:
        """
    ...
    def to_patch_request_information(self,body: Optional[workbook_chart_gridlines.WorkbookChartGridlines] = None, request_configuration: Optional[MajorGridlinesRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property majorGridlines in drives
        Args:
            body: The request body
    ...
    @dataclass
    class MajorGridlinesRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
