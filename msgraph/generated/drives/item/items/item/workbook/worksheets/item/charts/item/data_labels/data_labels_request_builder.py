...
if TYPE_CHECKING:
    from ...........models import workbook_chart_data_labels
...
class DataLabelsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/dataLabels{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[DataLabelsRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[DataLabelsRequestBuilderGetRequestConfiguration] = None) -> Optional[workbook_chart_data_labels.WorkbookChartDataLabels]:
        ...
        return await self.request_adapter.send_async(request_info, workbook_chart_data_labels.WorkbookChartDataLabels, error_mapping)
    ...
    @dataclass
    class DataLabelsRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class DataLabelsRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
