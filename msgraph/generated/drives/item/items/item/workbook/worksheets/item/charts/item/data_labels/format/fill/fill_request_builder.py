...
microsoft_graph_clear_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.charts.item.data_labels.format.fill.microsoft_graph_clear.microsoft_graph_clear_request_builder')
microsoft_graph_set_solid_color_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.charts.item.data_labels.format.fill.microsoft_graph_set_solid_color.microsoft_graph_set_solid_color_request_builder')
