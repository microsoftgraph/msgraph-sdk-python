...
clear_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.charts.item.series.item.format.fill.microsoft_graph_clear.clear_request_builder')
set_solid_color_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.charts.item.series.item.format.fill.microsoft_graph_set_solid_color.set_solid_color_request_builder')
