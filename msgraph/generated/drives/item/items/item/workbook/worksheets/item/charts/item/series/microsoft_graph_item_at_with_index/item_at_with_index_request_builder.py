...
class ItemAtWithIndexRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[ItemAtWithIndexRequestBuilderGetRequestConfiguration] = None) -> Optional[workbook_chart_series.WorkbookChartSeries]:
        """
