...
if TYPE_CHECKING:
    from ............models import workbook_chart_title_format
...
class FormatRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[FormatRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
