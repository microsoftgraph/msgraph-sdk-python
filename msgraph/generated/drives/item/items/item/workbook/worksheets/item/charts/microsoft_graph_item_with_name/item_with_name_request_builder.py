...
class ItemWithNameRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[ItemWithNameRequestBuilderGetRequestConfiguration] = None) -> Optional[workbook_chart.WorkbookChart]:
        """
    ...
    @dataclass
    class ItemWithNameRequestBuilderGetRequestConfiguration():
        """
