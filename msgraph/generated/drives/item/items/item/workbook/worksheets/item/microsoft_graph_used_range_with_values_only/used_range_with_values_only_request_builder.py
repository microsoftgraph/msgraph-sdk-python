...
class UsedRangeWithValuesOnlyRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, values_only: Optional[bool] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/microsoft.graph.usedRange(valuesOnly={valuesOnly})"
    ...
    async def get(self,request_configuration: Optional[UsedRangeWithValuesOnlyRequestBuilderGetRequestConfiguration] = None) -> Optional[workbook_range.WorkbookRange]:
        """
