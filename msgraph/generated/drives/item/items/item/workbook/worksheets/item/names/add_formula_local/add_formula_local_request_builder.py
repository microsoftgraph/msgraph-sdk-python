...
add_formula_local_post_request_body = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.names.add_formula_local.add_formula_local_post_request_body')
...
class AddFormulaLocalRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/names/addFormulaLocal"
