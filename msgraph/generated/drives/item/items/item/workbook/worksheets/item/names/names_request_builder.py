...
add_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.names.add.add_request_builder')
add_formula_local_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.names.add_formula_local.add_formula_local_request_builder')
