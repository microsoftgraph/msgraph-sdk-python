...
microsoft_graph_apply_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.filter.microsoft_graph_apply.microsoft_graph_apply_request_builder')
microsoft_graph_apply_bottom_items_filter_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.filter.microsoft_graph_apply_bottom_items_filter.microsoft_graph_apply_bottom_items_filter_request_builder')
microsoft_graph_apply_bottom_percent_filter_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.filter.microsoft_graph_apply_bottom_percent_filter.microsoft_graph_apply_bottom_percent_filter_request_builder')
microsoft_graph_apply_cell_color_filter_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.filter.microsoft_graph_apply_cell_color_filter.microsoft_graph_apply_cell_color_filter_request_builder')
microsoft_graph_apply_custom_filter_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.filter.microsoft_graph_apply_custom_filter.microsoft_graph_apply_custom_filter_request_builder')
microsoft_graph_apply_dynamic_filter_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.filter.microsoft_graph_apply_dynamic_filter.microsoft_graph_apply_dynamic_filter_request_builder')
microsoft_graph_apply_font_color_filter_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.filter.microsoft_graph_apply_font_color_filter.microsoft_graph_apply_font_color_filter_request_builder')
microsoft_graph_apply_icon_filter_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.filter.microsoft_graph_apply_icon_filter.microsoft_graph_apply_icon_filter_request_builder')
microsoft_graph_apply_top_items_filter_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.filter.microsoft_graph_apply_top_items_filter.microsoft_graph_apply_top_items_filter_request_builder')
microsoft_graph_apply_top_percent_filter_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.filter.microsoft_graph_apply_top_percent_filter.microsoft_graph_apply_top_percent_filter_request_builder')
microsoft_graph_apply_values_filter_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.filter.microsoft_graph_apply_values_filter.microsoft_graph_apply_values_filter_request_builder')
microsoft_graph_clear_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.filter.microsoft_graph_clear.microsoft_graph_clear_request_builder')
