...
class UsedRangeWithValuesOnlyRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], values_only: Optional[bool] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/headerRowRange()/usedRange(valuesOnly={valuesOnly})", path_parameters)
    ...
    def with_url(self,raw_url: str) -> UsedRangeWithValuesOnlyRequestBuilder:
        """
        ...
        return UsedRangeWithValuesOnlyRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class UsedRangeWithValuesOnlyRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
