...
class HeaderRowRangeRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/headerRowRange()", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> HeaderRowRangeRequestBuilder:
        ...
        return HeaderRowRangeRequestBuilder(raw_url, self.request_adapter)
