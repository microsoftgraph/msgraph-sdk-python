...
add_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.rows.add.add_request_builder')
...
item_at_with_index_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.rows.item_at_with_index.item_at_with_index_request_builder')
