...
apply_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.sort.microsoft_graph_apply.apply_request_builder')
clear_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.sort.microsoft_graph_clear.clear_request_builder')
reapply_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.sort.microsoft_graph_reapply.reapply_request_builder')
