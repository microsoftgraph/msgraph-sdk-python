...
microsoft_graph_apply_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.sort.microsoft_graph_apply.microsoft_graph_apply_request_builder')
microsoft_graph_clear_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.sort.microsoft_graph_clear.microsoft_graph_clear_request_builder')
microsoft_graph_reapply_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.sort.microsoft_graph_reapply.microsoft_graph_reapply_request_builder')
