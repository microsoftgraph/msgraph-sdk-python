...
columns_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.columns_request_builder')
workbook_table_column_item_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.columns.item.workbook_table_column_item_request_builder')
microsoft_graph_clear_filters_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_clear_filters.microsoft_graph_clear_filters_request_builder')
microsoft_graph_convert_to_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_convert_to_range.microsoft_graph_convert_to_range_request_builder')
microsoft_graph_data_body_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_data_body_range.microsoft_graph_data_body_range_request_builder')
microsoft_graph_header_row_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_header_row_range.microsoft_graph_header_row_range_request_builder')
microsoft_graph_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_range.microsoft_graph_range_request_builder')
microsoft_graph_reapply_filters_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_reapply_filters.microsoft_graph_reapply_filters_request_builder')
microsoft_graph_total_row_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_total_row_range.microsoft_graph_total_row_range_request_builder')
rows_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.rows.rows_request_builder')
workbook_table_row_item_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.rows.item.workbook_table_row_item_request_builder')
sort_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.sort.sort_request_builder')
worksheet_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.worksheet.worksheet_request_builder')
...
class WorkbookTableItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}{?%24select,%24expand}"
