...
clear_filters_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.clear_filters.clear_filters_request_builder')
...
convert_to_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.convert_to_range.convert_to_range_request_builder')
data_body_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.data_body_range.data_body_range_request_builder')
header_row_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.header_row_range.header_row_range_request_builder')
range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.range.range_request_builder')
reapply_filters_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.reapply_filters.reapply_filters_request_builder')
...
total_row_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.total_row_range.total_row_range_request_builder')
