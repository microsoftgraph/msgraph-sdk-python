...
clear_filters_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_clear_filters.clear_filters_request_builder')
convert_to_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_convert_to_range.convert_to_range_request_builder')
data_body_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_data_body_range.data_body_range_request_builder')
header_row_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_header_row_range.header_row_range_request_builder')
range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_range.range_request_builder')
reapply_filters_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_reapply_filters.reapply_filters_request_builder')
total_row_range_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.tables.item.microsoft_graph_total_row_range.total_row_range_request_builder')
