...
class ItemsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_drive_item_id(self,drive_item_id: str) -> drive_item_item_request_builder.DriveItemItemRequestBuilder:
        """
        Provides operations to manage the items property of the microsoft.graph.drive entity.
        Args:
        ...
        if drive_item_id is None:
            raise Exception("drive_item_id cannot be undefined")
        from .item import drive_item_item_request_builder
    ...
    async def get(self,request_configuration: Optional[ItemsRequestBuilderGetRequestConfiguration] = None) -> Optional[drive_item_collection_response.DriveItemCollectionResponse]:
        """
        ...
        return await self.request_adapter.send_async(request_info, drive_item_collection_response.DriveItemCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[drive_item.DriveItem] = None, request_configuration: Optional[ItemsRequestBuilderPostRequestConfiguration] = None) -> Optional[drive_item.DriveItem]:
        """
    ...
    def to_post_request_information(self,body: Optional[drive_item.DriveItem] = None, request_configuration: Optional[ItemsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to items for drives
        Args:
            body: The request body
