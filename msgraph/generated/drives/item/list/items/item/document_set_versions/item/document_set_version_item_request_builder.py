...
microsoft_graph_restore_request_builder = lazy_import('msgraph.generated.drives.item.list.items.item.document_set_versions.item.microsoft_graph_restore.microsoft_graph_restore_request_builder')
