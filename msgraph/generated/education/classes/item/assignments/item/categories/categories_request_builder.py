...
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.education.classes.item.assignments.item.categories.microsoft_graph_delta.microsoft_graph_delta_request_builder')
