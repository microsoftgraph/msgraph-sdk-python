...
class GetRecentlyModifiedSubmissionsGetResponse(BaseCollectionPaginationCountResponse, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetRecentlyModifiedSubmissionsGetResponse:
        """
        ...
        return GetRecentlyModifiedSubmissionsGetResponse()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(EducationSubmission)),
        }
