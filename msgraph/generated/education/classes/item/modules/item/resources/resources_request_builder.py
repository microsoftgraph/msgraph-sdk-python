...
if TYPE_CHECKING:
    ...
    from .......models.education_module_resource_collection_response import EducationModuleResourceCollectionResponse
    from .......models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.education_module_resource_item_request_builder import EducationModuleResourceItemRequestBuilder
...
class ResourcesRequestBuilder(BaseRequestBuilder):
    ...
    def by_education_module_resource_id(self,education_module_resource_id: str) -> EducationModuleResourceItemRequestBuilder:
        """
        Provides operations to manage the resources property of the microsoft.graph.educationModule entity.
        param education_module_resource_id: The unique identifier of educationModuleResource
        Returns: EducationModuleResourceItemRequestBuilder
        """
        if education_module_resource_id is None:
            raise TypeError("education_module_resource_id cannot be null.")
        from .item.education_module_resource_item_request_builder import EducationModuleResourceItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["educationModuleResource%2Did"] = education_module_resource_id
        return EducationModuleResourceItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[ResourcesRequestBuilderGetQueryParameters]] = None) -> Optional[EducationModuleResourceCollectionResponse]:
        """
    ...
    async def post(self,body: EducationModuleResource, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[EducationModuleResource]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ResourcesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/education/classes/{educationClass%2Did}/modules/{educationModule%2Did}/resources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: EducationModuleResource, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a resource in a module. Only teachers can perform this operation. You can create the following types of module resources: Every resource has an @odata.type property to indicate which type of resource is being created.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/education/classes/{educationClass%2Did}/modules/{educationModule%2Did}/resources', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
