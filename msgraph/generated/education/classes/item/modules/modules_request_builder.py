...
if TYPE_CHECKING:
    ...
    from .....models.education_module_collection_response import EducationModuleCollectionResponse
    from .....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.education_module_item_request_builder import EducationModuleItemRequestBuilder

class ModulesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def by_education_module_id(self,education_module_id: str) -> EducationModuleItemRequestBuilder:
        """
        Provides operations to manage the modules property of the microsoft.graph.educationClass entity.
        param education_module_id: The unique identifier of educationModule
        Returns: EducationModuleItemRequestBuilder
        """
        if education_module_id is None:
            raise TypeError("education_module_id cannot be null.")
        from .item.education_module_item_request_builder import EducationModuleItemRequestBuilder
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ModulesRequestBuilderGetQueryParameters]] = None) -> Optional[EducationModuleCollectionResponse]:
        """
    ...
    async def post(self,body: EducationModule, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[EducationModule]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ModulesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Retrieve a list of module objects. Only teachers, students, and applications with application permissions can perform this operation. A teacher or an application with application permissions can see all module objects for the class. Students can only see published modules.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/education/classes/{educationClass%2Did}/modules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: EducationModule, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new module in a class. Only teachers in a class can create a module. Modules start in the draft state, which means that students can't see the modules until publication.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ModulesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ModulesRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class ModulesRequestBuilderGetRequestConfiguration(RequestConfiguration[ModulesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class ModulesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
