...
class SubmitRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/submit", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SubmitRequestBuilder:
        ...
        return SubmitRequestBuilder(raw_url, self.request_adapter)
