...
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.education.users.item.assignments.item.categories.microsoft_graph_delta.microsoft_graph_delta_request_builder')
