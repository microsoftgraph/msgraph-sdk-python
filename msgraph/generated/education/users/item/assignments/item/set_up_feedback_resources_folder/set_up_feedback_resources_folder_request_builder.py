...
class SetUpFeedbackResourcesFolderRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/setUpFeedbackResourcesFolder", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SetUpFeedbackResourcesFolderRequestBuilder:
        ...
        return SetUpFeedbackResourcesFolderRequestBuilder(raw_url, self.request_adapter)
