...
reassign_request_builder = lazy_import('msgraph.generated.education.users.item.assignments.item.submissions.item.microsoft_graph_reassign.reassign_request_builder')
return_request_builder = lazy_import('msgraph.generated.education.users.item.assignments.item.submissions.item.microsoft_graph_return.return_request_builder')
set_up_resources_folder_request_builder = lazy_import('msgraph.generated.education.users.item.assignments.item.submissions.item.microsoft_graph_set_up_resources_folder.set_up_resources_folder_request_builder')
submit_request_builder = lazy_import('msgraph.generated.education.users.item.assignments.item.submissions.item.microsoft_graph_submit.submit_request_builder')
unsubmit_request_builder = lazy_import('msgraph.generated.education.users.item.assignments.item.submissions.item.microsoft_graph_unsubmit.unsubmit_request_builder')
