...
class TaughtClassesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/education/users/{educationUser%2Did}/taughtClasses{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[TaughtClassesRequestBuilderGetQueryParameters]] = None) -> Optional[EducationClassCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[TaughtClassesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get the educationClass resources owned by an educationUser.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> TaughtClassesRequestBuilder:
        """
    ...
    @dataclass
    class TaughtClassesRequestBuilderGetRequestConfiguration(RequestConfiguration[TaughtClassesRequestBuilderGetQueryParameters]):
        """
