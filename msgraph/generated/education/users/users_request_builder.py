...
class UsersRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[EducationUser] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[EducationUser]:
        """
    ...
    def to_post_request_information(self,body: Optional[EducationUser] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create a new educationUser object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
