...
class ConnectionOperationItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, connection_operation_id: Optional[str] = None) -> None:
        """
        Instantiates a new ConnectionOperationItemRequestBuilder and sets the default values.
        Args:
            connectionOperationId: key: id of connectionOperation
        ...
        self.url_template: str = "{+baseurl}/external/connections/{externalConnection%2Did}/operations/{connectionOperation%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["connectionOperation%2Did"] = connectionOperationId
