...
class AttributeMappingFunctionSchemaItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/functions/{attributeMappingFunctionSchema%2Did}{?%24select,%24expand}", path_parameters)
    ...
    class AttributeMappingFunctionSchemaItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[AttributeMappingFunctionSchemaItemRequestBuilderGetQueryParameters] = None
