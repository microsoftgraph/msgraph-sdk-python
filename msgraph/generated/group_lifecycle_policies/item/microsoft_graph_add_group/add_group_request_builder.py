...
add_group_post_request_body = lazy_import('msgraph.generated.group_lifecycle_policies.item.microsoft_graph_add_group.add_group_post_request_body')
add_group_response = lazy_import('msgraph.generated.group_lifecycle_policies.item.microsoft_graph_add_group.add_group_response')
