...
class GroupSettingTemplatesRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GroupSettingTemplatesRequestBuilder:
        """
        ...
        return GroupSettingTemplatesRequestBuilder(raw_url, self.request_adapter)
