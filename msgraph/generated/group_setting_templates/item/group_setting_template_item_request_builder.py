...
class GroupSettingTemplateItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[GroupSettingTemplate]:
        """
    ...
    async def patch(self,body: Optional[GroupSettingTemplate] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[GroupSettingTemplate]:
        """
    ...
    def to_patch_request_information(self,body: Optional[GroupSettingTemplate] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update entity in groupSettingTemplates
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
