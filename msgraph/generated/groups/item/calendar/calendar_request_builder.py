...
microsoft_graph_allowed_calendar_sharing_roles_with_user_request_builder = lazy_import('msgraph.generated.groups.item.calendar.microsoft_graph_allowed_calendar_sharing_roles_with_user.microsoft_graph_allowed_calendar_sharing_roles_with_user_request_builder')
microsoft_graph_get_schedule_request_builder = lazy_import('msgraph.generated.groups.item.calendar.microsoft_graph_get_schedule.microsoft_graph_get_schedule_request_builder')
