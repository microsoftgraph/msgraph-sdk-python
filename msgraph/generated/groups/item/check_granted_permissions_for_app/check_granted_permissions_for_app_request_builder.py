...
class CheckGrantedPermissionsForAppRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> CheckGrantedPermissionsForAppRequestBuilder:
        """
    ...
    @dataclass
    class CheckGrantedPermissionsForAppRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
