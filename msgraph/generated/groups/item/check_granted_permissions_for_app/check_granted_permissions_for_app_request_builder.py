...
class CheckGrantedPermissionsForAppRequestBuilder():
    ...
    async def post(self,request_configuration: Optional[CheckGrantedPermissionsForAppRequestBuilderPostRequestConfiguration] = None) -> Optional[check_granted_permissions_for_app_response.CheckGrantedPermissionsForAppResponse]:
        """
