...
check_member_objects_post_request_body = lazy_import('msgraph.generated.groups.item.check_member_objects.check_member_objects_post_request_body')
check_member_objects_response = lazy_import('msgraph.generated.groups.item.check_member_objects.check_member_objects_response')
...
class CheckMemberObjectsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/microsoft.graph.checkMemberObjects"
