...
forward_post_request_body = lazy_import('msgraph.generated.groups.item.conversations.item.threads.item.posts.item.microsoft_graph_forward.forward_post_request_body')
