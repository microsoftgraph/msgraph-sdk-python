...
bundles_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.bundles.bundles_request_builder')
drive_item_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.bundles.item.drive_item_item_request_builder')
following_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.following.following_request_builder')
drive_item_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.following.item.drive_item_item_request_builder')
items_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.items_request_builder')
drive_item_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.drive_item_item_request_builder')
list_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.list_request_builder')
recent_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.recent.recent_request_builder')
root_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.root.root_request_builder')
search_with_q_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.search_with_q.search_with_q_request_builder')
shared_with_me_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.shared_with_me.shared_with_me_request_builder')
special_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.special.special_request_builder')
drive_item_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.special.item.drive_item_item_request_builder')
...
class DriveItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}{?%24select,%24expand}"
