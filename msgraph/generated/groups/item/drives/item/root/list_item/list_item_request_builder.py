...
get_activities_by_interval_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.root.list_item.get_activities_by_interval.get_activities_by_interval_request_builder')
