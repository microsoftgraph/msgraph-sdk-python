...
shared_with_me_response = lazy_import('msgraph.generated.groups.item.drives.item.shared_with_me.shared_with_me_response')
...
class SharedWithMeRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/microsoft.graph.sharedWithMe(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
