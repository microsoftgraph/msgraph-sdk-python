...
get_notebook_from_web_url_post_request_body = lazy_import('msgraph.generated.groups.item.onenote.notebooks.get_notebook_from_web_url.get_notebook_from_web_url_post_request_body')
...
class GetNotebookFromWebUrlRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/onenote/notebooks/microsoft.graph.getNotebookFromWebUrl"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,body: Optional[get_notebook_from_web_url_post_request_body.GetNotebookFromWebUrlPostRequestBody] = None, request_configuration: Optional[GetNotebookFromWebUrlRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
