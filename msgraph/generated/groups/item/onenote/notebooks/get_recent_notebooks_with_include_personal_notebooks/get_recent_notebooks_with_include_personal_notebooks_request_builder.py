...
get_recent_notebooks_with_include_personal_notebooks_response = lazy_import('msgraph.generated.groups.item.onenote.notebooks.get_recent_notebooks_with_include_personal_notebooks.get_recent_notebooks_with_include_personal_notebooks_response')
...
class GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, include_personal_notebooks: Optional[bool] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/onenote/notebooks/getRecentNotebooks(includePersonalNotebooks={includePersonalNotebooks}){?%24top,%24skip,%24search,%24filter,%24count}"
