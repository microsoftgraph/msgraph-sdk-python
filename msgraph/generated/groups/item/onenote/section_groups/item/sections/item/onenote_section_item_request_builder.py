...
microsoft_graph_copy_to_notebook_request_builder = lazy_import('msgraph.generated.groups.item.onenote.section_groups.item.sections.item.microsoft_graph_copy_to_notebook.microsoft_graph_copy_to_notebook_request_builder')
microsoft_graph_copy_to_section_group_request_builder = lazy_import('msgraph.generated.groups.item.onenote.section_groups.item.sections.item.microsoft_graph_copy_to_section_group.microsoft_graph_copy_to_section_group_request_builder')
