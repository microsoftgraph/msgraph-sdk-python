...
application_request_builder = lazy_import('msgraph.generated.groups.item.owners.item.application.application_request_builder')
device_request_builder = lazy_import('msgraph.generated.groups.item.owners.item.device.device_request_builder')
group_request_builder = lazy_import('msgraph.generated.groups.item.owners.item.group.group_request_builder')
org_contact_request_builder = lazy_import('msgraph.generated.groups.item.owners.item.org_contact.org_contact_request_builder')
ref_request_builder = lazy_import('msgraph.generated.groups.item.owners.item.ref.ref_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.groups.item.owners.item.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.groups.item.owners.item.user.user_request_builder')
