...
tasks_request_builder = lazy_import('msgraph.generated.groups.item.planner.plans.item.buckets.item.tasks.tasks_request_builder')
planner_task_item_request_builder = lazy_import('msgraph.generated.groups.item.planner.plans.item.buckets.item.tasks.item.planner_task_item_request_builder')
