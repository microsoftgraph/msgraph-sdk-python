...
buckets_request_builder = lazy_import('msgraph.generated.groups.item.planner.plans.item.buckets.buckets_request_builder')
planner_bucket_item_request_builder = lazy_import('msgraph.generated.groups.item.planner.plans.item.buckets.item.planner_bucket_item_request_builder')
details_request_builder = lazy_import('msgraph.generated.groups.item.planner.plans.item.details.details_request_builder')
tasks_request_builder = lazy_import('msgraph.generated.groups.item.planner.plans.item.tasks.tasks_request_builder')
planner_task_item_request_builder = lazy_import('msgraph.generated.groups.item.planner.plans.item.tasks.item.planner_task_item_request_builder')
...
class PlannerPlanItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}{?%24select,%24expand}"
