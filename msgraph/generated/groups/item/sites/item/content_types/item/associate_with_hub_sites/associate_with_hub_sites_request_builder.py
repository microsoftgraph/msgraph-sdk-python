...
associate_with_hub_sites_post_request_body = lazy_import('msgraph.generated.groups.item.sites.item.content_types.item.associate_with_hub_sites.associate_with_hub_sites_post_request_body')
...
class AssociateWithHubSitesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/associateWithHubSites"
