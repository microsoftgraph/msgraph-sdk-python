...
microsoft_graph_add_copy_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.lists.item.content_types.microsoft_graph_add_copy.microsoft_graph_add_copy_request_builder')
microsoft_graph_add_copy_from_content_type_hub_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.lists.item.content_types.microsoft_graph_add_copy_from_content_type_hub.microsoft_graph_add_copy_from_content_type_hub_request_builder')
microsoft_graph_get_compatible_hub_content_types_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.lists.item.content_types.microsoft_graph_get_compatible_hub_content_types.microsoft_graph_get_compatible_hub_content_types_request_builder')
