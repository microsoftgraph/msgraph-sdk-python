...
copy_to_default_content_location_post_request_body = lazy_import('msgraph.generated.groups.item.sites.item.lists.item.content_types.item.copy_to_default_content_location.copy_to_default_content_location_post_request_body')
...
class CopyToDefaultContentLocationRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/copyToDefaultContentLocation"
