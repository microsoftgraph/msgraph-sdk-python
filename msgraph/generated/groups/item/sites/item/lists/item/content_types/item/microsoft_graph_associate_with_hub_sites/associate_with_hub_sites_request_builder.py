...
associate_with_hub_sites_post_request_body = lazy_import('msgraph.generated.groups.item.sites.item.lists.item.content_types.item.microsoft_graph_associate_with_hub_sites.associate_with_hub_sites_post_request_body')
