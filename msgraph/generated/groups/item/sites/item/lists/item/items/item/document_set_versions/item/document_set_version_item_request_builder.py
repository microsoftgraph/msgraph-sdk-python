...
restore_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.lists.item.items.item.document_set_versions.item.microsoft_graph_restore.restore_request_builder')
...
class DocumentSetVersionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, document_set_version_id: Optional[str] = None) -> None:
        """
        Instantiates a new DocumentSetVersionItemRequestBuilder and sets the default values.
        Args:
            documentSetVersionId: key: id of documentSetVersion
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["documentSetVersion%2Did"] = documentSetVersionId
    ...
    def to_patch_request_information(self,body: Optional[document_set_version.DocumentSetVersion] = None, request_configuration: Optional[DocumentSetVersionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property documentSetVersions in groups
        Args:
            body: The request body
