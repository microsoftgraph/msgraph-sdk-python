...
restore_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.lists.item.items.item.document_set_versions.item.restore.restore_request_builder')
