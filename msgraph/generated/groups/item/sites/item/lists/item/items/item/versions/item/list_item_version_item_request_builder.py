...
restore_version_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.lists.item.items.item.versions.item.restore_version.restore_version_request_builder')
