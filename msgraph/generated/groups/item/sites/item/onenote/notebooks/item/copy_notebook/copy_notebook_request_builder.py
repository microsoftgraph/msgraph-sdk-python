...
copy_notebook_post_request_body = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.item.copy_notebook.copy_notebook_post_request_body')
