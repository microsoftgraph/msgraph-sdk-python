...
copy_notebook_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.item.microsoft_graph_copy_notebook.copy_notebook_request_builder')
