...
grant_post_request_body = lazy_import('msgraph.generated.groups.item.sites.item.permissions.item.grant.grant_post_request_body')
grant_response = lazy_import('msgraph.generated.groups.item.sites.item.permissions.item.grant.grant_response')
...
class GrantRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/permissions/{permission%2Did}/grant"
