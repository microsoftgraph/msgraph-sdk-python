...
grant_post_request_body = lazy_import('msgraph.generated.groups.item.sites.item.permissions.item.microsoft_graph_grant.grant_post_request_body')
grant_response = lazy_import('msgraph.generated.groups.item.sites.item.permissions.item.microsoft_graph_grant.grant_response')
