...
add_post_request_body = lazy_import('msgraph.generated.groups.item.team.channels.item.members.add.add_post_request_body')
add_response = lazy_import('msgraph.generated.groups.item.team.channels.item.members.add.add_response')
