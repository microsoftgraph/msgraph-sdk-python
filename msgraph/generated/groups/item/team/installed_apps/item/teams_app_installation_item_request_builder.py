...
microsoft_graph_upgrade_request_builder = lazy_import('msgraph.generated.groups.item.team.installed_apps.item.microsoft_graph_upgrade.microsoft_graph_upgrade_request_builder')
