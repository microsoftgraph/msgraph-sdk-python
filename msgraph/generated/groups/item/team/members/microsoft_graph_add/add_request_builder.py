...
add_post_request_body = lazy_import('msgraph.generated.groups.item.team.members.microsoft_graph_add.add_post_request_body')
add_response = lazy_import('msgraph.generated.groups.item.team.members.microsoft_graph_add.add_response')
...
class AddRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/team/members/microsoft.graph.add"
