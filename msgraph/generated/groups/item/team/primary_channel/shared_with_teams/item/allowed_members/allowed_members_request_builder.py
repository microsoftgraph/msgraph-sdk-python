...
class AllowedMembersRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> AllowedMembersRequestBuilder:
        """
    ...
    @dataclass
    class AllowedMembersRequestBuilderGetRequestConfiguration(RequestConfiguration[AllowedMembersRequestBuilderGetQueryParameters]):
        """
