...
class OpenShiftChangeRequestItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/groups/{group%2Did}/team/schedule/openShiftChangeRequests/{openShiftChangeRequest%2Did}{?%24select,%24expand}", path_parameters)
    ...
    class OpenShiftChangeRequestItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[OpenShiftChangeRequestItemRequestBuilderGetQueryParameters] = None
