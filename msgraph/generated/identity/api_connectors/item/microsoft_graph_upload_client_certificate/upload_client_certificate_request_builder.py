...
upload_client_certificate_post_request_body = lazy_import('msgraph.generated.identity.api_connectors.item.microsoft_graph_upload_client_certificate.upload_client_certificate_post_request_body')
