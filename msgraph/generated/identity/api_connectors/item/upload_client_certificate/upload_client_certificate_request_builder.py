...
upload_client_certificate_post_request_body = lazy_import('msgraph.generated.identity.api_connectors.item.upload_client_certificate.upload_client_certificate_post_request_body')
...
class UploadClientCertificateRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[upload_client_certificate_post_request_body.UploadClientCertificatePostRequestBody] = None, request_configuration: Optional[UploadClientCertificateRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
