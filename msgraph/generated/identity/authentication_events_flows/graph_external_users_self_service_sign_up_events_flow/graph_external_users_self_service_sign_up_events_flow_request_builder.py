...
if TYPE_CHECKING:
    from ....models.external_users_self_service_sign_up_events_flow_collection_response import ExternalUsersSelfServiceSignUpEventsFlowCollectionResponse
...
class GraphExternalUsersSelfServiceSignUpEventsFlowRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identity/authenticationEventsFlows/graph.externalUsersSelfServiceSignUpEventsFlow{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[GraphExternalUsersSelfServiceSignUpEventsFlowRequestBuilderGetQueryParameters]] = None) -> Optional[ExternalUsersSelfServiceSignUpEventsFlowCollectionResponse]:
        """
        ...
        Returns: Optional[ExternalUsersSelfServiceSignUpEventsFlowCollectionResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, ExternalUsersSelfServiceSignUpEventsFlowCollectionResponse, error_mapping)
