...
if TYPE_CHECKING:
    from .......models.on_attribute_collection_external_users_self_service_sign_up import OnAttributeCollectionExternalUsersSelfServiceSignUp
    from .......models.o_data_errors.o_data_error import ODataError
    from .attributes.attributes_request_builder import AttributesRequestBuilder

class GraphOnAttributeCollectionExternalUsersSelfServiceSignU_8d1599ba(BaseRequestBuilder):
    """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[OnAttributeCollectionExternalUsersSelfServiceSignUp]:
        """
        ...
        Returns: Optional[OnAttributeCollectionExternalUsersSelfServiceSignUp]
        """
    ...
    def with_url(self,raw_url: str) -> GraphOnAttributeCollectionExternalUsersSelfServiceSignU_8d1599ba:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GraphOnAttributeCollectionExternalUsersSelfServiceSignU_8d1599ba
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return GraphOnAttributeCollectionExternalUsersSelfServiceSignU_8d1599ba(self.request_adapter, raw_url)
    ...
    @dataclass
    class GraphOnAttributeCollectionExternalUsersSelfServiceSignUpRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
