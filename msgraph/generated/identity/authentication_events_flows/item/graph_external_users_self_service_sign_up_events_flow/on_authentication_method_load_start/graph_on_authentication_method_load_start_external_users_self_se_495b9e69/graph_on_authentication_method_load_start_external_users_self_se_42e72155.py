...
class GraphOnAuthenticationMethodLoadStartExternalUsersSelfSe_42e72155(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> GraphOnAuthenticationMethodLoadStartExternalUsersSelfSe_42e72155:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GraphOnAuthenticationMethodLoadStartExternalUsersSelfSe_42e72155
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return GraphOnAuthenticationMethodLoadStartExternalUsersSelfSe_42e72155(self.request_adapter, raw_url)
