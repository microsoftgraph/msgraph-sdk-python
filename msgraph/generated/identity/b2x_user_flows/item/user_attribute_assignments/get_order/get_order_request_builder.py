...
class GetOrderRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[GetOrderRequestBuilderGetRequestConfiguration] = None) -> Optional[assignment_order.AssignmentOrder]:
        """
        ...
        return await self.request_adapter.send_async(request_info, assignment_order.AssignmentOrder, error_mapping)
