...
set_order_post_request_body = lazy_import('msgraph.generated.identity.b2x_user_flows.item.user_attribute_assignments.set_order.set_order_post_request_body')
...
class SetOrderRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/userAttributeAssignments/setOrder"
