...
count_request_builder = lazy_import('msgraph.generated.identity.b2x_user_flows.item.user_flow_identity_providers.count.count_request_builder')
ref_request_builder = lazy_import('msgraph.generated.identity.b2x_user_flows.item.user_flow_identity_providers.ref.ref_request_builder')
...
class UserFlowIdentityProvidersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/userFlowIdentityProviders{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
