...
class AuthenticationStrengthRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identity/conditionalAccess/authenticationStrength{?%24select,%24expand}"
    ...
    def to_patch_request_information(self,body: Optional[authentication_strength_root.AuthenticationStrengthRoot] = None, request_configuration: Optional[AuthenticationStrengthRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property authenticationStrength in identity
        Args:
            body: The request body
    ...
    @dataclass
    class AuthenticationStrengthRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
