...
count_request_builder = lazy_import('msgraph.generated.identity.conditional_access.named_locations.count.count_request_builder')
named_location = lazy_import('msgraph.generated.models.named_location')
named_location_collection_response = lazy_import('msgraph.generated.models.named_location_collection_response')
...
class NamedLocationsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identity/conditionalAccess/namedLocations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[NamedLocationsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[named_location.NamedLocation] = None, request_configuration: Optional[NamedLocationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
