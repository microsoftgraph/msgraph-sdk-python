...
class ConditionalAccessTemplateItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, conditional_access_template_id: Optional[str] = None) -> None:
        """
        Instantiates a new ConditionalAccessTemplateItemRequestBuilder and sets the default values.
        Args:
            conditionalAccessTemplateId: key: id of conditionalAccessTemplate
        ...
        url_tpl_params["conditionalAccessTemplate%2Did"] = conditionalAccessTemplateId
