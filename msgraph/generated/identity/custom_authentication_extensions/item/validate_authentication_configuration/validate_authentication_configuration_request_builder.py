...
class ValidateAuthenticationConfigurationRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ValidateAuthenticationConfigurationRequestBuilder:
        """
    ...
    @dataclass
    class ValidateAuthenticationConfigurationRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
