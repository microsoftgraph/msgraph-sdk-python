...
class ProviderRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identity/riskPrevention/webApplicationFirewallVerifications/{webApplicationFirewallVerificationModel%2Did}/provider{?%24expand,%24select}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> ProviderRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ProviderRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return ProviderRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class ProviderRequestBuilderGetRequestConfiguration(RequestConfiguration[ProviderRequestBuilderGetQueryParameters]):
        """
