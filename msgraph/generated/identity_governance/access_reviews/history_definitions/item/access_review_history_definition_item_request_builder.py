...
class AccessReviewHistoryDefinitionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, access_review_history_definition_id: Optional[str] = None) -> None:
        """
        Instantiates a new AccessReviewHistoryDefinitionItemRequestBuilder and sets the default values.
        Args:
            accessReviewHistoryDefinitionId: key: id of accessReviewHistoryDefinition
        ...
        url_tpl_params["accessReviewHistoryDefinition%2Did"] = accessReviewHistoryDefinitionId
