...
count_request_builder = lazy_import('msgraph.generated.identity_governance.access_reviews.history_definitions.item.instances.count.count_request_builder')
access_review_history_instance = lazy_import('msgraph.generated.models.access_review_history_instance')
access_review_history_instance_collection_response = lazy_import('msgraph.generated.models.access_review_history_instance_collection_response')
...
class InstancesRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[access_review_history_instance.AccessReviewHistoryInstance] = None, request_configuration: Optional[InstancesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
