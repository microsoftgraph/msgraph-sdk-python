...
class AccessReviewHistoryInstanceItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[AccessReviewHistoryInstanceItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[access_review_history_instance.AccessReviewHistoryInstance] = None, request_configuration: Optional[AccessReviewHistoryInstanceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property instances in identityGovernance
        Args:
            body: The request body
