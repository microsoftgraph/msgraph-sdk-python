...
from .generate_download_uri import generate_download_uri_request_builder
...
class AccessReviewHistoryInstanceItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[AccessReviewHistoryInstanceItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[AccessReviewHistoryInstanceItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[access_review_history_instance.AccessReviewHistoryInstance] = None, request_configuration: Optional[AccessReviewHistoryInstanceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class AccessReviewHistoryInstanceItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class AccessReviewHistoryInstanceItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
