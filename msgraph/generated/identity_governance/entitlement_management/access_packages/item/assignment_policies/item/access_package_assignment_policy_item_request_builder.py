...
questions_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_packages.item.assignment_policies.item.questions.questions_request_builder')
access_package_question_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_packages.item.assignment_policies.item.questions.item.access_package_question_item_request_builder')
