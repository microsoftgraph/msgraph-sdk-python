...
class AdditionalAccessRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> AdditionalAccessRequestBuilder:
        """
    ...
    @dataclass
    class AdditionalAccessRequestBuilderGetRequestConfiguration(RequestConfiguration[AdditionalAccessRequestBuilderGetQueryParameters]):
        """
