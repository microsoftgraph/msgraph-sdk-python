...
filter_by_current_user_with_on_response = lazy_import('msgraph.generated.identity_governance.entitlement_management.catalogs.item.access_packages.filter_by_current_user_with_on.filter_by_current_user_with_on_response')
