...
access_packages_incompatible_with_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.catalogs.item.access_packages.item.access_packages_incompatible_with.access_packages_incompatible_with_request_builder')
access_package_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.catalogs.item.access_packages.item.access_packages_incompatible_with.item.access_package_item_request_builder')
...
microsoft_graph_get_applicable_policy_requirements_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.catalogs.item.access_packages.item.microsoft_graph_get_applicable_policy_requirements.microsoft_graph_get_applicable_policy_requirements_request_builder')
