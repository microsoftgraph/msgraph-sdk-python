...
access_package_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.catalogs.item.access_packages.item.assignment_policies.item.access_package.access_package_request_builder')
catalog_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.catalogs.item.access_packages.item.assignment_policies.item.catalog.catalog_request_builder')
questions_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.catalogs.item.access_packages.item.assignment_policies.item.questions.questions_request_builder')
access_package_question_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.catalogs.item.access_packages.item.assignment_policies.item.questions.item.access_package_question_item_request_builder')
...
class AccessPackageAssignmentPolicyItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/accessPackages/{accessPackage%2Did}/assignmentPolicies/{accessPackageAssignmentPolicy%2Did}{?%24select,%24expand}"
