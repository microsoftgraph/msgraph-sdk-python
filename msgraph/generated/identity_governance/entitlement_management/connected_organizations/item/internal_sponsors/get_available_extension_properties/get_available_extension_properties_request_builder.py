...
class GetAvailableExtensionPropertiesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/connectedOrganizations/{connectedOrganization%2Did}/internalSponsors/getAvailableExtensionProperties", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetAvailableExtensionPropertiesRequestBuilder:
        ...
        return GetAvailableExtensionPropertiesRequestBuilder(raw_url, self.request_adapter)
