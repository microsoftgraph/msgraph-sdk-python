...
get_available_extension_properties_post_request_body = lazy_import('msgraph.generated.identity_governance.entitlement_management.connected_organizations.item.internal_sponsors.microsoft_graph_get_available_extension_properties.get_available_extension_properties_post_request_body')
get_available_extension_properties_response = lazy_import('msgraph.generated.identity_governance.entitlement_management.connected_organizations.item.internal_sponsors.microsoft_graph_get_available_extension_properties.get_available_extension_properties_response')
