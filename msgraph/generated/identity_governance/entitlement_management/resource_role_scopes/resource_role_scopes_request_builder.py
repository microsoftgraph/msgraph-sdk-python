...
class ResourceRoleScopesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceRoleScopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_access_package_resource_role_scope_id(self,access_package_resource_role_scope_id: str) -> AccessPackageResourceRoleScopeItemRequestBuilder:
        ...
        Provides operations to manage the resourceRoleScopes property of the microsoft.graph.entitlementManagement entity.
        Args:
            access_package_resource_role_scope_id: The unique identifier of accessPackageResourceRoleScope
    ...
    class ResourceRoleScopesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[ResourceRoleScopesRequestBuilderGetQueryParameters] = None
