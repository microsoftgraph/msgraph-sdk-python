...
class ResourcesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/resources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_access_package_resource_id(self,access_package_resource_id: str) -> AccessPackageResourceItemRequestBuilder:
        """
        Provides operations to manage the resources property of the microsoft.graph.entitlementManagement entity.
        Args:
            access_package_resource_id: The unique identifier of accessPackageResource
    ...
    async def get(self,request_configuration: Optional[ResourcesRequestBuilderGetRequestConfiguration] = None) -> Optional[AccessPackageResourceCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[AccessPackageResource] = None, request_configuration: Optional[ResourcesRequestBuilderPostRequestConfiguration] = None) -> Optional[AccessPackageResource]:
        """
    ...
    def to_post_request_information(self,body: Optional[AccessPackageResource] = None, request_configuration: Optional[ResourcesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to resources for identityGovernance
        Args:
            body: The request body
    ...
    class ResourcesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[ResourcesRequestBuilderGetQueryParameters] = None
