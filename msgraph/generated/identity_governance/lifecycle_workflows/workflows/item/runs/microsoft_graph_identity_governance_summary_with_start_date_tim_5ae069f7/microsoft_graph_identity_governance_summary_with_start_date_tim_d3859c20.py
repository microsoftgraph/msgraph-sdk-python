...
class MicrosoftGraphIdentityGovernanceSummaryWithStartDateTim_d3859c20(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], end_date_time: Optional[datetime.datetime] = None, start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphIdentityGovernanceSummaryWithStartDateTim_d3859c20 and sets the default values.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphIdentityGovernanceSummaryWithStartDateTim_d3859c20:
        """
        ...
        return MicrosoftGraphIdentityGovernanceSummaryWithStartDateTim_d3859c20(self.request_adapter, raw_url)
