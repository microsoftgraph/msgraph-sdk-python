...
class WorkflowsRequestBuilder(BaseRequestBuilder):
    ...
    def by_workflow_id(self,workflow_id: str) -> WorkflowItemRequestBuilder:
        """
        Provides operations to manage the workflows property of the microsoft.graph.identityGovernance.lifecycleWorkflowsContainer entity.
        param workflow_id: The unique identifier of workflow
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[WorkflowsRequestBuilderGetQueryParameters]] = None) -> Optional[WorkflowCollectionResponse]:
        """
    ...
    async def post(self,body: Workflow, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Workflow]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[WorkflowsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of workflow resources that are associated with lifecycle workflows.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/identityGovernance/lifecycleWorkflows/workflows{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: Workflow, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new workflow object. You can create up to 100 workflows in a tenant.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/identityGovernance/lifecycleWorkflows/workflows', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @dataclass
    class WorkflowsRequestBuilderGetRequestConfiguration(RequestConfiguration[WorkflowsRequestBuilderGetQueryParameters]):
        """
