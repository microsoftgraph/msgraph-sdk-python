...
class AssignmentScheduleInstancesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleInstances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_privileged_access_group_assignment_schedule_instance_id(self,privileged_access_group_assignment_schedule_instance_id: str) -> PrivilegedAccessGroupAssignmentScheduleInstanceItemRequestBuilder:
        ...
        """
        if not privileged_access_group_assignment_schedule_instance_id:
    ...
    async def post(self,body: Optional[PrivilegedAccessGroupAssignmentScheduleInstance] = None, request_configuration: Optional[AssignmentScheduleInstancesRequestBuilderPostRequestConfiguration] = None) -> Optional[PrivilegedAccessGroupAssignmentScheduleInstance]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AssignmentScheduleInstancesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AssignmentScheduleInstancesRequestBuilder
        """
        if not raw_url:
    ...
    @dataclass
    class AssignmentScheduleInstancesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[AssignmentScheduleInstancesRequestBuilder.AssignmentScheduleInstancesRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class AssignmentScheduleInstancesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
