...
class AssignmentScheduleInstancesRequestBuilder(BaseRequestBuilder):
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AssignmentScheduleInstancesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of the privilegedAccessGroupAssignmentScheduleInstance objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: PrivilegedAccessGroupAssignmentScheduleInstance, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to assignmentScheduleInstances for identityGovernance
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> AssignmentScheduleInstancesRequestBuilder:
        """
    ...
    @dataclass
    class AssignmentScheduleInstancesRequestBuilderGetRequestConfiguration(RequestConfiguration[AssignmentScheduleInstancesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class AssignmentScheduleInstancesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
