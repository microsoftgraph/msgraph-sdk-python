...
acceptances_request_builder = lazy_import('msgraph.generated.identity_governance.terms_of_use.agreements.item.acceptances.acceptances_request_builder')
agreement_acceptance_item_request_builder = lazy_import('msgraph.generated.identity_governance.terms_of_use.agreements.item.acceptances.item.agreement_acceptance_item_request_builder')
file_request_builder = lazy_import('msgraph.generated.identity_governance.terms_of_use.agreements.item.file.file_request_builder')
files_request_builder = lazy_import('msgraph.generated.identity_governance.terms_of_use.agreements.item.files.files_request_builder')
agreement_file_localization_item_request_builder = lazy_import('msgraph.generated.identity_governance.terms_of_use.agreements.item.files.item.agreement_file_localization_item_request_builder')
