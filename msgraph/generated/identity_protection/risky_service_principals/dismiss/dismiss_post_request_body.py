...
@dataclass
class DismissPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    service_principal_ids: Optional[List[str]] = None
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_primitive_values("service_principal_ids", self.service_principal_ids)
