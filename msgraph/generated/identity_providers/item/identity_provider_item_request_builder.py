...
class IdentityProviderItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[IdentityProviderItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[identity_provider.IdentityProvider] = None, request_configuration: Optional[IdentityProviderItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update properties in an existing identityProvider.
        Args:
            body: The request body
