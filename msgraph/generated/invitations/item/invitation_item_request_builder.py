...
invited_user_request_builder = lazy_import('msgraph.generated.invitations.item.invited_user.invited_user_request_builder')
...
class InvitationItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[InvitationItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[InvitationItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[invitation.Invitation] = None, request_configuration: Optional[InvitationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class InvitationItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class InvitationItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
