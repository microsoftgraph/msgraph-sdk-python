...
class HeaderLogoRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/headerLogo", path_parameters)
    
    async def get(self,request_configuration: Optional[HeaderLogoRequestBuilderGetRequestConfiguration] = None) -> bytes:
        """
        Get headerLogo for organizationalBrandingLocalization from localizations
        Args:
    ...
    async def put(self,body: bytes, request_configuration: Optional[HeaderLogoRequestBuilderPutRequestConfiguration] = None) -> bytes:
        """
        Update headerLogo for organizationalBrandingLocalization in localizations
        Args:
