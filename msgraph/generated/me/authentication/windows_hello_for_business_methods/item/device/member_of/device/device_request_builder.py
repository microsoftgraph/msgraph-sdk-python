...
count_request_builder = lazy_import('msgraph.generated.me.authentication.windows_hello_for_business_methods.item.device.member_of.device.count.count_request_builder')
