...
decline_post_request_body = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.microsoft_graph_decline.decline_post_request_body')
