...
forward_post_request_body = lazy_import('msgraph.generated.me.calendars.item.calendar_view.item.instances.item.microsoft_graph_forward.forward_post_request_body')
