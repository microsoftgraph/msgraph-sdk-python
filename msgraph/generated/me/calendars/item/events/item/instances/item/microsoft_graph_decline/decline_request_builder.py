...
decline_post_request_body = lazy_import('msgraph.generated.me.calendars.item.events.item.instances.item.microsoft_graph_decline.decline_post_request_body')
