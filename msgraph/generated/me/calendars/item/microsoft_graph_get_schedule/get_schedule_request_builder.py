...
get_schedule_post_request_body = lazy_import('msgraph.generated.me.calendars.item.microsoft_graph_get_schedule.get_schedule_post_request_body')
get_schedule_response = lazy_import('msgraph.generated.me.calendars.item.microsoft_graph_get_schedule.get_schedule_response')
...
class GetScheduleRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/calendars/{calendar%2Did}/microsoft.graph.getSchedule"
