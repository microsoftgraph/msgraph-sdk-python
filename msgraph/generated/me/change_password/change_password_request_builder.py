...
change_password_post_request_body = lazy_import('msgraph.generated.me.change_password.change_password_post_request_body')
...
class ChangePasswordRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/changePassword"
