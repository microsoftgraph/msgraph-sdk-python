...
mark_chat_read_for_user_post_request_body = lazy_import('msgraph.generated.me.chats.item.microsoft_graph_mark_chat_read_for_user.mark_chat_read_for_user_post_request_body')
...
class MarkChatReadForUserRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/chats/{chat%2Did}/microsoft.graph.markChatReadForUser"
