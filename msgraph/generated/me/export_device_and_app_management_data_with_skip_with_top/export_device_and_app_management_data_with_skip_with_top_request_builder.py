...
class ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, skip: Optional[int] = None, top: Optional[int] = None) -> None:
        ...
        Args:
            ...
            top: Usage: top={top}
        """
        super().__init__(request_adapter, "{+baseurl}/me/exportDeviceAndAppManagementData(skip={skip},top={top})", path_parameters)
    ...
    @dataclass
    class ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
