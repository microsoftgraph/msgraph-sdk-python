...
get_managed_app_diagnostic_statuses_response = lazy_import('msgraph.generated.me.get_managed_app_diagnostic_statuses.get_managed_app_diagnostic_statuses_response')
...
class GetManagedAppDiagnosticStatusesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/getManagedAppDiagnosticStatuses(){?%24top,%24skip,%24search,%24filter,%24count}"
