...
count_request_builder = lazy_import('msgraph.generated.me.inference_classification.overrides.count.count_request_builder')
inference_classification_override = lazy_import('msgraph.generated.models.inference_classification_override')
inference_classification_override_collection_response = lazy_import('msgraph.generated.models.inference_classification_override_collection_response')
...
class OverridesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/inferenceClassification/overrides{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
    ...
    async def get(self,request_configuration: Optional[OverridesRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[inference_classification_override_collection_response.InferenceClassificationOverrideCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, inference_classification_override_collection_response.InferenceClassificationOverrideCollectionResponse, response_handler, error_mapping)
