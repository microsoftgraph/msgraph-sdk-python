...
delta_request_builder = lazy_import('msgraph.generated.me.joined_teams.item.channels.item.messages.item.replies.microsoft_graph_delta.delta_request_builder')
