...
microsoft_graph_complete_migration_request_builder = lazy_import('msgraph.generated.me.joined_teams.item.primary_channel.microsoft_graph_complete_migration.microsoft_graph_complete_migration_request_builder')
...
microsoft_graph_provision_email_request_builder = lazy_import('msgraph.generated.me.joined_teams.item.primary_channel.microsoft_graph_provision_email.microsoft_graph_provision_email_request_builder')
microsoft_graph_remove_email_request_builder = lazy_import('msgraph.generated.me.joined_teams.item.primary_channel.microsoft_graph_remove_email.microsoft_graph_remove_email_request_builder')
...
teams_tab_item_request_builder = lazy_import('msgraph.generated.me.joined_teams.item.primary_channel.tabs.item.teams_tab_item_request_builder')
...
class PrimaryChannelRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel{?%24select,%24expand}"
