...
class JoinedTeamsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[team.Team] = None, request_configuration: Optional[JoinedTeamsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to joinedTeams for me
        Args:
            body: The request body
