...
create_reply_post_request_body = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.create_reply.create_reply_post_request_body')
