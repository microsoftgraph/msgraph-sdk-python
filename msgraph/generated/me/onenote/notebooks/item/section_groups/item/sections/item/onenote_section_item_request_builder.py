...
copy_to_notebook_request_builder = lazy_import('msgraph.generated.me.onenote.notebooks.item.section_groups.item.sections.item.microsoft_graph_copy_to_notebook.copy_to_notebook_request_builder')
