...
microsoft_graph_copy_to_section_request_builder = lazy_import('msgraph.generated.me.onenote.notebooks.item.section_groups.item.sections.item.pages.item.microsoft_graph_copy_to_section.microsoft_graph_copy_to_section_request_builder')
microsoft_graph_onenote_patch_content_request_builder = lazy_import('msgraph.generated.me.onenote.notebooks.item.section_groups.item.sections.item.pages.item.microsoft_graph_onenote_patch_content.microsoft_graph_onenote_patch_content_request_builder')
microsoft_graph_preview_request_builder = lazy_import('msgraph.generated.me.onenote.notebooks.item.section_groups.item.sections.item.pages.item.microsoft_graph_preview.microsoft_graph_preview_request_builder')
