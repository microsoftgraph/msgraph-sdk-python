...
copy_to_section_request_builder = lazy_import('msgraph.generated.me.onenote.notebooks.item.section_groups.item.sections.item.pages.item.microsoft_graph_copy_to_section.copy_to_section_request_builder')
onenote_patch_content_request_builder = lazy_import('msgraph.generated.me.onenote.notebooks.item.section_groups.item.sections.item.pages.item.microsoft_graph_onenote_patch_content.onenote_patch_content_request_builder')
preview_request_builder = lazy_import('msgraph.generated.me.onenote.notebooks.item.section_groups.item.sections.item.pages.item.microsoft_graph_preview.preview_request_builder')
