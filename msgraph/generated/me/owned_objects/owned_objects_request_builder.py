...
graph_application_request_builder = lazy_import('msgraph.generated.me.owned_objects.graph_application.graph_application_request_builder')
graph_group_request_builder = lazy_import('msgraph.generated.me.owned_objects.graph_group.graph_group_request_builder')
graph_service_principal_request_builder = lazy_import('msgraph.generated.me.owned_objects.graph_service_principal.graph_service_principal_request_builder')
...
class OwnedObjectsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/ownedObjects{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
