...
tasks_request_builder = lazy_import('msgraph.generated.me.planner.plans.item.buckets.item.tasks.tasks_request_builder')
planner_task_item_request_builder = lazy_import('msgraph.generated.me.planner.plans.item.buckets.item.tasks.item.planner_task_item_request_builder')
...
class PlannerBucketItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}{?%24select,%24expand}"
    ...
    def to_patch_request_information(self,body: Optional[planner_bucket.PlannerBucket] = None, request_configuration: Optional[PlannerBucketItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property buckets in me
        Args:
            body: The request body
