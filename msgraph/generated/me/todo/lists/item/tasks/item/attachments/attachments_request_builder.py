...
create_upload_session_request_builder = lazy_import('msgraph.generated.me.todo.lists.item.tasks.item.attachments.create_upload_session.create_upload_session_request_builder')
