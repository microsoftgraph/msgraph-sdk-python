...
class Admin(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "service_announcement": lambda n : setattr(self, 'service_announcement', n.get_object_value(ServiceAnnouncement)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("service_announcement", self.service_announcement)
