...
if TYPE_CHECKING:
    from . import agreement_file_localization, base_collection_pagination_count_response
...
class AgreementFileLocalizationCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[agreement_file_localization.AgreementFileLocalization]] = None
