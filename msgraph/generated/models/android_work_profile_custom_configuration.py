...
@dataclass
class AndroidWorkProfileCustomConfiguration(DeviceConfiguration, Parsable):
    """
    Android Work Profile custom configuration
    """
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.androidWorkProfileCustomConfiguration"
    # OMA settings. This collection can contain a maximum of 500 elements.
    oma_settings: Optional[list[OmaSetting]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AndroidWorkProfileCustomConfiguration:
        """
