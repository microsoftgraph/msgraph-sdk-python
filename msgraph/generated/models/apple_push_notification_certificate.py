...
class ApplePushNotificationCertificate(Entity):
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("apple_identifier", self.apple_identifier)
        writer.write_str_value("certificate", self.certificate)
        writer.write_str_value("certificate_upload_failure_reason", self.certificate_upload_failure_reason)
        writer.write_str_value("certificate_upload_status", self.certificate_upload_status)
        ...
        writer.write_str_value("topic_identifier", self.topic_identifier)
