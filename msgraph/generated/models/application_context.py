...
@dataclass
class ApplicationContext(SignInContext, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.applicationContext"
    # Collection of appId values for the applications.
    include_applications: Optional[list[str]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ApplicationContext:
        """
