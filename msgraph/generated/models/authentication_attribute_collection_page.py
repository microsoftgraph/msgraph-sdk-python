...
@dataclass
class AuthenticationAttributeCollectionPage(AdditionalDataHolder, BackedModel, Parsable):
    ...
    views: Optional[list[AuthenticationAttributeCollectionPageViewConfiguration]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AuthenticationAttributeCollectionPage:
        """
