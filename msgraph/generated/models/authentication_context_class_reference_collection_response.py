...
@dataclass
class AuthenticationContextClassReferenceCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[AuthenticationContextClassReference]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AuthenticationContextClassReferenceCollectionResponse:
        """
