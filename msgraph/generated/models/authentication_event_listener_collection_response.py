...
@dataclass
class AuthenticationEventListenerCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[AuthenticationEventListener]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AuthenticationEventListenerCollectionResponse:
        """
