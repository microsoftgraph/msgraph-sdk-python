...
class AuthenticationMethodModeDetailCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[authentication_method_mode_detail.AuthenticationMethodModeDetail]] = None
    ...
    @property
    def value(self,) -> Optional[List[authentication_method_mode_detail.AuthenticationMethodModeDetail]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[authentication_method_mode_detail.AuthenticationMethodModeDetail]] = None) -> None:
        """
