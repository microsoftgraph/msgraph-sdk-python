...
@dataclass
class AverageComparativeScore_averageScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AverageComparativeScore_averageScore:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: AverageComparativeScore_averageScore
        """
        ...
        try:
            ...
            mapping_value = None
        result = AverageComparativeScore_averageScore()
