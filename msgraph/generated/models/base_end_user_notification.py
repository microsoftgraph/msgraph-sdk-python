...
class BaseEndUserNotification(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "end_user_notification": lambda n : setattr(self, 'end_user_notification', n.get_object_value(EndUserNotification)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("default_language", self.default_language)
        writer.write_object_value("end_user_notification", self.end_user_notification)
