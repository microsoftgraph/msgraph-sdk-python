...
@dataclass
class DeviceInfo_deviceGlitchEventRatio(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceInfo_deviceGlitchEventRatio:
        """
        ...
        try:
            ...
            mapping_value = None
        result = DeviceInfo_deviceGlitchEventRatio()
