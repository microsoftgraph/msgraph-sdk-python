...
@dataclass
class DeviceInfo_initialSignalLevelRootMeanSquare(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceInfo_initialSignalLevelRootMeanSquare:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DeviceInfo_initialSignalLevelRootMeanSquare
        """
        ...
        try:
            ...
            mapping_value = None
        result = DeviceInfo_initialSignalLevelRootMeanSquare()
