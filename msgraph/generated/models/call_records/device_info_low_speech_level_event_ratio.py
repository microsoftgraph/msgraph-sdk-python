...
@dataclass
class DeviceInfo_lowSpeechLevelEventRatio(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceInfo_lowSpeechLevelEventRatio:
        """
        ...
        try:
            ...
            mapping_value = None
        result = DeviceInfo_lowSpeechLevelEventRatio()
