...
@dataclass
class DeviceInfo_lowSpeechToNoiseEventRatio(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceInfo_lowSpeechToNoiseEventRatio:
        """
        ...
        try:
            ...
            mapping_value = None
        result = DeviceInfo_lowSpeechToNoiseEventRatio()
