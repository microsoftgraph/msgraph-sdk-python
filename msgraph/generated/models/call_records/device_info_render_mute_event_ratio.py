...
@dataclass
class DeviceInfo_renderMuteEventRatio(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceInfo_renderMuteEventRatio:
        """
        ...
        try:
            ...
            mapping_value = None
        result = DeviceInfo_renderMuteEventRatio()
