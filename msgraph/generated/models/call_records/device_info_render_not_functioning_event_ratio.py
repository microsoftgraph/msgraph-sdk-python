...
@dataclass
class DeviceInfo_renderNotFunctioningEventRatio(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceInfo_renderNotFunctioningEventRatio:
        """
        ...
        try:
            ...
            mapping_value = None
        result = DeviceInfo_renderNotFunctioningEventRatio()
