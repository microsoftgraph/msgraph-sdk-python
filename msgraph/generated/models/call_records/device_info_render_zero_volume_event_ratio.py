...
@dataclass
class DeviceInfo_renderZeroVolumeEventRatio(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceInfo_renderZeroVolumeEventRatio:
        """
        ...
        try:
            ...
            mapping_value = None
        result = DeviceInfo_renderZeroVolumeEventRatio()
