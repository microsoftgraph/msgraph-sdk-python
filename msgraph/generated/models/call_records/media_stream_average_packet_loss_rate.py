...
@dataclass
class MediaStream_averagePacketLossRate(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MediaStream_averagePacketLossRate:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: MediaStream_averagePacketLossRate
        """
        ...
        try:
            ...
            mapping_value = None
        result = MediaStream_averagePacketLossRate()
