...
@dataclass
class MediaStream_averageRatioOfConcealedSamples(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MediaStream_averageRatioOfConcealedSamples:
        """
        ...
        try:
            ...
            mapping_value = None
        result = MediaStream_averageRatioOfConcealedSamples()
