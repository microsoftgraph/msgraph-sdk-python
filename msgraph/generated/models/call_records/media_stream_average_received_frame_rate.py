...
@dataclass
class MediaStream_averageReceivedFrameRate(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MediaStream_averageReceivedFrameRate:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: MediaStream_averageReceivedFrameRate
        """
        ...
        try:
            ...
            mapping_value = None
        result = MediaStream_averageReceivedFrameRate()
