...
@dataclass
class MediaStream_averageVideoPacketLossRate(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MediaStream_averageVideoPacketLossRate:
        """
        ...
        try:
            ...
            mapping_value = None
        result = MediaStream_averageVideoPacketLossRate()
