...
@dataclass
class MediaStream_postForwardErrorCorrectionPacketLossRate(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MediaStream_postForwardErrorCorrectionPacketLossRate:
        """
        ...
        try:
            ...
            mapping_value = None
        result = MediaStream_postForwardErrorCorrectionPacketLossRate()
