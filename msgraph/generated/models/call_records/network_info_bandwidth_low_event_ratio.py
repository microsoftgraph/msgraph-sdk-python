...
@dataclass
class NetworkInfo_bandwidthLowEventRatio(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> NetworkInfo_bandwidthLowEventRatio:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: NetworkInfo_bandwidthLowEventRatio
        """
        ...
        try:
            ...
            mapping_value = None
        result = NetworkInfo_bandwidthLowEventRatio()
