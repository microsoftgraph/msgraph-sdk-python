...
@dataclass
class NetworkInfo_receivedQualityEventRatio(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> NetworkInfo_receivedQualityEventRatio:
        """
        ...
        try:
            ...
            mapping_value = None
        result = NetworkInfo_receivedQualityEventRatio()
