...
class CallTranscript(Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "meeting_id": lambda n : setattr(self, 'meeting_id', n.get_str_value()),
            "meeting_organizer": lambda n : setattr(self, 'meeting_organizer', n.get_object_value(IdentitySet)),
            "metadata_content": lambda n : setattr(self, 'metadata_content', n.get_bytes_value()),
            "transcript_content_url": lambda n : setattr(self, 'transcript_content_url', n.get_str_value()),
        }
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("meeting_id", self.meeting_id)
        writer.write_object_value("meeting_organizer", self.meeting_organizer)
        writer.write_bytes_value("metadata_content", self.metadata_content)
        writer.write_str_value("transcript_content_url", self.transcript_content_url)
