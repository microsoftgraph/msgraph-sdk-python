...
@dataclass
class ChannelDeletedEventMessageDetail(EventMessageDetail, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ChannelDeletedEventMessageDetail:
        """
