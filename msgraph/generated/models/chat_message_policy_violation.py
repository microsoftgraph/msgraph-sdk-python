...
class ChatMessagePolicyViolation(AdditionalDataHolder, Parsable):
    ...
    dlp_action: Optional[chat_message_policy_violation_dlp_action_types.ChatMessagePolicyViolationDlpActionTypes] = None
    # Justification text provided by the sender of the message when overriding a policy violation.
    justification_text: Optional[str] = None
    # The OdataType property
    odata_type: Optional[str] = None
    # Information to display to the message sender about why the message was flagged as a violation.
    policy_tip: Optional[chat_message_policy_violation_policy_tip.ChatMessagePolicyViolationPolicyTip] = None
    ...
    user_action: Optional[chat_message_policy_violation_user_action_types.ChatMessagePolicyViolationUserActionTypes] = None
    ...
    verdict_details: Optional[chat_message_policy_violation_verdict_details_types.ChatMessagePolicyViolationVerdictDetailsTypes] = None
