...
class CloudCommunications(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "call_records": lambda n : setattr(self, 'call_records', n.get_collection_of_object_values(CallRecord)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_object_values("call_records", self.call_records)
