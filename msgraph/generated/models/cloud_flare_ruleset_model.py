...
@dataclass
class CloudFlareRulesetModel(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CloudFlareRulesetModel:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "phaseName": lambda n : setattr(self, 'phase_name', n.get_str_value()),
            "rulesetId": lambda n : setattr(self, 'ruleset_id', n.get_str_value()),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("phaseName", self.phase_name)
        writer.write_str_value("rulesetId", self.ruleset_id)
