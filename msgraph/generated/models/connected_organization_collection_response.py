...
class ConnectedOrganizationCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[connected_organization.ConnectedOrganization]] = None
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ConnectedOrganizationCollectionResponse:
        ...
        return ConnectedOrganizationCollectionResponse()
    ...
    @property
    def value(self,) -> Optional[List[connected_organization.ConnectedOrganization]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[connected_organization.ConnectedOrganization]] = None) -> None:
        """
