...
@dataclass
class CrossTenantAccessPolicyM365CollaborationInboundSetting(AdditionalDataHolder, BackedModel, Parsable):
    ...
    users: Optional[CrossTenantAccessPolicyTargetConfiguration] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CrossTenantAccessPolicyM365CollaborationInboundSetting:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "users": lambda n : setattr(self, 'users', n.get_object_value(CrossTenantAccessPolicyTargetConfiguration)),
        }
        return fields
