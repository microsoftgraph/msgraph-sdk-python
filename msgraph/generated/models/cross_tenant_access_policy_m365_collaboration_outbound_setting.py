...
@dataclass
class CrossTenantAccessPolicyM365CollaborationOutboundSetting(AdditionalDataHolder, BackedModel, Parsable):
    ...
    # The usersAndGroups property
    users_and_groups: Optional[CrossTenantAccessPolicyTargetConfiguration] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CrossTenantAccessPolicyM365CollaborationOutboundSetting:
        """
