...
@dataclass
class CustomAuthenticationExtensionCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[CustomAuthenticationExtension]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CustomAuthenticationExtensionCollectionResponse:
        """
