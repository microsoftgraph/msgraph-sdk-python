...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, custom_security_attribute_definition
...
class CustomSecurityAttributeDefinitionCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[custom_security_attribute_definition.CustomSecurityAttributeDefinition]] = None
