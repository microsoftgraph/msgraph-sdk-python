...
if TYPE_CHECKING:
    from .data_policy_operation_status import DataPolicyOperation_status
...
class DataPolicyOperation(Entity):
    ...
    status: Optional[DataPolicyOperation_status] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "status": lambda n : setattr(self, 'status', n.get_enum_value(DataPolicyOperation_status)),
