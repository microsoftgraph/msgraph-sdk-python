...
@dataclass
class DataPolicyOperationCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[DataPolicyOperation]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DataPolicyOperationCollectionResponse:
        """
