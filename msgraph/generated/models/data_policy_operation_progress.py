...
@dataclass
class DataPolicyOperation_progress(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DataPolicyOperation_progress:
        """
        ...
        try:
            ...
            mapping_value = None
        result = DataPolicyOperation_progress()
