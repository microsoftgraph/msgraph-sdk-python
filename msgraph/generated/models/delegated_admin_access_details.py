...
@dataclass
class DelegatedAdminAccessDetails(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "unified_roles": lambda n : setattr(self, 'unified_roles', n.get_collection_of_object_values(UnifiedRole)),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_object_values("unified_roles", self.unified_roles)
