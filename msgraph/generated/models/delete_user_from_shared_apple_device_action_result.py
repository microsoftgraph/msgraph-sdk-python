...
@dataclass
class DeleteUserFromSharedAppleDeviceActionResult(DeviceActionResult, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeleteUserFromSharedAppleDeviceActionResult:
        """
