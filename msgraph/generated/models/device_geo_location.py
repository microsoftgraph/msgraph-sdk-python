...
class DeviceGeoLocation(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_float_value("horizontal_accuracy", self.horizontal_accuracy)
        writer.write_datetime_value("last_collected_date_time", self.last_collected_date_time)
        ...
        writer.write_float_value("vertical_accuracy", self.vertical_accuracy)
