...
@dataclass
class DeviceGeoLocation_horizontalAccuracy(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceGeoLocation_horizontalAccuracy:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DeviceGeoLocation_horizontalAccuracy
        """
        ...
        try:
            ...
            mapping_value = None
        result = DeviceGeoLocation_horizontalAccuracy()
