...
@dataclass
class DeviceGeoLocation_verticalAccuracy(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceGeoLocation_verticalAccuracy:
        """
        ...
        try:
            ...
            mapping_value = None
        result = DeviceGeoLocation_verticalAccuracy()
