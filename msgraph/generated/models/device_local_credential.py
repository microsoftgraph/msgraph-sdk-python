...
class DeviceLocalCredential(Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "account_sid": lambda n : setattr(self, 'account_sid', n.get_str_value()),
            "backup_date_time": lambda n : setattr(self, 'backup_date_time', n.get_datetime_value()),
            "password_base64": lambda n : setattr(self, 'password_base64', n.get_str_value()),
        }
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("account_sid", self.account_sid)
        writer.write_datetime_value("backup_date_time", self.backup_date_time)
        writer.write_str_value("password_base64", self.password_base64)
