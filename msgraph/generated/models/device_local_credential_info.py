...
class DeviceLocalCredentialInfo(Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "last_backup_date_time": lambda n : setattr(self, 'last_backup_date_time', n.get_datetime_value()),
            "refresh_date_time": lambda n : setattr(self, 'refresh_date_time', n.get_datetime_value()),
        }
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_datetime_value("last_backup_date_time", self.last_backup_date_time)
        writer.write_datetime_value("refresh_date_time", self.refresh_date_time)
