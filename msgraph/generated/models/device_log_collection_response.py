...
class DeviceLogCollectionResponse(Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "managed_device_id": lambda n : setattr(self, 'managed_device_id', n.get_uuid_value()),
            ...
            "size_in_k_b": lambda n : setattr(self, 'size_in_k_b', n.get_float_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("enrolled_by_user", self.enrolled_by_user)
        writer.write_datetime_value("expiration_date_time_u_t_c", self.expiration_date_time_u_t_c)
        writer.write_str_value("initiated_by_user_principal_name", self.initiated_by_user_principal_name)
        writer.write_uuid_value("managed_device_id", self.managed_device_id)
        writer.write_datetime_value("received_date_time_u_t_c", self.received_date_time_u_t_c)
        writer.write_datetime_value("requested_date_time_u_t_c", self.requested_date_time_u_t_c)
        writer.write_float_value("size_in_k_b", self.size_in_k_b)
