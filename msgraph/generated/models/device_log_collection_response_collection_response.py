...
@dataclass
class DeviceLogCollectionResponseCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[DeviceLogCollectionResponse]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceLogCollectionResponseCollectionResponse:
        """
