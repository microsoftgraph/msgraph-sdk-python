...
class DeviceManagementSettings(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_int_value("device_compliance_checkin_threshold_days", self.device_compliance_checkin_threshold_days)
        writer.write_bool_value("is_scheduled_action_enabled", self.is_scheduled_action_enabled)
        writer.write_str_value("@odata.type", self.odata_type)
        writer.write_bool_value("secure_by_default", self.secure_by_default)
