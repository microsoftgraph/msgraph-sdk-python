...
class EducationAssignmentGrade(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "graded_by": lambda n : setattr(self, 'graded_by', n.get_object_value(IdentitySet)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("graded_by", self.graded_by)
        writer.write_datetime_value("graded_date_time", self.graded_date_time)
