...
@dataclass
class EducationAssignmentPointsGrade_points(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> EducationAssignmentPointsGrade_points:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: EducationAssignmentPointsGrade_points
        """
        ...
        try:
            ...
            mapping_value = None
        result = EducationAssignmentPointsGrade_points()
