...
@dataclass
class EducationAssignmentPointsGradeType_maxPoints(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> EducationAssignmentPointsGradeType_maxPoints:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: EducationAssignmentPointsGradeType_maxPoints
        """
        ...
        try:
            ...
            mapping_value = None
        result = EducationAssignmentPointsGradeType_maxPoints()
