...
class EducationAssignmentRecipient(AdditionalDataHolder, Parsable):
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> EducationAssignmentRecipient:
        ...
        if mapping_value_node:
            ...
            if mapping_value == "#microsoft.graph.educationAssignmentClassRecipient":
            ...
            if mapping_value == "#microsoft.graph.educationAssignmentGroupRecipient":
            ...
            if mapping_value == "#microsoft.graph.educationAssignmentIndividualRecipient":
