...
@dataclass
class EducationFeedback(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "feedback_by": lambda n : setattr(self, 'feedback_by', n.get_object_value(IdentitySet)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("feedback_by", self.feedback_by)
        writer.write_datetime_value("feedback_date_time", self.feedback_date_time)
