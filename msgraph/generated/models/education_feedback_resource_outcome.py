...
if TYPE_CHECKING:
    from .education_feedback_resource_outcome_resource_status import EducationFeedbackResourceOutcome_resourceStatus
...
class EducationFeedbackResourceOutcome(EducationOutcome):
    ...
    resource_status: Optional[EducationFeedbackResourceOutcome_resourceStatus] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "resourceStatus": lambda n : setattr(self, 'resource_status', n.get_enum_value(EducationFeedbackResourceOutcome_resourceStatus)),
        }
