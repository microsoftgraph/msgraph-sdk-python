...
class EducationOnPremisesInfo(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        ...
        self.odata_type = "#microsoft.graph.educationOnPremisesInfo"
        # Unique identifier for the user object in Active Directory.
        self._immutable_id: Optional[str] = None

    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> EducationOnPremisesInfo:
        """
    ...
    @immutable_id.setter
    def immutable_id(self,value: Optional[str] = None) -> None:
        """
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("immutableId", self.immutable_id)
