...
class EmailSettings(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> EmailSettings:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "sender_domain": lambda n : setattr(self, 'sender_domain', n.get_str_value()),
            "use_company_branding": lambda n : setattr(self, 'use_company_branding', n.get_bool_value()),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("sender_domain", self.sender_domain)
        writer.write_bool_value("use_company_branding", self.use_company_branding)
