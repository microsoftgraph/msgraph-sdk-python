...
class EndUserNotification(Entity):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> EndUserNotification:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "notification_type": lambda n : setattr(self, 'notification_type', n.get_enum_value(EndUserNotificationType)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_enum_value("notification_type", self.notification_type)
