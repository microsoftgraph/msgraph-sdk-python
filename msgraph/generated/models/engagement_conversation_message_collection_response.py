...
@dataclass
class EngagementConversationMessageCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[EngagementConversationMessage]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> EngagementConversationMessageCollectionResponse:
        """
