...
@dataclass
class EngagementConversationQuestionMessage(EngagementConversationMessage, Parsable):
    """
    A Viva Engage conversation question message.
    """
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.engagementConversationQuestionMessage"
    # The title of the question post message on Viva Engage. Inherited from engagementConversationMessage.
    title: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> EngagementConversationQuestionMessage:
        """
