...
class EnrollmentTroubleshootingEvent(DeviceManagementTroubleshootingEvent):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "enrollment_type": lambda n : setattr(self, 'enrollment_type', n.get_enum_value(DeviceEnrollmentType)),
            "failure_category": lambda n : setattr(self, 'failure_category', n.get_enum_value(DeviceEnrollmentFailureReason)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_enum_value("enrollment_type", self.enrollment_type)
        writer.write_enum_value("failure_category", self.failure_category)
        writer.write_str_value("failure_reason", self.failure_reason)
        writer.write_str_value("managed_device_identifier", self.managed_device_identifier)
