...
class Fido2KeyRestrictions(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "enforcement_type": lambda n : setattr(self, 'enforcement_type', n.get_enum_value(Fido2RestrictionEnforcementType)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_primitive_values("aa_guids", self.aa_guids)
        writer.write_enum_value("enforcement_type", self.enforcement_type)
        writer.write_bool_value("is_enforced", self.is_enforced)
