...
class FileHash(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "hash_type": lambda n : setattr(self, 'hash_type', n.get_enum_value(FileHashType)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_enum_value("hash_type", self.hash_type)
        writer.write_str_value("hash_value", self.hash_value)
