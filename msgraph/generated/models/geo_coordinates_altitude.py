...
@dataclass
class GeoCoordinates_altitude(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GeoCoordinates_altitude:
        """
        ...
        try:
            ...
            mapping_value = None
        result = GeoCoordinates_altitude()
