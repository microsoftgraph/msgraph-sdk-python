...
@dataclass
class GeoCoordinates_latitude(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GeoCoordinates_latitude:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: GeoCoordinates_latitude
        """
        ...
        try:
            ...
            mapping_value = None
        result = GeoCoordinates_latitude()
