...
@dataclass
class PercentageBasedQuarantineCondition(QuarantineCondition, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.identityGovernance.percentageBasedQuarantineCondition"
    # The maximum percentage of in-scope users a workflow run can process before the workflow is quarantined.
    percentage: Optional[int] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PercentageBasedQuarantineCondition:
        """
