...
@dataclass
class IdentityUserFlow_userFlowTypeVersion(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> IdentityUserFlow_userFlowTypeVersion:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: IdentityUserFlow_userFlowTypeVersion
        """
        ...
        try:
            ...
            mapping_value = None
        result = IdentityUserFlow_userFlowTypeVersion()
