...
class InboundOutboundPolicyConfiguration(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "inbound_allowed": lambda n : setattr(self, 'inbound_allowed', n.get_bool_value()),
            "@odata.type": lambda n : setattr(self, 'odata_type', n.get_str_value()),
            "outbound_allowed": lambda n : setattr(self, 'outbound_allowed', n.get_bool_value()),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_bool_value("inbound_allowed", self.inbound_allowed)
        writer.write_str_value("@odata.type", self.odata_type)
        writer.write_bool_value("outbound_allowed", self.outbound_allowed)
