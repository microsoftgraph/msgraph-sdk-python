...
@dataclass
class InsightValueDouble_value(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> InsightValueDouble_value:
        """
        ...
        try:
            ...
            mapping_value = None
        result = InsightValueDouble_value()
