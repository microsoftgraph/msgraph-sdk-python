...
class InternalDomainFederation(saml_or_ws_fed_provider.SamlOrWsFedProvider):
    ...
    federated_idp_mfa_behavior: Optional[federated_idp_mfa_behavior.FederatedIdpMfaBehavior] = None
    ...
    prompt_login_behavior: Optional[prompt_login_behavior.PromptLoginBehavior] = None
    ...
    signing_certificate_update_status: Optional[signing_certificate_update_status.SigningCertificateUpdateStatus] = None
