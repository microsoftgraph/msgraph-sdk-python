...
if TYPE_CHECKING:
    from .internal_domain_federation_federated_idp_mfa_behavior import InternalDomainFederation_federatedIdpMfaBehavior
    from .internal_domain_federation_prompt_login_behavior import InternalDomainFederation_promptLoginBehavior
...
class InternalDomainFederation(SamlOrWsFedProvider):
    ...
    federated_idp_mfa_behavior: Optional[InternalDomainFederation_federatedIdpMfaBehavior] = None
    ...
    prompt_login_behavior: Optional[InternalDomainFederation_promptLoginBehavior] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "federatedIdpMfaBehavior": lambda n : setattr(self, 'federated_idp_mfa_behavior', n.get_enum_value(InternalDomainFederation_federatedIdpMfaBehavior)),
            ...
            "promptLoginBehavior": lambda n : setattr(self, 'prompt_login_behavior', n.get_enum_value(InternalDomainFederation_promptLoginBehavior)),
