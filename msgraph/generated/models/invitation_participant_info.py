...
class InvitationParticipantInfo(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_bool_value("remove_from_default_audio_routing_group", self.remove_from_default_audio_routing_group)
        writer.write_str_value("replaces_call_id", self.replaces_call_id)
