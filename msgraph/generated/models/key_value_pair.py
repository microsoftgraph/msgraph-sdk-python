...
class KeyValuePair(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        ...
        self.odata_type = "#microsoft.graph.keyValuePair"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> KeyValuePair:
        """
