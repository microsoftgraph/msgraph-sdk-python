...
class LearningAssignment(LearningCourseActivity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "assigner_user_id": lambda n : setattr(self, 'assigner_user_id', n.get_str_value()),
            "assignment_type": lambda n : setattr(self, 'assignment_type', n.get_enum_value(AssignmentType)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("assigner_user_id", self.assigner_user_id)
