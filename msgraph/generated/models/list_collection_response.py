...
@dataclass
class ListCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[List_]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ListCollectionResponse:
        """
