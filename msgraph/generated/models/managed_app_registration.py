...
class ManagedAppRegistration(entity.Entity):
    ...
    app_identifier: Optional[mobile_app_identifier.MobileAppIdentifier] = None
    # App version
    application_version: Optional[str] = None
    # Zero or more policys already applied on the registered app when it last synchronized with managment service.
    applied_policies: Optional[List[managed_app_policy.ManagedAppPolicy]] = None
    ...
    flagged_reasons: Optional[List[managed_app_flagged_reason.ManagedAppFlaggedReason]] = None
    # Zero or more policies admin intended for the app as of now.
    intended_policies: Optional[List[managed_app_policy.ManagedAppPolicy]] = None
    ...
    operations: Optional[List[managed_app_operation.ManagedAppOperation]] = None
