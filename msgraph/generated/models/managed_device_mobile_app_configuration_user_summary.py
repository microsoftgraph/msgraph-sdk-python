...
@dataclass
class ManagedDeviceMobileAppConfigurationUserSummary(Entity, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ManagedDeviceMobileAppConfigurationUserSummary:
        """
