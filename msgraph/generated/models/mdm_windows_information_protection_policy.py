...
@dataclass
class MdmWindowsInformationProtectionPolicy(WindowsInformationProtection, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MdmWindowsInformationProtectionPolicy:
        """
