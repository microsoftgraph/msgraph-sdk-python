...
class MediaContentRatingGermany(AdditionalDataHolder, Parsable):
    ...
    movie_rating: Optional[rating_germany_movies_type.RatingGermanyMoviesType] = None
    # The OdataType property
    odata_type: Optional[str] = None
    # TV content rating labels in Germany
    tv_rating: Optional[rating_germany_television_type.RatingGermanyTelevisionType] = None
