...
class MediaContentRatingIreland(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "movie_rating": lambda n : setattr(self, 'movie_rating', n.get_enum_value(RatingIrelandMoviesType)),
            "@odata.type": lambda n : setattr(self, 'odata_type', n.get_str_value()),
            "tv_rating": lambda n : setattr(self, 'tv_rating', n.get_enum_value(RatingIrelandTelevisionType)),
        }
        return fields
