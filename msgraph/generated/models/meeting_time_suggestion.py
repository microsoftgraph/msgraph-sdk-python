...
class MeetingTimeSuggestion(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "attendee_availability": lambda n : setattr(self, 'attendee_availability', n.get_collection_of_object_values(AttendeeAvailability)),
            ...
            "meeting_time_slot": lambda n : setattr(self, 'meeting_time_slot', n.get_object_value(TimeSlot)),
            "@odata.type": lambda n : setattr(self, 'odata_type', n.get_str_value()),
            "order": lambda n : setattr(self, 'order', n.get_int_value()),
            "organizer_availability": lambda n : setattr(self, 'organizer_availability', n.get_enum_value(FreeBusyStatus)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_object_values("attendee_availability", self.attendee_availability)
        writer.write_float_value("confidence", self.confidence)
        writer.write_collection_of_object_values("locations", self.locations)
        writer.write_object_value("meeting_time_slot", self.meeting_time_slot)
        writer.write_str_value("@odata.type", self.odata_type)
        writer.write_int_value("order", self.order)
        writer.write_enum_value("organizer_availability", self.organizer_availability)
        writer.write_str_value("suggestion_reason", self.suggestion_reason)
