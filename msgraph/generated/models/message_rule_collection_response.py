...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, message_rule

from . import base_collection_pagination_count_response

class MessageRuleCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[message_rule.MessageRule]] = None
    ...
    @property
    def value(self,) -> Optional[List[message_rule.MessageRule]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[message_rule.MessageRule]] = None) -> None:
        """
