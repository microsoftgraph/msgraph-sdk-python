...
if TYPE_CHECKING:
    from .microsoft_managed_training_setting_training_completion_duration import MicrosoftManagedTrainingSetting_trainingCompletionDuration
...
class MicrosoftManagedTrainingSetting(TrainingSetting):
    ...
    training_completion_duration: Optional[MicrosoftManagedTrainingSetting_trainingCompletionDuration] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "trainingCompletionDuration": lambda n : setattr(self, 'training_completion_duration', n.get_enum_value(MicrosoftManagedTrainingSetting_trainingCompletionDuration)),
        }
