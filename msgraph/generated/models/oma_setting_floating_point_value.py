...
@dataclass
class OmaSettingFloatingPoint_value(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> OmaSettingFloatingPoint_value:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: OmaSettingFloatingPoint_value
        """
        ...
        try:
            ...
            mapping_value = None
        result = OmaSettingFloatingPoint_value()
