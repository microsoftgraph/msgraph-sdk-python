...
class OnenoteOperationError(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        ...
        self.odata_type = "#microsoft.graph.onenoteOperationError"
        # The error code.
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> OnenoteOperationError:
        """
