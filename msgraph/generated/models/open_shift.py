...
class OpenShift(ChangeTrackedEntity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "draft_open_shift": lambda n : setattr(self, 'draft_open_shift', n.get_object_value(OpenShiftItem)),
            "scheduling_group_id": lambda n : setattr(self, 'scheduling_group_id', n.get_str_value()),
            "shared_open_shift": lambda n : setattr(self, 'shared_open_shift', n.get_object_value(OpenShiftItem)),
        }
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("draft_open_shift", self.draft_open_shift)
        writer.write_str_value("scheduling_group_id", self.scheduling_group_id)
        writer.write_object_value("shared_open_shift", self.shared_open_shift)
