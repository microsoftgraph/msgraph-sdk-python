...
@dataclass
class OutlookGeoCoordinates_accuracy(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> OutlookGeoCoordinates_accuracy:
        """
        ...
        try:
            ...
            mapping_value = None
        result = OutlookGeoCoordinates_accuracy()
