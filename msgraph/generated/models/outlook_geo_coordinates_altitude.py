...
@dataclass
class OutlookGeoCoordinates_altitude(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> OutlookGeoCoordinates_altitude:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: OutlookGeoCoordinates_altitude
        """
        ...
        try:
            ...
            mapping_value = None
        result = OutlookGeoCoordinates_altitude()
