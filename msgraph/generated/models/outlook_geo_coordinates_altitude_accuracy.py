...
@dataclass
class OutlookGeoCoordinates_altitudeAccuracy(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> OutlookGeoCoordinates_altitudeAccuracy:
        """
        ...
        try:
            ...
            mapping_value = None
        result = OutlookGeoCoordinates_altitudeAccuracy()
