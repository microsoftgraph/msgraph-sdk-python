...
class Payload(Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "simulation_attack_type": lambda n : setattr(self, 'simulation_attack_type', n.get_enum_value(SimulationAttackType)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_bool_value("is_automated", self.is_automated)
        writer.write_bool_value("is_controversial", self.is_controversial)
        writer.write_bool_value("is_current_event", self.is_current_event)
        ...
        writer.write_collection_of_primitive_values("payload_tags", self.payload_tags)
        writer.write_enum_value("platform", self.platform)
        writer.write_float_value("predicted_compromise_rate", self.predicted_compromise_rate)
        writer.write_enum_value("simulation_attack_type", self.simulation_attack_type)
