...
@dataclass
class Payload_predictedCompromiseRate(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Payload_predictedCompromiseRate:
        """
        ...
        try:
            ...
            mapping_value = None
        result = Payload_predictedCompromiseRate()
