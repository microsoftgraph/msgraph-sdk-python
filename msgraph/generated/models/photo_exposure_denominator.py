...
@dataclass
class Photo_exposureDenominator(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Photo_exposureDenominator:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: Photo_exposureDenominator
        """
        ...
        try:
            ...
            mapping_value = None
        result = Photo_exposureDenominator()
