...
@dataclass
class PrintCertificateSigningRequest(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PrintCertificateSigningRequest:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "transportKey": lambda n : setattr(self, 'transport_key', n.get_str_value()),
        }
        return fields
