...
class PrintSettings(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        ...
        self.odata_type = "#microsoft.graph.printSettings"
        ...
        self._document_conversion_enabled: Optional[bool] = None

    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> PrintSettings:
        """
    ...
    @property
    def document_conversion_enabled(self,) -> Optional[bool]:
        """
        ...
        """
        return self._document_conversion_enabled

    @document_conversion_enabled.setter
    def document_conversion_enabled(self,value: Optional[bool] = None) -> None:
        """
