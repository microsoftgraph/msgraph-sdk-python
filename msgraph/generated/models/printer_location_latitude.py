...
@dataclass
class PrinterLocation_latitude(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PrinterLocation_latitude:
        """
        ...
        try:
            ...
            mapping_value = None
        result = PrinterLocation_latitude()
