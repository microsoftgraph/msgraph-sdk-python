...
@dataclass
class PrinterLocation_longitude(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PrinterLocation_longitude:
        """
        ...
        try:
            ...
            mapping_value = None
        result = PrinterLocation_longitude()
