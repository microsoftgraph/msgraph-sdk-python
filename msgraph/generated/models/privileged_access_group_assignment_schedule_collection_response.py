...
@dataclass
class PrivilegedAccessGroupAssignmentScheduleCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[PrivilegedAccessGroupAssignmentSchedule]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PrivilegedAccessGroupAssignmentScheduleCollectionResponse:
        """
