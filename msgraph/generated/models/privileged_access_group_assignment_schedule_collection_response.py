...
@dataclass
class PrivilegedAccessGroupAssignmentScheduleCollectionResponse(BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[PrivilegedAccessGroupAssignmentSchedule]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> PrivilegedAccessGroupAssignmentScheduleCollectionResponse:
        """
        ...
        return PrivilegedAccessGroupAssignmentScheduleCollectionResponse()
