...
@dataclass
class PrivilegedAccessGroupAssignmentScheduleRequestCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[PrivilegedAccessGroupAssignmentScheduleRequest]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PrivilegedAccessGroupAssignmentScheduleRequestCollectionResponse:
        """
