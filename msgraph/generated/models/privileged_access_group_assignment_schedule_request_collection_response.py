...
@dataclass
class PrivilegedAccessGroupAssignmentScheduleRequestCollectionResponse(BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[PrivilegedAccessGroupAssignmentScheduleRequest]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> PrivilegedAccessGroupAssignmentScheduleRequestCollectionResponse:
        """
