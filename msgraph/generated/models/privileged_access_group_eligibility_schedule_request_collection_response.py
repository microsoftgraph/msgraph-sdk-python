...
@dataclass
class PrivilegedAccessGroupEligibilityScheduleRequestCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[PrivilegedAccessGroupEligibilityScheduleRequest]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PrivilegedAccessGroupEligibilityScheduleRequestCollectionResponse:
        """
