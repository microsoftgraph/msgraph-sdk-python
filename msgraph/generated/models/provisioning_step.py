...
class ProvisioningStep(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "provisioning_step_type": lambda n : setattr(self, 'provisioning_step_type', n.get_enum_value(ProvisioningStepType)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_enum_value("provisioning_step_type", self.provisioning_step_type)
