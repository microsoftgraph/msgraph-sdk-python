...
@dataclass
class RecommendedAction_potentialScoreImpact(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RecommendedAction_potentialScoreImpact:
        """
        ...
        try:
            ...
            mapping_value = None
        result = RecommendedAction_potentialScoreImpact()
