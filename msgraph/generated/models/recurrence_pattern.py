...
class RecurrencePattern(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "days_of_week": lambda n : setattr(self, 'days_of_week', n.get_collection_of_enum_values(DayOfWeek)),
            "first_day_of_week": lambda n : setattr(self, 'first_day_of_week', n.get_enum_value(DayOfWeek)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_int_value("day_of_month", self.day_of_month)
        writer.write_collection_of_enum_values("days_of_week", self.days_of_week)
        writer.write_enum_value("first_day_of_week", self.first_day_of_week)
