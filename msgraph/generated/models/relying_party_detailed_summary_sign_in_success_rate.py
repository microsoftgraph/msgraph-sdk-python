...
@dataclass
class RelyingPartyDetailedSummary_signInSuccessRate(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RelyingPartyDetailedSummary_signInSuccessRate:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RelyingPartyDetailedSummary_signInSuccessRate
        """
        ...
        try:
            ...
            mapping_value = None
        result = RelyingPartyDetailedSummary_signInSuccessRate()
