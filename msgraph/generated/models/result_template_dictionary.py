...
class ResultTemplateDictionary(dictionary.Dictionary):
    def __init__(self,) -> None:
        ...
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.resultTemplateDictionary"

    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ResultTemplateDictionary:
        """
