...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, risky_service_principal_history_item
...
class RiskyServicePrincipalHistoryItemCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[risky_service_principal_history_item.RiskyServicePrincipalHistoryItem]] = None
