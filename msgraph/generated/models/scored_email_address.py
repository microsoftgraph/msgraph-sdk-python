...
if TYPE_CHECKING:
    from .scored_email_address_selection_likelihood import ScoredEmailAddress_selectionLikelihood
...
class ScoredEmailAddress(AdditionalDataHolder, BackedModel, Parsable):
    ...
    selection_likelihood: Optional[ScoredEmailAddress_selectionLikelihood] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "selectionLikelihood": lambda n : setattr(self, 'selection_likelihood', n.get_enum_value(ScoredEmailAddress_selectionLikelihood)),
        }
        return fields
