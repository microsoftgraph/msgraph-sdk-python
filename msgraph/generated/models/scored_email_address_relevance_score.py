...
@dataclass
class ScoredEmailAddress_relevanceScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ScoredEmailAddress_relevanceScore:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ScoredEmailAddress_relevanceScore
        """
        ...
        try:
            ...
            mapping_value = None
        result = ScoredEmailAddress_relevanceScore()
