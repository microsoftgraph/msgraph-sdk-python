...
@dataclass
class SearchQuery(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("query_string", self.query_string)
        writer.write_str_value("query_template", self.query_template)
