...
@dataclass
class SecureScoreControlProfile_maxScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> SecureScoreControlProfile_maxScore:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: SecureScoreControlProfile_maxScore
        """
        ...
        try:
            ...
            mapping_value = None
        result = SecureScoreControlProfile_maxScore()
