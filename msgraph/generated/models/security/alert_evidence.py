...
class AlertEvidence(AdditionalDataHolder, Parsable):
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AlertEvidence:
        ...
        if mapping_value_node:
            ...
            if mapping_value == "#microsoft.graph.security.amazonResourceEvidence":
            ...
            if mapping_value == "#microsoft.graph.security.azureResourceEvidence":
            ...
            if mapping_value == "#microsoft.graph.security.googleCloudResourceEvidence":
