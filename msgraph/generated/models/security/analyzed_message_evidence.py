...
class AnalyzedMessageEvidence(AlertEvidence):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "p1_sender": lambda n : setattr(self, 'p1_sender', n.get_object_value(EmailSender)),
            "p2_sender": lambda n : setattr(self, 'p2_sender', n.get_object_value(EmailSender)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("anti_spam_direction", self.anti_spam_direction)
        ...
        writer.write_object_value("p1_sender", self.p1_sender)
        writer.write_object_value("p2_sender", self.p2_sender)
        writer.write_datetime_value("received_date_time", self.received_date_time)
        writer.write_str_value("recipient_email_address", self.recipient_email_address)
        writer.write_str_value("sender_ip", self.sender_ip)
        writer.write_str_value("subject", self.subject)
        writer.write_collection_of_primitive_values("threat_detection_methods", self.threat_detection_methods)
        writer.write_collection_of_primitive_values("threats", self.threats)
        writer.write_int_value("url_count", self.url_count)
