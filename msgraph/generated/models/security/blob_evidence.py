...
class BlobEvidence(AlertEvidence):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "blob_container": lambda n : setattr(self, 'blob_container', n.get_object_value(BlobContainerEvidence)),
            "etag": lambda n : setattr(self, 'etag', n.get_str_value()),
            "file_hashes": lambda n : setattr(self, 'file_hashes', n.get_collection_of_object_values(FileHash)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("blob_container", self.blob_container)
        writer.write_str_value("etag", self.etag)
        writer.write_collection_of_object_values("file_hashes", self.file_hashes)
