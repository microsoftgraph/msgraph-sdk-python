...
class EdiscoveryCustodianCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[ediscovery_custodian.EdiscoveryCustodian]] = None
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> EdiscoveryCustodianCollectionResponse:
        ...
        return EdiscoveryCustodianCollectionResponse()
    ...
    @property
    def value(self,) -> Optional[List[ediscovery_custodian.EdiscoveryCustodian]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[ediscovery_custodian.EdiscoveryCustodian]] = None) -> None:
        """
