...
class RetentionEventTypeCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[retention_event_type.RetentionEventType]] = None
    ...
    @property
    def value(self,) -> Optional[List[retention_event_type.RetentionEventType]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[retention_event_type.RetentionEventType]] = None) -> None:
        """
