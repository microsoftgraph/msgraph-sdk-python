...
class ServiceAnnouncementAttachmentCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[service_announcement_attachment.ServiceAnnouncementAttachment]] = None
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ServiceAnnouncementAttachmentCollectionResponse:
        ...
        return ServiceAnnouncementAttachmentCollectionResponse()
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(service_announcement_attachment.ServiceAnnouncementAttachment)),
        }
    ...
    @property
    def value(self,) -> Optional[List[service_announcement_attachment.ServiceAnnouncementAttachment]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[service_announcement_attachment.ServiceAnnouncementAttachment]] = None) -> None:
        """
