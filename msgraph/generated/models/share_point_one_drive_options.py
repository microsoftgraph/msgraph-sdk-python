...
class SharePointOneDriveOptions(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "include_content": lambda n : setattr(self, 'include_content', n.get_collection_of_enum_values(SearchContent)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_enum_value("include_content", self.include_content)
