...
class SharedWithChannelTeamInfoCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[shared_with_channel_team_info.SharedWithChannelTeamInfo]] = None
    ...
    @property
    def value(self,) -> Optional[List[shared_with_channel_team_info.SharedWithChannelTeamInfo]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[shared_with_channel_team_info.SharedWithChannelTeamInfo]] = None) -> None:
        """
