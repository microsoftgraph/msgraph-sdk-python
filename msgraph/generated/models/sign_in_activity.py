...
class SignInActivity(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_datetime_value("last_non_interactive_sign_in_date_time", self.last_non_interactive_sign_in_date_time)
        writer.write_str_value("last_non_interactive_sign_in_request_id", self.last_non_interactive_sign_in_request_id)
        writer.write_datetime_value("last_sign_in_date_time", self.last_sign_in_date_time)
        writer.write_str_value("last_sign_in_request_id", self.last_sign_in_request_id)
