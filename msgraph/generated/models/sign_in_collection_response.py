...
@dataclass
class SignInCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[SignIn]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> SignInCollectionResponse:
        """
