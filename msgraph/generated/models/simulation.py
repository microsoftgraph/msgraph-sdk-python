...
class Simulation(Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "attack_technique": lambda n : setattr(self, 'attack_technique', n.get_enum_value(SimulationAttackTechnique)),
            "attack_type": lambda n : setattr(self, 'attack_type', n.get_enum_value(SimulationAttackType)),
            ...
            "end_user_notification_setting": lambda n : setattr(self, 'end_user_notification_setting', n.get_object_value(EndUserNotificationSetting)),
            "excluded_account_target": lambda n : setattr(self, 'excluded_account_target', n.get_object_value(AccountTargetContent)),
            "included_account_target": lambda n : setattr(self, 'included_account_target', n.get_object_value(AccountTargetContent)),
            "is_automated": lambda n : setattr(self, 'is_automated', n.get_bool_value()),
            "landing_page": lambda n : setattr(self, 'landing_page', n.get_object_value(LandingPage)),
            ...
            "login_page": lambda n : setattr(self, 'login_page', n.get_object_value(LoginPage)),
            "o_auth_consent_app_detail": lambda n : setattr(self, 'o_auth_consent_app_detail', n.get_object_value(OAuthConsentAppDetail)),
            "payload": lambda n : setattr(self, 'payload', n.get_object_value(Payload)),
            "payload_delivery_platform": lambda n : setattr(self, 'payload_delivery_platform', n.get_enum_value(PayloadDeliveryPlatform)),
            ...
            "training_setting": lambda n : setattr(self, 'training_setting', n.get_object_value(TrainingSetting)),
        }
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_enum_value("attack_technique", self.attack_technique)
        writer.write_enum_value("attack_type", self.attack_type)
        writer.write_str_value("automation_id", self.automation_id)
        ...
        writer.write_object_value("end_user_notification_setting", self.end_user_notification_setting)
        writer.write_object_value("excluded_account_target", self.excluded_account_target)
        writer.write_object_value("included_account_target", self.included_account_target)
        writer.write_bool_value("is_automated", self.is_automated)
        writer.write_object_value("landing_page", self.landing_page)
        ...
        writer.write_datetime_value("launch_date_time", self.launch_date_time)
        writer.write_object_value("login_page", self.login_page)
        writer.write_object_value("o_auth_consent_app_detail", self.o_auth_consent_app_detail)
        writer.write_object_value("payload", self.payload)
        writer.write_enum_value("payload_delivery_platform", self.payload_delivery_platform)
        writer.write_object_value("report", self.report)
        writer.write_enum_value("status", self.status)
        writer.write_object_value("training_setting", self.training_setting)
