...
@dataclass
class SimulationEventsContent_compromisedRate(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> SimulationEventsContent_compromisedRate:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: SimulationEventsContent_compromisedRate
        """
        ...
        try:
            ...
            mapping_value = None
        result = SimulationEventsContent_compromisedRate()
