...
if TYPE_CHECKING:
    ...
    from .simulation_notification_targetted_user_type import SimulationNotification_targettedUserType
...
class SimulationNotification(BaseEndUserNotification):
    ...
    targetted_user_type: Optional[SimulationNotification_targettedUserType] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "targettedUserType": lambda n : setattr(self, 'targetted_user_type', n.get_enum_value(SimulationNotification_targettedUserType)),
        }
