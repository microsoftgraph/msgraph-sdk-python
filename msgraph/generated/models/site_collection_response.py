...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, site

from . import base_collection_pagination_count_response

class SiteCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
