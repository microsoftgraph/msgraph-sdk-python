...
class SpecialFolder(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        ...
        self.odata_type = "#microsoft.graph.specialFolder"
        # The unique identifier for this item in the /drive/special collection
        self._name: Optional[str] = None

    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> SpecialFolder:
        """
