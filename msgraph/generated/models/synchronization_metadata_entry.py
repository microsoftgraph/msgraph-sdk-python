...
if TYPE_CHECKING:
    from .synchronization_metadata_entry_key import SynchronizationMetadataEntry_key
...
class SynchronizationMetadataEntry(AdditionalDataHolder, BackedModel, Parsable):
    ...
    key: Optional[SynchronizationMetadataEntry_key] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "key": lambda n : setattr(self, 'key', n.get_enum_value(SynchronizationMetadataEntry_key)),
