...
class SynchronizationSecretKeyStringValuePair(AdditionalDataHolder, Parsable):
    ...
    @property
    def key(self,) -> Optional[synchronization_secret.SynchronizationSecret]:
        """
        Gets the key property value. The key property
        Returns: Optional[synchronization_secret.SynchronizationSecret]
        """
        return self._key
    
    @key.setter
    def key(self,value: Optional[synchronization_secret.SynchronizationSecret] = None) -> None:
        """
