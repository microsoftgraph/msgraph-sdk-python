...
@dataclass
class TeamDescriptionUpdatedEventMessageDetail(EventMessageDetail, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.teamDescriptionUpdatedEventMessageDetail"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TeamDescriptionUpdatedEventMessageDetail:
        """
