...
@dataclass
class TeamJoiningDisabledEventMessageDetail(EventMessageDetail, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.teamJoiningDisabledEventMessageDetail"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TeamJoiningDisabledEventMessageDetail:
        """
