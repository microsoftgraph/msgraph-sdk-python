...
class TeamsAppResourceSpecificPermission(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "permission_type": lambda n : setattr(self, 'permission_type', n.get_enum_value(TeamsAppResourceSpecificPermissionType)),
            "permission_value": lambda n : setattr(self, 'permission_value', n.get_str_value()),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("permission_value", self.permission_value)
