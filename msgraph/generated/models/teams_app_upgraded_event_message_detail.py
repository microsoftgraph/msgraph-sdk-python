...
@dataclass
class TeamsAppUpgradedEventMessageDetail(EventMessageDetail, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.teamsAppUpgradedEventMessageDetail"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TeamsAppUpgradedEventMessageDetail:
        """
