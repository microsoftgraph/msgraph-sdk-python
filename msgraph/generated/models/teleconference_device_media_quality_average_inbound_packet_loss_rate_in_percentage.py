...
@dataclass
class TeleconferenceDeviceMediaQuality_averageInboundPacketLossRateInPercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TeleconferenceDeviceMediaQuality_averageInboundPacketLossRateInPercentage:
        """
        ...
        try:
            ...
            mapping_value = None
        result = TeleconferenceDeviceMediaQuality_averageInboundPacketLossRateInPercentage()
