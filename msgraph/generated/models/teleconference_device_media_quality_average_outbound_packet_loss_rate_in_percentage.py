...
@dataclass
class TeleconferenceDeviceMediaQuality_averageOutboundPacketLossRateInPercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TeleconferenceDeviceMediaQuality_averageOutboundPacketLossRateInPercentage:
        """
        ...
        try:
            ...
            mapping_value = None
        result = TeleconferenceDeviceMediaQuality_averageOutboundPacketLossRateInPercentage()
