...
@dataclass
class TeleconferenceDeviceMediaQuality_maximumInboundPacketLossRateInPercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TeleconferenceDeviceMediaQuality_maximumInboundPacketLossRateInPercentage:
        """
        ...
        try:
            ...
            mapping_value = None
        result = TeleconferenceDeviceMediaQuality_maximumInboundPacketLossRateInPercentage()
