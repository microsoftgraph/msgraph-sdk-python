...
@dataclass
class TeleconferenceDeviceMediaQuality_maximumOutboundPacketLossRateInPercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TeleconferenceDeviceMediaQuality_maximumOutboundPacketLossRateInPercentage:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: TeleconferenceDeviceMediaQuality_maximumOutboundPacketLossRateInPercentage
        """
        ...
        try:
            ...
            mapping_value = None
        result = TeleconferenceDeviceMediaQuality_maximumOutboundPacketLossRateInPercentage()
