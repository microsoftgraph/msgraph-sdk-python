...
@dataclass
class TeleconferenceDeviceVideoQuality_averageInboundFrameRate(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TeleconferenceDeviceVideoQuality_averageInboundFrameRate:
        """
        ...
        try:
            ...
            mapping_value = None
        result = TeleconferenceDeviceVideoQuality_averageInboundFrameRate()
