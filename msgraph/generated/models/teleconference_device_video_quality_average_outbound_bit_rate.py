...
@dataclass
class TeleconferenceDeviceVideoQuality_averageOutboundBitRate(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TeleconferenceDeviceVideoQuality_averageOutboundBitRate:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: TeleconferenceDeviceVideoQuality_averageOutboundBitRate
        """
        ...
        try:
            ...
            mapping_value = None
        result = TeleconferenceDeviceVideoQuality_averageOutboundBitRate()
