...
@dataclass
class TeleconferenceDeviceVideoQuality_averageOutboundFrameRate(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TeleconferenceDeviceVideoQuality_averageOutboundFrameRate:
        """
        ...
        try:
            ...
            mapping_value = None
        result = TeleconferenceDeviceVideoQuality_averageOutboundFrameRate()
