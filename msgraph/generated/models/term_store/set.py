...
class Set(Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "localized_names": lambda n : setattr(self, 'localized_names', n.get_collection_of_object_values(LocalizedName)),
            "parent_group": lambda n : setattr(self, 'parent_group', n.get_object_value(Group)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_object_values("localized_names", self.localized_names)
        writer.write_object_value("parent_group", self.parent_group)
