...
@dataclass
class StoreCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[Store]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> StoreCollectionResponse:
        """
