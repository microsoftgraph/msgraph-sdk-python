...
class UnifiedRbacResourceAction(Entity):
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("action_verb", self.action_verb)
        writer.write_str_value("authentication_context_id", self.authentication_context_id)
        writer.write_str_value("description", self.description)
        writer.write_bool_value("is_authentication_context_settable", self.is_authentication_context_settable)
        writer.write_str_value("name", self.name)
        writer.write_str_value("resource_scope_id", self.resource_scope_id)
