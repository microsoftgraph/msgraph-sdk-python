...
@dataclass
class UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_ba5b7522(Entity, Parsable):
    """
    The user experience analytics application performance entity contains application performance by application version details. Original name: UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_ba5b7522:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsAppHealthAppPerformanceByAppVers_ba5b7522
        """
