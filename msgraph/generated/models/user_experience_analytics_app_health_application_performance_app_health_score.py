...
@dataclass
class UserExperienceAnalyticsAppHealthApplicationPerformance_appHealthScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsAppHealthApplicationPerformance_appHealthScore:
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsAppHealthApplicationPerformance_appHealthScore()
