...
@dataclass
class UserExperienceAnalyticsAppHealthDeviceModelPerformance_modelAppHealthScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsAppHealthDeviceModelPerformance_modelAppHealthScore:
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsAppHealthDeviceModelPerformance_modelAppHealthScore()
