...
@dataclass
class UserExperienceAnalyticsAppHealthDevicePerformance_deviceAppHealthScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsAppHealthDevicePerformance_deviceAppHealthScore:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsAppHealthDevicePerformance_deviceAppHealthScore
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsAppHealthDevicePerformance_deviceAppHealthScore()
