...
@dataclass
class UserExperienceAnalyticsAppHealthOSVersionPerformance_osVersionAppHealthScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsAppHealthOSVersionPerformance_osVersionAppHealthScore:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsAppHealthOSVersionPerformance_osVersionAppHealthScore
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsAppHealthOSVersionPerformance_osVersionAppHealthScore()
