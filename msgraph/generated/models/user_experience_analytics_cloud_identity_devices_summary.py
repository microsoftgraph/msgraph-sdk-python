...
class UserExperienceAnalyticsCloudIdentityDevicesSummary(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> UserExperienceAnalyticsCloudIdentityDevicesSummary:
        """
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_int_value("device_without_cloud_identity_count", self.device_without_cloud_identity_count)
