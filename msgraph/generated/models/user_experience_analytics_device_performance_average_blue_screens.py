...
@dataclass
class UserExperienceAnalyticsDevicePerformance_averageBlueScreens(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsDevicePerformance_averageBlueScreens:
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsDevicePerformance_averageBlueScreens()
