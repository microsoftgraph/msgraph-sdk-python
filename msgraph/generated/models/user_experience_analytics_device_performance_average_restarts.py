...
@dataclass
class UserExperienceAnalyticsDevicePerformance_averageRestarts(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsDevicePerformance_averageRestarts:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsDevicePerformance_averageRestarts
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsDevicePerformance_averageRestarts()
