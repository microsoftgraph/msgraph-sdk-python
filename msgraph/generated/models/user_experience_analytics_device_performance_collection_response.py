...
@dataclass
class UserExperienceAnalyticsDevicePerformanceCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[UserExperienceAnalyticsDevicePerformance]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsDevicePerformanceCollectionResponse:
        """
