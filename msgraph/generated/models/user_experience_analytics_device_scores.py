...
if TYPE_CHECKING:
    ...
    from .user_experience_analytics_device_scores_app_reliability_score import UserExperienceAnalyticsDeviceScores_appReliabilityScore
    from .user_experience_analytics_device_scores_battery_health_score import UserExperienceAnalyticsDeviceScores_batteryHealthScore
    from .user_experience_analytics_device_scores_endpoint_analytics_score import UserExperienceAnalyticsDeviceScores_endpointAnalyticsScore
    from .user_experience_analytics_device_scores_startup_performance_score import UserExperienceAnalyticsDeviceScores_startupPerformanceScore
    from .user_experience_analytics_device_scores_work_from_anywhere_score import UserExperienceAnalyticsDeviceScores_workFromAnywhereScore
...
class UserExperienceAnalyticsDeviceScores(Entity):
    ...
    app_reliability_score: Optional[UserExperienceAnalyticsDeviceScores_appReliabilityScore] = None
    ...
    battery_health_score: Optional[UserExperienceAnalyticsDeviceScores_batteryHealthScore] = None
    ...
    endpoint_analytics_score: Optional[UserExperienceAnalyticsDeviceScores_endpointAnalyticsScore] = None
    ...
    startup_performance_score: Optional[UserExperienceAnalyticsDeviceScores_startupPerformanceScore] = None
    ...
    work_from_anywhere_score: Optional[UserExperienceAnalyticsDeviceScores_workFromAnywhereScore] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "appReliabilityScore": lambda n : setattr(self, 'app_reliability_score', n.get_object_value(UserExperienceAnalyticsDeviceScores_appReliabilityScore)),
            "batteryHealthScore": lambda n : setattr(self, 'battery_health_score', n.get_object_value(UserExperienceAnalyticsDeviceScores_batteryHealthScore)),
            "deviceName": lambda n : setattr(self, 'device_name', n.get_str_value()),
            "endpointAnalyticsScore": lambda n : setattr(self, 'endpoint_analytics_score', n.get_object_value(UserExperienceAnalyticsDeviceScores_endpointAnalyticsScore)),
            ...
            "startupPerformanceScore": lambda n : setattr(self, 'startup_performance_score', n.get_object_value(UserExperienceAnalyticsDeviceScores_startupPerformanceScore)),
            "workFromAnywhereScore": lambda n : setattr(self, 'work_from_anywhere_score', n.get_object_value(UserExperienceAnalyticsDeviceScores_workFromAnywhereScore)),
        }
