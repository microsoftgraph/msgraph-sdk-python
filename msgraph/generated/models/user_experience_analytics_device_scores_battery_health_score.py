...
@dataclass
class UserExperienceAnalyticsDeviceScores_batteryHealthScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsDeviceScores_batteryHealthScore:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsDeviceScores_batteryHealthScore
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsDeviceScores_batteryHealthScore()
