...
@dataclass
class UserExperienceAnalyticsDeviceScores_endpointAnalyticsScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsDeviceScores_endpointAnalyticsScore:
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsDeviceScores_endpointAnalyticsScore()
