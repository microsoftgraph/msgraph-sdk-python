...
@dataclass
class UserExperienceAnalyticsMetric_value(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsMetric_value:
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsMetric_value()
