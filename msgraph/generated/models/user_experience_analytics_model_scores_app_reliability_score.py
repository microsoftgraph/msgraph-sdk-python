...
@dataclass
class UserExperienceAnalyticsModelScores_appReliabilityScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsModelScores_appReliabilityScore:
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsModelScores_appReliabilityScore()
