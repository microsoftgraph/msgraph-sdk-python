...
@dataclass
class UserExperienceAnalyticsWorkFromAnywhereDevice_cloudIdentityScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsWorkFromAnywhereDevice_cloudIdentityScore:
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsWorkFromAnywhereDevice_cloudIdentityScore()
