...
@dataclass
class UserExperienceAnalyticsWorkFromAnywhereDevice_cloudProvisioningScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsWorkFromAnywhereDevice_cloudProvisioningScore:
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsWorkFromAnywhereDevice_cloudProvisioningScore()
