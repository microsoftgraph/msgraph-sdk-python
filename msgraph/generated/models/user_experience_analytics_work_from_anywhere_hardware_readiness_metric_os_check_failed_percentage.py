...
@dataclass
class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric_osCheckFailedPercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric_osCheckFailedPercentage:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric_osCheckFailedPercentage
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric_osCheckFailedPercentage()
