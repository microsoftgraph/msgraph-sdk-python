...
@dataclass
class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric_ramCheckFailedPercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric_ramCheckFailedPercentage:
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric_ramCheckFailedPercentage()
