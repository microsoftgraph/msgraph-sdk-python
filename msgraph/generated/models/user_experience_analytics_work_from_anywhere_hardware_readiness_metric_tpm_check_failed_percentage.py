...
@dataclass
class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric_tpmCheckFailedPercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric_tpmCheckFailedPercentage:
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric_tpmCheckFailedPercentage()
