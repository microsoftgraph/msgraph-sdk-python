...
@dataclass
class UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudIdentityScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudIdentityScore:
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudIdentityScore()
