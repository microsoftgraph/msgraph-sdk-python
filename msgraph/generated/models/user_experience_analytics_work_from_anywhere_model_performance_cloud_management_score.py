...
@dataclass
class UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudManagementScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudManagementScore:
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsWorkFromAnywhereModelPerformance_cloudManagementScore()
