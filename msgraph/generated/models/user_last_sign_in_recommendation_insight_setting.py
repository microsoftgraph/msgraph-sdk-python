...
if TYPE_CHECKING:
    ...
    from .user_last_sign_in_recommendation_insight_setting_sign_in_scope import UserLastSignInRecommendationInsightSetting_signInScope
...
class UserLastSignInRecommendationInsightSetting(AccessReviewRecommendationInsightSetting):
    ...
    sign_in_scope: Optional[UserLastSignInRecommendationInsightSetting_signInScope] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "signInScope": lambda n : setattr(self, 'sign_in_scope', n.get_enum_value(UserLastSignInRecommendationInsightSetting_signInScope)),
        }
