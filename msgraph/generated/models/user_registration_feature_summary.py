...
class UserRegistrationFeatureSummary(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "user_registration_feature_counts": lambda n : setattr(self, 'user_registration_feature_counts', n.get_collection_of_object_values(UserRegistrationFeatureCount)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_object_values("user_registration_feature_counts", self.user_registration_feature_counts)
