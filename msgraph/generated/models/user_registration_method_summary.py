...
if TYPE_CHECKING:
    ...
    from .user_registration_method_summary_user_roles import UserRegistrationMethodSummary_userRoles
    from .user_registration_method_summary_user_types import UserRegistrationMethodSummary_userTypes
...
class UserRegistrationMethodSummary(AdditionalDataHolder, BackedModel, Parsable):
    ...
    user_roles: Optional[UserRegistrationMethodSummary_userRoles] = None
    # User type. Possible values are: all, member, guest, unknownFutureValue.
    user_types: Optional[UserRegistrationMethodSummary_userTypes] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "userRoles": lambda n : setattr(self, 'user_roles', n.get_enum_value(UserRegistrationMethodSummary_userRoles)),
            "userTypes": lambda n : setattr(self, 'user_types', n.get_enum_value(UserRegistrationMethodSummary_userTypes)),
        }
        return fields
