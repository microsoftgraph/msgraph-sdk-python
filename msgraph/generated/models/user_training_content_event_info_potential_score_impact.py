...
@dataclass
class UserTrainingContentEventInfo_potentialScoreImpact(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserTrainingContentEventInfo_potentialScoreImpact:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserTrainingContentEventInfo_potentialScoreImpact
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserTrainingContentEventInfo_potentialScoreImpact()
