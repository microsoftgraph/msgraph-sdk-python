...
if TYPE_CHECKING:
    from .user_training_status_info_training_status import UserTrainingStatusInfo_trainingStatus
...
class UserTrainingStatusInfo(AdditionalDataHolder, BackedModel, Parsable):
    ...
    training_status: Optional[UserTrainingStatusInfo_trainingStatus] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "trainingStatus": lambda n : setattr(self, 'training_status', n.get_enum_value(UserTrainingStatusInfo_trainingStatus)),
        }
        return fields
