...
@dataclass
class VirtualEventTownhallCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[VirtualEventTownhall]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> VirtualEventTownhallCollectionResponse:
        """
