...
@dataclass
class WebPartPosition_columnId(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WebPartPosition_columnId:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: WebPartPosition_columnId
        """
        ...
        try:
            ...
            mapping_value = None
        result = WebPartPosition_columnId()
