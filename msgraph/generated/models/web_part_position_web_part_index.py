...
@dataclass
class WebPartPosition_webPartIndex(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WebPartPosition_webPartIndex:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: WebPartPosition_webPartIndex
        """
        ...
        try:
            ...
            mapping_value = None
        result = WebPartPosition_webPartIndex()
