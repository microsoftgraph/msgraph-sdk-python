...
class Win32LobAppInstallExperience(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "device_restart_behavior": lambda n : setattr(self, 'device_restart_behavior', n.get_enum_value(Win32LobAppRestartBehavior)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_enum_value("device_restart_behavior", self.device_restart_behavior)
