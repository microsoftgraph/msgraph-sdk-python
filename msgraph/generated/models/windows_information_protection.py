...
class WindowsInformationProtection(managed_app_policy.ManagedAppPolicy):
    ...
    data_recovery_certificate: Optional[windows_information_protection_data_recovery_certificate.WindowsInformationProtectionDataRecoveryCertificate] = None
    # Possible values for WIP Protection enforcement levels
    enforcement_level: Optional[windows_information_protection_enforcement_level.WindowsInformationProtectionEnforcementLevel] = None
    ...
    enterprise_i_p_ranges: Optional[List[windows_information_protection_i_p_range_collection.WindowsInformationProtectionIPRangeCollection]] = None
    ...
    enterprise_internal_proxy_servers: Optional[List[windows_information_protection_resource_collection.WindowsInformationProtectionResourceCollection]] = None
    # This is the list of domains that comprise the boundaries of the enterprise. Data from one of these domains that is sent to a device will be considered enterprise data and protected These locations will be considered a safe destination for enterprise data to be shared to
    enterprise_network_domain_names: Optional[List[windows_information_protection_resource_collection.WindowsInformationProtectionResourceCollection]] = None
    # List of enterprise domains to be protected
    enterprise_protected_domain_names: Optional[List[windows_information_protection_resource_collection.WindowsInformationProtectionResourceCollection]] = None
    # Contains a list of Enterprise resource domains hosted in the cloud that need to be protected. Connections to these resources are considered enterprise data. If a proxy is paired with a cloud resource, traffic to the cloud resource will be routed through the enterprise network via the denoted proxy server (on Port 80). A proxy server used for this purpose must also be configured using the EnterpriseInternalProxyServers policy
    enterprise_proxied_domains: Optional[List[windows_information_protection_proxied_domain_collection.WindowsInformationProtectionProxiedDomainCollection]] = None
    # This is a list of proxy servers. Any server not on this list is considered non-enterprise
    enterprise_proxy_servers: Optional[List[windows_information_protection_resource_collection.WindowsInformationProtectionResourceCollection]] = None
    # Boolean value that tells the client to accept the configured list of proxies and not try to detect other work proxies. Default is false
    enterprise_proxy_servers_are_authoritative: Optional[bool] = None
    # Another way to input exempt apps through xml files
    exempt_app_locker_files: Optional[List[windows_information_protection_app_locker_file.WindowsInformationProtectionAppLockerFile]] = None
    ...
    exempt_apps: Optional[List[windows_information_protection_app.WindowsInformationProtectionApp]] = None
    ...
    neutral_domain_resources: Optional[List[windows_information_protection_resource_collection.WindowsInformationProtectionResourceCollection]] = None
    # Another way to input protected apps through xml files
    protected_app_locker_files: Optional[List[windows_information_protection_app_locker_file.WindowsInformationProtectionAppLockerFile]] = None
    # Protected applications can access enterprise data and the data handled by those applications are protected with encryption
    protected_apps: Optional[List[windows_information_protection_app.WindowsInformationProtectionApp]] = None
    ...
    smb_auto_encrypted_file_extensions: Optional[List[windows_information_protection_resource_collection.WindowsInformationProtectionResourceCollection]] = None
