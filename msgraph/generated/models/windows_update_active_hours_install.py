...
@dataclass
class WindowsUpdateActiveHoursInstall(WindowsUpdateInstallScheduleType, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WindowsUpdateActiveHoursInstall:
        """
