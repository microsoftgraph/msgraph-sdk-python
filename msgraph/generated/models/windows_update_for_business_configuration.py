...
class WindowsUpdateForBusinessConfiguration(device_configuration.DeviceConfiguration):
    ...
    auto_restart_notification_dismissal: Optional[auto_restart_notification_dismissal_method.AutoRestartNotificationDismissalMethod] = None
    # Possible values for automatic update mode.
    automatic_update_mode: Optional[automatic_update_mode.AutomaticUpdateMode] = None
    # Which branch devices will receive their updates from
    business_ready_updates_only: Optional[windows_update_type.WindowsUpdateType] = None
    ...
    feature_updates_pause_expiry_date_time: Optional[datetime] = None
    ...
    feature_updates_pause_start_date: Optional[date] = None
    ...
    feature_updates_rollback_start_date_time: Optional[datetime] = None
    ...
    installation_schedule: Optional[windows_update_install_schedule_type.WindowsUpdateInstallScheduleType] = None
    ...
    prerelease_features: Optional[prerelease_features.PrereleaseFeatures] = None
    ...
    quality_updates_pause_expiry_date_time: Optional[datetime] = None
    ...
    quality_updates_pause_start_date: Optional[date] = None
    ...
    quality_updates_rollback_start_date_time: Optional[datetime] = None
    ...
    update_notification_level: Optional[windows_update_notification_display_option.WindowsUpdateNotificationDisplayOption] = None
    ...
    update_weeks: Optional[windows_update_for_business_update_weeks.WindowsUpdateForBusinessUpdateWeeks] = None
    # Possible values of a property
    user_pause_access: Optional[enablement.Enablement] = None
    # Possible values of a property
    user_windows_update_scan_access: Optional[enablement.Enablement] = None
