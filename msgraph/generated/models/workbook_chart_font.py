...
if TYPE_CHECKING:
    ...
    from .workbook_chart_font_size import WorkbookChartFont_size
...
class WorkbookChartFont(Entity):
    ...
    size: Optional[WorkbookChartFont_size] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "size": lambda n : setattr(self, 'size', n.get_object_value(WorkbookChartFont_size)),
