...
@dataclass
class WorkbookRangeFormat_columnWidth(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WorkbookRangeFormat_columnWidth:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: WorkbookRangeFormat_columnWidth
        """
        ...
        try:
            ...
            mapping_value = None
        result = WorkbookRangeFormat_columnWidth()
