...
@dataclass
class WorkbookRangeFormat_rowHeight(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WorkbookRangeFormat_rowHeight:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: WorkbookRangeFormat_rowHeight
        """
        ...
        try:
            ...
            mapping_value = None
        result = WorkbookRangeFormat_rowHeight()
