...
class CustomCSSRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/organization/{organization%2Did}/branding/customCSS", path_parameters)
    ...
    async def put(self,body: bytes, content_type: Optional[str] = None, request_configuration: Optional[CustomCSSRequestBuilderPutRequestConfiguration] = None) -> bytes:
        """
        CSS styling that appears on the sign-in page. The allowed format is .css format only and not larger than 25 KB.
    ...
    def to_put_request_information(self,body: bytes, content_type: Optional[str] = None, request_configuration: Optional[CustomCSSRequestBuilderPutRequestConfiguration] = None) -> RequestInformation:
        """
        CSS styling that appears on the sign-in page. The allowed format is .css format only and not larger than 25 KB.
        param body: Binary request body
        param content_type: The request body content type.
    ...
    @dataclass
    class CustomCSSRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class CustomCSSRequestBuilderPutRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
