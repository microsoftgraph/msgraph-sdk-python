...
class BannerLogoRequestBuilder(BaseRequestBuilder):
    ...
    async def put(self,body: bytes, content_type: Optional[str] = None, request_configuration: Optional[BannerLogoRequestBuilderPutRequestConfiguration] = None) -> bytes:
        """
        A banner version of your company logo that appears on the sign-in page. The allowed types are PNG or JPEG not larger than 36 × 245 pixels. We recommend using a transparent image with no padding around the logo.
    ...
    def to_put_request_information(self,body: bytes, content_type: Optional[str] = None, request_configuration: Optional[BannerLogoRequestBuilderPutRequestConfiguration] = None) -> RequestInformation:
        """
        A banner version of your company logo that appears on the sign-in page. The allowed types are PNG or JPEG not larger than 36 × 245 pixels. We recommend using a transparent image with no padding around the logo.
        param body: Binary request body
        param content_type: The request body content type.
    ...
    @dataclass
    class BannerLogoRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class BannerLogoRequestBuilderPutRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
