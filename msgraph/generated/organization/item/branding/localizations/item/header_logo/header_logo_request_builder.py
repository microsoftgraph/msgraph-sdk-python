...
class HeaderLogoRequestBuilder(BaseRequestBuilder):
    ...
    async def put(self,body: bytes, content_type: str, request_configuration: Optional[HeaderLogoRequestBuilderPutRequestConfiguration] = None) -> bytes:
        """
        A company logo that appears in the header of the sign-in page. The allowed types are PNG or JPEG not larger than 36 × 245 pixels. We recommend using a transparent image with no padding around the logo.
    ...
    def to_put_request_information(self,body: bytes, content_type: str, request_configuration: Optional[HeaderLogoRequestBuilderPutRequestConfiguration] = None) -> RequestInformation:
        """
        A company logo that appears in the header of the sign-in page. The allowed types are PNG or JPEG not larger than 36 × 245 pixels. We recommend using a transparent image with no padding around the logo.
        param body: Binary request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
