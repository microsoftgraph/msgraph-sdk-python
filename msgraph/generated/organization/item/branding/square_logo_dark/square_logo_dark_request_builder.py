...
class SquareLogoDarkRequestBuilder(BaseRequestBuilder):
    ...
    async def put(self,body: bytes, content_type: str, request_configuration: Optional[SquareLogoDarkRequestBuilderPutRequestConfiguration] = None) -> bytes:
        """
        A square dark version of your company logo that appears in Windows 10 out-of-box experiences (OOBE) and when Windows Autopilot is enabled for deployment. Allowed types are PNG or JPEG not larger than 240 x 240 pixels and not more than 10 KB in size. We recommend using a transparent image with no padding around the logo.
    ...
    def to_put_request_information(self,body: bytes, content_type: str, request_configuration: Optional[SquareLogoDarkRequestBuilderPutRequestConfiguration] = None) -> RequestInformation:
        """
        A square dark version of your company logo that appears in Windows 10 out-of-box experiences (OOBE) and when Windows Autopilot is enabled for deployment. Allowed types are PNG or JPEG not larger than 240 x 240 pixels and not more than 10 KB in size. We recommend using a transparent image with no padding around the logo.
        param body: Binary request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
