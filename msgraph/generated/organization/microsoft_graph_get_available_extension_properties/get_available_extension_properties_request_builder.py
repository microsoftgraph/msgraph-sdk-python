...
get_available_extension_properties_post_request_body = lazy_import('msgraph.generated.organization.microsoft_graph_get_available_extension_properties.get_available_extension_properties_post_request_body')
get_available_extension_properties_response = lazy_import('msgraph.generated.organization.microsoft_graph_get_available_extension_properties.get_available_extension_properties_response')
...
class GetAvailableExtensionPropertiesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/organization/microsoft.graph.getAvailableExtensionProperties"
