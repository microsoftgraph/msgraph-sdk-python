...
if TYPE_CHECKING:
    ...
    from ...models.section_collection_response import SectionCollectionResponse
...
class GraphSectionRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new GraphSectionRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/places/graph.section{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GraphSectionRequestBuilderGetQueryParameters]] = None) -> Optional[SectionCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, SectionCollectionResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GraphSectionRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GraphSectionRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return GraphSectionRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class GraphSectionRequestBuilderGetRequestConfiguration(RequestConfiguration[GraphSectionRequestBuilderGetQueryParameters]):
        """
