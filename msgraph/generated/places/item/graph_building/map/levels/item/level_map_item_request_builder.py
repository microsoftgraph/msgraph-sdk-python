...
if TYPE_CHECKING:
    ...
    from .fixtures.fixtures_request_builder import FixturesRequestBuilder
...
class LevelMapItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/places/{place%2Did}/graph.building/map/levels/{levelMap%2Did}", path_parameters)
    ...
    async def patch(self,body: LevelMap, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[LevelMap]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[LevelMapItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/places/{place%2Did}/graph.building/map/levels/{levelMap%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_patch_request_information(self,body: LevelMap, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property levels in places
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> LevelMapItemRequestBuilder:
        """
        ...
        return LevelMapItemRequestBuilder(self.request_adapter, raw_url)
    
    @property
    def fixtures(self) -> FixturesRequestBuilder:
        """
        Provides operations to manage the fixtures property of the microsoft.graph.levelMap entity.
        """
        from .fixtures.fixtures_request_builder import FixturesRequestBuilder

        return FixturesRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @dataclass
    class LevelMapItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class LevelMapItemRequestBuilderGetRequestConfiguration(RequestConfiguration[LevelMapItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class LevelMapItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
