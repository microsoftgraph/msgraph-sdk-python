...
from ..models import place, place_collection_response
...
class PlacesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[PlacesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[place.Place] = None, request_configuration: Optional[PlacesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
