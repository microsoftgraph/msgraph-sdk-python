...
class PlannerRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[planner.Planner] = None, request_configuration: Optional[PlannerRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update planner
        Args:
            body: The request body
