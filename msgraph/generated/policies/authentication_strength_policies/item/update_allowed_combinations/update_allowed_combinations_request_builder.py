...
if TYPE_CHECKING:
    from . import update_allowed_combinations_post_request_body
    from .....models import update_allowed_combinations_result
...
class UpdateAllowedCombinationsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}/updateAllowedCombinations"
