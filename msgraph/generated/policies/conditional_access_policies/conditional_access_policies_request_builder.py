...
class ConditionalAccessPoliciesRequestBuilder():
    ...
    async def post(self,body: Optional[conditional_access_policy.ConditionalAccessPolicy] = None, request_configuration: Optional[ConditionalAccessPoliciesRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[conditional_access_policy.ConditionalAccessPolicy]:
        """
        Create new navigation property to conditionalAccessPolicies for policies
        Args:
            body: The request body
