...
count_request_builder = lazy_import('msgraph.generated.policies.conditional_access_policies.count.count_request_builder')
...
class ConditionalAccessPoliciesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/policies/conditionalAccessPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def get(self,request_configuration: Optional[ConditionalAccessPoliciesRequestBuilderGetRequestConfiguration] = None) -> Optional[conditional_access_policy_collection_response.ConditionalAccessPolicyCollectionResponse]:
        """
        ...
        return await self.request_adapter.send_async(request_info, conditional_access_policy_collection_response.ConditionalAccessPolicyCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[conditional_access_policy.ConditionalAccessPolicy] = None, request_configuration: Optional[ConditionalAccessPoliciesRequestBuilderPostRequestConfiguration] = None) -> Optional[conditional_access_policy.ConditionalAccessPolicy]:
        """
    ...
    @dataclass
    class ConditionalAccessPoliciesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
