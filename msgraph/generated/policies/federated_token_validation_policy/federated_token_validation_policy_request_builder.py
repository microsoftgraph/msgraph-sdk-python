...
if TYPE_CHECKING:
    from ...models.federated_token_validation_policy import FederatedTokenValidationPolicy
    from ...models.o_data_errors.o_data_error import ODataError

class FederatedTokenValidationPolicyRequestBuilder(BaseRequestBuilder):
    """
    ...
    async def patch(self,body: FederatedTokenValidationPolicy, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[FederatedTokenValidationPolicy]:
        """
    ...
    def to_patch_request_information(self,body: FederatedTokenValidationPolicy, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property federatedTokenValidationPolicy in policies
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> FederatedTokenValidationPolicyRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: FederatedTokenValidationPolicyRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class FederatedTokenValidationPolicyRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class FederatedTokenValidationPolicyRequestBuilderGetRequestConfiguration(RequestConfiguration[FederatedTokenValidationPolicyRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class FederatedTokenValidationPolicyRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
