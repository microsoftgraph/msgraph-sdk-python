...
class IncludesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[IncludesRequestBuilderGetRequestConfiguration] = None) -> Optional[permission_grant_condition_set_collection_response.PermissionGrantConditionSetCollectionResponse]:
        """
        ...
        from .....models import permission_grant_condition_set_collection_response

        return await self.request_adapter.send_async(request_info, permission_grant_condition_set_collection_response.PermissionGrantConditionSetCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[permission_grant_condition_set.PermissionGrantConditionSet] = None, request_configuration: Optional[IncludesRequestBuilderPostRequestConfiguration] = None) -> Optional[permission_grant_condition_set.PermissionGrantConditionSet]:
        """
    ...
    def to_post_request_information(self,body: Optional[permission_grant_condition_set.PermissionGrantConditionSet] = None, request_configuration: Optional[IncludesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to includes for policies
        Args:
            body: The request body
