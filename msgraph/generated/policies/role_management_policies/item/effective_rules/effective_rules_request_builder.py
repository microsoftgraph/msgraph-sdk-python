...
class EffectiveRulesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[unified_role_management_policy_rule.UnifiedRoleManagementPolicyRule] = None, request_configuration: Optional[EffectiveRulesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to effectiveRules for policies
        Args:
            body: The request body
