...
class UnifiedRoleManagementPolicyItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, unified_role_management_policy_id: Optional[str] = None) -> None:
        """
        Instantiates a new UnifiedRoleManagementPolicyItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            unifiedRoleManagementPolicyId: key: id of unifiedRoleManagementPolicy
        """
        ...
        url_tpl_params["unifiedRoleManagementPolicy%2Did"] = unifiedRoleManagementPolicyId
