...
if TYPE_CHECKING:
    ...
    from .....models.print_connector_collection_response import PrintConnectorCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.print_connector_item_request_builder import PrintConnectorItemRequestBuilder
...
class ConnectorsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/print/printers/{printer%2Did}/connectors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_print_connector_id(self,print_connector_id: str) -> PrintConnectorItemRequestBuilder:
        """
        Provides operations to manage the connectors property of the microsoft.graph.printer entity.
        ...
        if not print_connector_id:
            raise TypeError("print_connector_id cannot be null.")
        from .item.print_connector_item_request_builder import PrintConnectorItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["printConnector%2Did"] = print_connector_id
        return PrintConnectorItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[ConnectorsRequestBuilderGetRequestConfiguration] = None) -> Optional[PrintConnectorCollectionResponse]:
        """
        Retrieve a list of printConnectors associated with the printer. This API is supported in the following national cloud deployments.
