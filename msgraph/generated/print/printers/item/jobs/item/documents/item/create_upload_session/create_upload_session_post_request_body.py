...
class CreateUploadSessionPostRequestBody(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        ...
        self._properties: Optional[print_document_upload_properties.PrintDocumentUploadProperties] = None
    ...
    @property
    def properties(self,) -> Optional[print_document_upload_properties.PrintDocumentUploadProperties]:
        """
        Gets the properties property value. The properties property
        Returns: Optional[print_document_upload_properties.PrintDocumentUploadProperties]
        """
        return self._properties
    
    @properties.setter
    def properties(self,value: Optional[print_document_upload_properties.PrintDocumentUploadProperties] = None) -> None:
        """
