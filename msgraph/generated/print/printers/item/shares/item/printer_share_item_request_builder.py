...
class PrinterShareItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/print/printers/{printer%2Did}/shares/{printerShare%2Did}{?%24select,%24expand}", path_parameters)
    ...
    class PrinterShareItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[PrinterShareItemRequestBuilderGetQueryParameters] = None
