...
class PrintServiceEndpointItemRequestBuilder():
    """
    ...
    def create_delete_request_information(self,request_configuration: Optional[PrintServiceEndpointItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[PrintServiceEndpointItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[print_service_endpoint.PrintServiceEndpoint] = None, request_configuration: Optional[PrintServiceEndpointItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class PrintServiceEndpointItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class PrintServiceEndpointItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
