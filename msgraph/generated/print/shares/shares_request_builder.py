...
class SharesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/print/shares{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[SharesRequestBuilderGetRequestConfiguration] = None) -> Optional[PrinterShareCollectionResponse]:
        """
        Retrieve a list of printerShares. This API is supported in the following national cloud deployments.
    ...
    async def post(self,body: Optional[PrinterShare] = None, request_configuration: Optional[SharesRequestBuilderPostRequestConfiguration] = None) -> Optional[PrinterShare]:
        """
        Create a new printerShare for the specified printer. This API is supported in the following national cloud deployments.
    ...
    def to_post_request_information(self,body: Optional[PrinterShare] = None, request_configuration: Optional[SharesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create a new printerShare for the specified printer. This API is supported in the following national cloud deployments.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class SharesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class SharesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
