...
if TYPE_CHECKING:
    ...
    from ...models.print_task_definition_collection_response import PrintTaskDefinitionCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.print_task_definition_item_request_builder import PrintTaskDefinitionItemRequestBuilder
...
class TaskDefinitionsRequestBuilder(BaseRequestBuilder):
    ...
    def by_print_task_definition_id(self,print_task_definition_id: str) -> PrintTaskDefinitionItemRequestBuilder:
        """
        Provides operations to manage the taskDefinitions property of the microsoft.graph.print entity.
        param print_task_definition_id: The unique identifier of printTaskDefinition
        Returns: PrintTaskDefinitionItemRequestBuilder
        """
        if print_task_definition_id is None:
            raise TypeError("print_task_definition_id cannot be null.")
        from .item.print_task_definition_item_request_builder import PrintTaskDefinitionItemRequestBuilder
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[TaskDefinitionsRequestBuilderGetQueryParameters]] = None) -> Optional[PrintTaskDefinitionCollectionResponse]:
        """
    ...
    async def post(self,body: PrintTaskDefinition, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PrintTaskDefinition]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[TaskDefinitionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/print/taskDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: PrintTaskDefinition, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new task definition. For details about how to use this API to add pull printing support to Universal Print, see Extending Universal Print to support pull printing.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/print/taskDefinitions', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @dataclass
    class TaskDefinitionsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
