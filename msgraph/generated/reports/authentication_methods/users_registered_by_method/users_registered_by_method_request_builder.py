...
class UsersRegisteredByMethodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> UsersRegisteredByMethodRequestBuilder:
        """
    ...
    @dataclass
    class UsersRegisteredByMethodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
