...
class UsersRegisteredByMethodWithIncludedUserTypesWithInclude_c7c52dcb(BaseRequestBuilder):
    """
    Provides operations to call the usersRegisteredByMethod method. Original name: UsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], included_user_roles: Optional[str] = None, included_user_types: Optional[str] = None) -> None:
        """
        Instantiates a new UsersRegisteredByMethodWithIncludedUserTypesWithInclude_c7c52dcb and sets the default values.
    ...
    def with_url(self,raw_url: str) -> UsersRegisteredByMethodWithIncludedUserTypesWithInclude_c7c52dcb:
        """
        ...
        return UsersRegisteredByMethodWithIncludedUserTypesWithInclude_c7c52dcb(self.request_adapter, raw_url)
