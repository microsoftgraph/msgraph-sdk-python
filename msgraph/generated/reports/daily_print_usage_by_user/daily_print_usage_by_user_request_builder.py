...
class DailyPrintUsageByUserRequestBuilder():
    ...
    async def post(self,body: Optional[print_usage_by_user.PrintUsageByUser] = None, request_configuration: Optional[DailyPrintUsageByUserRequestBuilderPostRequestConfiguration] = None) -> Optional[print_usage_by_user.PrintUsageByUser]:
        """
