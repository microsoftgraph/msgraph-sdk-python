...
class GetEmailAppUsageUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetEmailAppUsageUserDetailWithDateRequestBuilder:
        """
    ...
    @dataclass
    class GetEmailAppUsageUserDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
