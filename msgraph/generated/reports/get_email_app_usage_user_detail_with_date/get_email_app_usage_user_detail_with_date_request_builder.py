...
class GetEmailAppUsageUserDetailWithDateRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, date: Optional[Date] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/reports/microsoft.graph.getEmailAppUsageUserDetail(date={date})"
    ...
    def create_get_request_information(self,request_configuration: Optional[GetEmailAppUsageUserDetailWithDateRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[GetEmailAppUsageUserDetailWithDateRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> bytes:
        """
        Invoke function getEmailAppUsageUserDetail
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
