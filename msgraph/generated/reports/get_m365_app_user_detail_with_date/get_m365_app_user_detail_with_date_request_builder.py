...
class GetM365AppUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetM365AppUserDetailWithDateRequestBuilder:
        """
    ...
    @dataclass
    class GetM365AppUserDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
