...
class GetOffice365ActivationsUserCountsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetOffice365ActivationsUserCountsRequestBuilder:
        """
    ...
    @dataclass
    class GetOffice365ActivationsUserCountsRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
