...
class GetOffice365GroupsActivityDetailWithDateRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[GetOffice365GroupsActivityDetailWithDateRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> bytes:
        """
        Invoke function getOffice365GroupsActivityDetail
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
