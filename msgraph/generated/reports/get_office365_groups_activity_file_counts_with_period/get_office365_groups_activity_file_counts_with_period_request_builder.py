...
class GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, period: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/reports/getOffice365GroupsActivityFileCounts(period='{period}')"
    ...
    async def get(self,request_configuration: Optional[GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration] = None) -> bytes:
        """
