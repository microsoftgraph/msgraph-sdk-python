...
class GetOneDriveActivityFileCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetOneDriveActivityFileCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetOneDriveActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
