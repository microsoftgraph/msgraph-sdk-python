...
class GetOneDriveActivityUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    """
    ...
    @dataclass
    class GetOneDriveActivityUserDetailWithDateRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
