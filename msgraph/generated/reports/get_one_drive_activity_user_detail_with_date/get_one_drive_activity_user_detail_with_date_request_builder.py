...
class GetOneDriveActivityUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetOneDriveActivityUserDetailWithDateRequestBuilder:
        """
    ...
    @dataclass
    class GetOneDriveActivityUserDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
