...
class GetOneDriveActivityUserDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetOneDriveActivityUserDetailWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetOneDriveActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
