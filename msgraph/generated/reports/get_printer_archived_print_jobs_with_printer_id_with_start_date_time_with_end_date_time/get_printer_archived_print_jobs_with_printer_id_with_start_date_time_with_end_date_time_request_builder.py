...
if TYPE_CHECKING:
    ...
    from .get_printer_archived_print_jobs_with_printer_id_with_start_date_time_with_end_date_timeget_response import GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTimegetResponse
