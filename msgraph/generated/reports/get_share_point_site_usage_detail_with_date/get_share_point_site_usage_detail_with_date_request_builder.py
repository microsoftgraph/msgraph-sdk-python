...
class GetSharePointSiteUsageDetailWithDateRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetSharePointSiteUsageDetailWithDateRequestBuilder:
        """
    ...
    @dataclass
    class GetSharePointSiteUsageDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
