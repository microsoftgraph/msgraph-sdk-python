...
class GetSharePointSiteUsagePagesWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetSharePointSiteUsagePagesWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetSharePointSiteUsagePagesWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
