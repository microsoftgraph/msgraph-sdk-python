...
class GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
