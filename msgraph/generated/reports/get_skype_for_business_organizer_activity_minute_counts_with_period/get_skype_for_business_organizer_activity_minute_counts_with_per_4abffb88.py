...
class GetSkypeForBusinessOrganizerActivityMinuteCountsWithPer_4abffb88(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], period: Optional[str] = None) -> None:
        """
        Instantiates a new GetSkypeForBusinessOrganizerActivityMinuteCountsWithPer_4abffb88 and sets the default values.
        ...
        super().__init__(request_adapter, "{+baseurl}/reports/getSkypeForBusinessOrganizerActivityMinuteCounts(period='{period}')", path_parameters)
    ...
    def with_url(self,raw_url: str) -> GetSkypeForBusinessOrganizerActivityMinuteCountsWithPer_4abffb88:
        """
        ...
        return GetSkypeForBusinessOrganizerActivityMinuteCountsWithPer_4abffb88(self.request_adapter, raw_url)
    
    @dataclass
    class GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
