...
class GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
