...
class GetTeamsTeamActivityDistributionCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetTeamsTeamActivityDistributionCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetTeamsTeamActivityDistributionCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
