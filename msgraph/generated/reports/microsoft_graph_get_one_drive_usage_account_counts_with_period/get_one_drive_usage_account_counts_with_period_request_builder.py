...
class GetOneDriveUsageAccountCountsWithPeriodRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[GetOneDriveUsageAccountCountsWithPeriodRequestBuilderGetRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[GetOneDriveUsageAccountCountsWithPeriodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke function getOneDriveUsageAccountCounts
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
