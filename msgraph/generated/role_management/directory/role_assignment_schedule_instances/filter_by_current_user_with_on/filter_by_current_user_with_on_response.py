...
if TYPE_CHECKING:
    from .....models import base_collection_pagination_count_response, unified_role_assignment_schedule_instance
...
class FilterByCurrentUserWithOnResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[unified_role_assignment_schedule_instance.UnifiedRoleAssignmentScheduleInstance]] = None
