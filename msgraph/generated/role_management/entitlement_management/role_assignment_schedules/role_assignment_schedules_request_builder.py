...
class RoleAssignmentSchedulesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentSchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_unified_role_assignment_schedule_id(self,unified_role_assignment_schedule_id: str) -> UnifiedRoleAssignmentScheduleItemRequestBuilder:
        ...
        Provides operations to manage the roleAssignmentSchedules property of the microsoft.graph.rbacApplication entity.
        Args:
            unified_role_assignment_schedule_id: The unique identifier of unifiedRoleAssignmentSchedule
    ...
    class RoleAssignmentSchedulesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[RoleAssignmentSchedulesRequestBuilderGetQueryParameters] = None
