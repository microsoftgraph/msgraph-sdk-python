...
class ScopedRoleMembershipsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[ScopedRoleMembershipsRequestBuilderGetRequestConfiguration] = None) -> Optional[scoped_role_membership_collection_response.ScopedRoleMembershipCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[scoped_role_membership.ScopedRoleMembership] = None, request_configuration: Optional[ScopedRoleMembershipsRequestBuilderPostRequestConfiguration] = None) -> Optional[scoped_role_membership.ScopedRoleMembership]:
        """
    ...
    def to_post_request_information(self,body: Optional[scoped_role_membership.ScopedRoleMembership] = None, request_configuration: Optional[ScopedRoleMembershipsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to scopedRoleMemberships
        Args:
            body: The request body
