...
class ScopedRoleMembershipsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/scopedRoleMemberships{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[ScopedRoleMembershipsRequestBuilderGetRequestConfiguration] = None) -> Optional[ScopedRoleMembershipCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[ScopedRoleMembership] = None, request_configuration: Optional[ScopedRoleMembershipsRequestBuilderPostRequestConfiguration] = None) -> Optional[ScopedRoleMembership]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[ScopedRoleMembershipsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get entities from scopedRoleMemberships
        Args:
            request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[ScopedRoleMembership] = None, request_configuration: Optional[ScopedRoleMembershipsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to scopedRoleMemberships
        Args:
            body: The request body
    ...
    @dataclass
    class ScopedRoleMembershipsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[ScopedRoleMembershipsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class ScopedRoleMembershipsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
