...
class QueryRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[QueryPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[QueryPostResponse]:
        """
    ...
    def to_post_request_information(self,body: Optional[QueryPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Runs the query specified in the request body. Search results are provided in the response.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> QueryRequestBuilder:
        """
