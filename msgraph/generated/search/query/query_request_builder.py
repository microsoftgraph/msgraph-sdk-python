...
query_post_request_body = lazy_import('msgraph.generated.search.query.query_post_request_body')
query_response = lazy_import('msgraph.generated.search.query.query_response')
...
class QueryRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[query_post_request_body.QueryPostRequestBody] = None, request_configuration: Optional[QueryRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action query
        Args:
            body: 
