...
class LandingPagesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[LandingPageCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[LandingPage] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[LandingPage]:
        """
    ...
    def to_post_request_information(self,body: Optional[LandingPage] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to landingPages for security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
