...
class RunsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[RunsRequestBuilderGetRequestConfiguration] = None) -> Optional[simulation_automation_run_collection_response.SimulationAutomationRunCollectionResponse]:
        ...
        from ......models import simulation_automation_run_collection_response
    ...
    def to_post_request_information(self,body: Optional[simulation_automation_run.SimulationAutomationRun] = None, request_configuration: Optional[RunsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to runs for security
        Args:
            body: The request body
