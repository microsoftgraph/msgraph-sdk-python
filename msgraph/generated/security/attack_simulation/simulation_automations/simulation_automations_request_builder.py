...
class SimulationAutomationsRequestBuilder(BaseRequestBuilder):
    ...
    def by_simulation_automation_id(self,simulation_automation_id: str) -> SimulationAutomationItemRequestBuilder:
        ...
        Provides operations to manage the simulationAutomations property of the microsoft.graph.attackSimulationRoot entity.
        Args:
            simulation_automation_id: The unique identifier of simulationAutomation
    ...
    class SimulationAutomationsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[SimulationAutomationsRequestBuilderGetQueryParameters] = None
