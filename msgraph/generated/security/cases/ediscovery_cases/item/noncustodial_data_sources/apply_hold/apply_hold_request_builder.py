...
apply_hold_post_request_body = lazy_import('msgraph.generated.security.cases.ediscovery_cases.item.noncustodial_data_sources.apply_hold.apply_hold_post_request_body')
