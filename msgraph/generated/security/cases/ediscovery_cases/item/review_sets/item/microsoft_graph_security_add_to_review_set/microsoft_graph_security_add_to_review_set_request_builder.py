...
class MicrosoftGraphSecurityAddToReviewSetRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphSecurityAddToReviewSetRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphSecurityAddToReviewSetRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
