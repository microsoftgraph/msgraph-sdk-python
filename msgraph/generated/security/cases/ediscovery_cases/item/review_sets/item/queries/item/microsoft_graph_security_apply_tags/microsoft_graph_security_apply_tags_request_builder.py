...
apply_tags_post_request_body = lazy_import('msgraph.generated.security.cases.ediscovery_cases.item.review_sets.item.queries.item.microsoft_graph_security_apply_tags.apply_tags_post_request_body')

class MicrosoftGraphSecurityApplyTagsRequestBuilder():
    """
    ...
    @dataclass
    class MicrosoftGraphSecurityApplyTagsRequestBuilderPostRequestConfiguration():
        """
