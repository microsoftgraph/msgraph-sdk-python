...
class SearchesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def by_ediscovery_search_id(self,ediscovery_search_id: str) -> EdiscoverySearchItemRequestBuilder:
        """
        Provides operations to manage the searches property of the microsoft.graph.security.ediscoveryCase entity.
        param ediscovery_search_id: The unique identifier of ediscoverySearch
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SearchesRequestBuilderGetQueryParameters]] = None) -> Optional[EdiscoverySearchCollectionResponse]:
        """
    ...
    async def post(self,body: EdiscoverySearch, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[EdiscoverySearch]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SearchesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get the list of ediscoverySearch resources from an eDiscoveryCase object.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: EdiscoverySearch, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new ediscoverySearch object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    def with_url(self,raw_url: str) -> SearchesRequestBuilder:
        ...
        Returns: SearchesRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class SearchesRequestBuilderGetRequestConfiguration(RequestConfiguration[SearchesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class SearchesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
