...
class EdiscoveryReviewTagItemRequestBuilder():
    ...
    def child_tags_by_id(self,id: str) -> Optional[EdiscoveryReviewTagItemRequestBuilder]:
        """
        Provides operations to manage the childTags property of the microsoft.graph.security.ediscoveryReviewTag entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[EdiscoveryReviewTagItemRequestBuilder]
        """
        if id is None:
    ...
    def create_delete_request_information(self,request_configuration: Optional[EdiscoveryReviewTagItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[ediscovery_review_tag.EdiscoveryReviewTag] = None, request_configuration: Optional[EdiscoveryReviewTagItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def delete(self,request_configuration: Optional[EdiscoveryReviewTagItemRequestBuilderDeleteRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> None:
        """
        Delete navigation property tags for security
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def patch(self,body: Optional[ediscovery_review_tag.EdiscoveryReviewTag] = None, request_configuration: Optional[EdiscoveryReviewTagItemRequestBuilderPatchRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[ediscovery_review_tag.EdiscoveryReviewTag]:
        """
        Update the navigation property tags in security
        Args:
            body: The request body
