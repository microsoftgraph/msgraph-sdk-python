...
from .as_hierarchy import as_hierarchy_request_builder
...
class TagsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[ediscovery_review_tag.EdiscoveryReviewTag] = None, request_configuration: Optional[TagsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
