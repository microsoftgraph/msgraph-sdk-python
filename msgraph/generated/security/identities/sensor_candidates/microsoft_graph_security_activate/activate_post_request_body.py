...
class ActivatePostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "serverIds": lambda n : setattr(self, 'server_ids', n.get_collection_of_primitive_values(str)),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_primitive_values("serverIds", self.server_ids)
