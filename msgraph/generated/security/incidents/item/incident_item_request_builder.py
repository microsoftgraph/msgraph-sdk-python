...
alerts_request_builder = lazy_import('msgraph.generated.security.incidents.item.alerts.alerts_request_builder')
alert_item_request_builder = lazy_import('msgraph.generated.security.incidents.item.alerts.item.alert_item_request_builder')
...
class IncidentItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[IncidentItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[IncidentItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[incident.Incident] = None, request_configuration: Optional[IncidentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
