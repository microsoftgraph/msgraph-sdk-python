...
class CitationsRequestBuilder(BaseRequestBuilder):
    ...
    def by_citation_template_id(self,citation_template_id: str) -> CitationTemplateItemRequestBuilder:
        ...
        """
        if citation_template_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[CitationsRequestBuilderGetQueryParameters]] = None) -> Optional[CitationTemplateCollectionResponse]:
        """
    ...
    async def post(self,body: CitationTemplate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CitationTemplate]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CitationsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of the citationTemplate objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/security/labels/citations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: CitationTemplate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new citationTemplate object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/security/labels/citations', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> CitationsRequestBuilder:
        """
    ...
    @dataclass
    class CitationsRequestBuilderGetRequestConfiguration(RequestConfiguration[CitationsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class CitationsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
