...
if TYPE_CHECKING:
    ...
    from ....models.security.department_template_collection_response import DepartmentTemplateCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.department_template_item_request_builder import DepartmentTemplateItemRequestBuilder
...
class DepartmentsRequestBuilder(BaseRequestBuilder):
    ...
    def by_department_template_id(self,department_template_id: str) -> DepartmentTemplateItemRequestBuilder:
        """
        Provides operations to manage the departments property of the microsoft.graph.security.labelsRoot entity.
        param department_template_id: The unique identifier of departmentTemplate
        Returns: DepartmentTemplateItemRequestBuilder
        """
        if department_template_id is None:
            raise TypeError("department_template_id cannot be null.")
        from .item.department_template_item_request_builder import DepartmentTemplateItemRequestBuilder
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[DepartmentsRequestBuilderGetQueryParameters]] = None) -> Optional[DepartmentTemplateCollectionResponse]:
        """
    ...
    async def post(self,body: DepartmentTemplate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[DepartmentTemplate]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[DepartmentsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/security/labels/departments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: DepartmentTemplate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new departmentTemplate object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/security/labels/departments', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
