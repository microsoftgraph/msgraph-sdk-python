...
class MicrosoftGraphSecurityRunHuntingQueryRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> MicrosoftGraphSecurityRunHuntingQueryRequestBuilder:
        ...
        return MicrosoftGraphSecurityRunHuntingQueryRequestBuilder(raw_url, self.request_adapter)
    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class MicrosoftGraphSecurityRunHuntingQueryRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
