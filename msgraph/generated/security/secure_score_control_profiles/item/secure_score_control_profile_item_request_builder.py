...
class SecureScoreControlProfileItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, secure_score_control_profile_id: Optional[str] = None) -> None:
        """
        Instantiates a new SecureScoreControlProfileItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            secureScoreControlProfileId: key: id of secureScoreControlProfile
        """
        ...
        url_tpl_params["secureScoreControlProfile%2Did"] = secureScoreControlProfileId
