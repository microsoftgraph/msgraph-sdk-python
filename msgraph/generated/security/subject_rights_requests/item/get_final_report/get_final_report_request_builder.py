...
class GetFinalReportRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetFinalReportRequestBuilder:
        """
    ...
    @dataclass
    class GetFinalReportRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
