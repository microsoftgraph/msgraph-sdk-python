...
class ArticleIndicatorsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[ArticleIndicator] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ArticleIndicator]:
        """
    ...
    def to_post_request_information(self,body: Optional[ArticleIndicator] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to articleIndicators for security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ArticleIndicatorsRequestBuilder:
        """
