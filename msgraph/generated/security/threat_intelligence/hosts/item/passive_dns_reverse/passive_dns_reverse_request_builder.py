...
class PassiveDnsReverseRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/passiveDnsReverse{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[PassiveDnsReverseRequestBuilderGetQueryParameters]] = None) -> Optional[PassiveDnsRecordCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[PassiveDnsReverseRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a collection of passiveDnsRecord resources from a reverse passive DNS retrieval.  A reverse DNS lookup queries the hostname of a host using an IP address.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> PassiveDnsReverseRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: PassiveDnsReverseRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class PassiveDnsReverseRequestBuilderGetRequestConfiguration(RequestConfiguration[PassiveDnsReverseRequestBuilderGetQueryParameters]):
        """
