...
class RetentionEventTypeItemRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/triggerTypes/retentionEventTypes/{retentionEventType%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[RetentionEventTypeItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def patch(self,body: Optional[retention_event_type.RetentionEventType] = None, request_configuration: Optional[RetentionEventTypeItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[retention_event_type.RetentionEventType]:
        """
    ...
    def to_patch_request_information(self,body: Optional[retention_event_type.RetentionEventType] = None, request_configuration: Optional[RetentionEventTypeItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property retentionEventTypes in security
        Args:
            body: The request body
    ...
    @dataclass
    class RetentionEventTypeItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class RetentionEventTypeItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
