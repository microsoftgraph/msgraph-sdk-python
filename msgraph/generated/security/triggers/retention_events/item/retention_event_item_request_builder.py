...
class RetentionEventItemRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: Optional[RetentionEvent] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[RetentionEvent]:
        """
    ...
    def to_patch_request_information(self,body: Optional[RetentionEvent] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property retentionEvents in security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
