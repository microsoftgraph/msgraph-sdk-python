...
add_password_post_request_body = lazy_import('msgraph.generated.service_principals.item.add_password.add_password_post_request_body')
...
class AddPasswordRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/addPassword"
