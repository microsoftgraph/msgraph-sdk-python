...
count_request_builder = lazy_import('msgraph.generated.service_principals.item.endpoints.count.count_request_builder')
...
class EndpointsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[endpoint.Endpoint] = None, request_configuration: Optional[EndpointsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
