...
count_request_builder = lazy_import('msgraph.generated.service_principals.item.home_realm_discovery_policies.count.count_request_builder')
ref_request_builder = lazy_import('msgraph.generated.service_principals.item.home_realm_discovery_policies.ref.ref_request_builder')
