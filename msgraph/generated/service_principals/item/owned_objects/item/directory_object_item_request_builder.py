...
app_role_assignment_request_builder = lazy_import('msgraph.generated.service_principals.item.owned_objects.item.microsoft_graph_app_role_assignment.app_role_assignment_request_builder')
