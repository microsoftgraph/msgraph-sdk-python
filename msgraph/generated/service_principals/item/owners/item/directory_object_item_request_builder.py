...
app_role_assignment_request_builder = lazy_import('msgraph.generated.service_principals.item.owners.item.app_role_assignment.app_role_assignment_request_builder')
