...
graph_app_role_assignment_request_builder = lazy_import('msgraph.generated.service_principals.item.owners.item.graph_app_role_assignment.graph_app_role_assignment_request_builder')
graph_endpoint_request_builder = lazy_import('msgraph.generated.service_principals.item.owners.item.graph_endpoint.graph_endpoint_request_builder')
graph_service_principal_request_builder = lazy_import('msgraph.generated.service_principals.item.owners.item.graph_service_principal.graph_service_principal_request_builder')
graph_user_request_builder = lazy_import('msgraph.generated.service_principals.item.owners.item.graph_user.graph_user_request_builder')
