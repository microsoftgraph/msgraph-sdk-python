...
class AcquireAccessTokenRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> AcquireAccessTokenRequestBuilder:
        """
    ...
    @dataclass
    class AcquireAccessTokenRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
