...
microsoft_graph_get_activities_by_interval_request_builder = lazy_import('msgraph.generated.shares.item.list.items.item.microsoft_graph_get_activities_by_interval.microsoft_graph_get_activities_by_interval_request_builder')
