...
grant_post_request_body = lazy_import('msgraph.generated.shares.item.permission.microsoft_graph_grant.grant_post_request_body')
grant_response = lazy_import('msgraph.generated.shares.item.permission.microsoft_graph_grant.grant_response')
...
class GrantRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/shares/{sharedDriveItem%2Did}/permission/microsoft.graph.grant"
