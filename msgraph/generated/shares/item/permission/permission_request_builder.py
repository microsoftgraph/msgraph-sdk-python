...
class PermissionRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[PermissionRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[permission.Permission] = None, request_configuration: Optional[PermissionRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property permission in shares
        Args:
            body: The request body
