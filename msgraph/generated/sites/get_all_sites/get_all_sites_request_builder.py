...
class GetAllSitesRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetAllSitesRequestBuilder:
        """
    ...
    @dataclass
    class GetAllSitesRequestBuilderGetRequestConfiguration(RequestConfiguration[GetAllSitesRequestBuilderGetQueryParameters]):
        """
