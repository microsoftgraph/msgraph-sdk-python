...
add_copy_post_request_body = lazy_import('msgraph.generated.sites.item.content_types.add_copy.add_copy_post_request_body')
...
class AddCopyRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/contentTypes/microsoft.graph.addCopy"
