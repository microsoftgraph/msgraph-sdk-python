...
class GetByPathWithPath1RequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], path1: Optional[str] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getByPath(path='{path1}')", path_parameters)
    ...
    def with_url(self,raw_url: str) -> GetByPathWithPath1RequestBuilder:
        """
    ...
    @dataclass
    class GetByPathWithPath1RequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
