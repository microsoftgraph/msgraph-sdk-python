...
get_compatible_hub_content_types_response = lazy_import('msgraph.generated.sites.item.lists.item.content_types.get_compatible_hub_content_types.get_compatible_hub_content_types_response')
