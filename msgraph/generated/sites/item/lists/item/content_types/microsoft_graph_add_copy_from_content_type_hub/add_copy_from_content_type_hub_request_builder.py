...
add_copy_from_content_type_hub_post_request_body = lazy_import('msgraph.generated.sites.item.lists.item.content_types.microsoft_graph_add_copy_from_content_type_hub.add_copy_from_content_type_hub_post_request_body')
...
class AddCopyFromContentTypeHubRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/microsoft.graph.addCopyFromContentTypeHub"
