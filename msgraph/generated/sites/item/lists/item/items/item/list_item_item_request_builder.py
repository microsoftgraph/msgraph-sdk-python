...
get_activities_by_interval_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.items.item.microsoft_graph_get_activities_by_interval.get_activities_by_interval_request_builder')
