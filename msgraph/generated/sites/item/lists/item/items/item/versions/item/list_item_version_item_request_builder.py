...
microsoft_graph_restore_version_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.items.item.versions.item.microsoft_graph_restore_version.microsoft_graph_restore_version_request_builder')
