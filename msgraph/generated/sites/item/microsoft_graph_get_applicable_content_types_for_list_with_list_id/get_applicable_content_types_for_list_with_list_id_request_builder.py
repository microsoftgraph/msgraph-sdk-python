...
get_applicable_content_types_for_list_with_list_id_response = lazy_import('msgraph.generated.sites.item.microsoft_graph_get_applicable_content_types_for_list_with_list_id.get_applicable_content_types_for_list_with_list_id_response')
...
class GetApplicableContentTypesForListWithListIdRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, list_id: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/microsoft.graph.getApplicableContentTypesForList(listId='{listId}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
