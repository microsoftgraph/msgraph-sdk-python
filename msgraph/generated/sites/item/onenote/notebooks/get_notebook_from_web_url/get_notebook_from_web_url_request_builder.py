...
get_notebook_from_web_url_post_request_body = lazy_import('msgraph.generated.sites.item.onenote.notebooks.get_notebook_from_web_url.get_notebook_from_web_url_post_request_body')
...
class GetNotebookFromWebUrlRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/onenote/notebooks/microsoft.graph.getNotebookFromWebUrl"
