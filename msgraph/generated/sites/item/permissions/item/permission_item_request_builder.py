...
microsoft_graph_grant_request_builder = lazy_import('msgraph.generated.sites.item.permissions.item.microsoft_graph_grant.microsoft_graph_grant_request_builder')
