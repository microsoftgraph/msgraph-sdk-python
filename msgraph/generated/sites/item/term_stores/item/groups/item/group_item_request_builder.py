...
sets_request_builder = lazy_import('msgraph.generated.sites.item.term_stores.item.groups.item.sets.sets_request_builder')
set_item_request_builder = lazy_import('msgraph.generated.sites.item.term_stores.item.groups.item.sets.item.set_item_request_builder')
