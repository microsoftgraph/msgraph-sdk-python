...
class StoreItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[store.Store] = None, request_configuration: Optional[StoreItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property termStores in sites
        Args:
            body: The request body
