...
remove_post_request_body = lazy_import('msgraph.generated.sites.remove.remove_post_request_body')
remove_response = lazy_import('msgraph.generated.sites.remove.remove_response')
...
class RemoveRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/remove"
