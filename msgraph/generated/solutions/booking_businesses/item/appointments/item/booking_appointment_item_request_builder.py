...
microsoft_graph_cancel_request_builder = lazy_import('msgraph.generated.solutions.booking_businesses.item.appointments.item.microsoft_graph_cancel.microsoft_graph_cancel_request_builder')
