...
cancel_request_builder = lazy_import('msgraph.generated.solutions.booking_businesses.item.calendar_view.item.microsoft_graph_cancel.cancel_request_builder')
