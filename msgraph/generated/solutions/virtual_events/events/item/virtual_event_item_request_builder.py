...
class VirtualEventItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[VirtualEvent]:
        """
    ...
    async def patch(self,body: Optional[VirtualEvent] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[VirtualEvent]:
        """
    ...
    def to_patch_request_information(self,body: Optional[VirtualEvent] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property events in solutions
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
