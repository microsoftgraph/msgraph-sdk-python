...
if TYPE_CHECKING:
    ...
    from ......models.virtual_event_townhall_registration_configuration import VirtualEventTownhallRegistrationConfiguration
...
class RegistrationConfigurationRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/registrationConfiguration{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[RegistrationConfigurationRequestBuilderGetQueryParameters]] = None) -> Optional[VirtualEventTownhallRegistrationConfiguration]:
        """
        Read the properties and relationships of a virtualEventTownhallRegistrationConfiguration object.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[VirtualEventTownhallRegistrationConfiguration]
        ...
        return await self.request_adapter.send_async(request_info, VirtualEventTownhallRegistrationConfiguration, error_mapping)
    
    async def patch(self,body: VirtualEventTownhallRegistrationConfiguration, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[VirtualEventTownhallRegistrationConfiguration]:
        """
    ...
    def to_patch_request_information(self,body: VirtualEventTownhallRegistrationConfiguration, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property registrationConfiguration in solutions
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
