...
@dataclass
class DollarDePostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    fraction: Optional[Json] = None
    # The fractionalDollar property
    fractional_dollar: Optional[Json] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DollarDePostRequestBody:
        """
