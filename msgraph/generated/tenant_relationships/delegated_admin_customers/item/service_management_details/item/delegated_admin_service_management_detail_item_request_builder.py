...
class DelegatedAdminServiceManagementDetailItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[DelegatedAdminServiceManagementDetailItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    @dataclass
    class DelegatedAdminServiceManagementDetailItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class DelegatedAdminServiceManagementDetailItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
