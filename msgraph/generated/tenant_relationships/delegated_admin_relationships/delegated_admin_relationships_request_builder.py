...
class DelegatedAdminRelationshipsRequestBuilder(BaseRequestBuilder):
    ...
    def by_delegated_admin_relationship_id(self,delegated_admin_relationship_id: str) -> DelegatedAdminRelationshipItemRequestBuilder:
        ...
        Provides operations to manage the delegatedAdminRelationships property of the microsoft.graph.tenantRelationship entity.
        Args:
            delegated_admin_relationship_id: The unique identifier of delegatedAdminRelationship
    ...
    class DelegatedAdminRelationshipsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[DelegatedAdminRelationshipsRequestBuilderGetQueryParameters] = None
