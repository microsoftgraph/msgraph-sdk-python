...
if TYPE_CHECKING:
    from ......models import delegated_admin_relationship_operation
...
class DelegatedAdminRelationshipOperationItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[DelegatedAdminRelationshipOperationItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[DelegatedAdminRelationshipOperationItemRequestBuilderGetRequestConfiguration] = None) -> Optional[delegated_admin_relationship_operation.DelegatedAdminRelationshipOperation]:
        ...
        return await self.request_adapter.send_async(request_info, delegated_admin_relationship_operation.DelegatedAdminRelationshipOperation, error_mapping)
    
    async def patch(self,body: Optional[delegated_admin_relationship_operation.DelegatedAdminRelationshipOperation] = None, request_configuration: Optional[DelegatedAdminRelationshipOperationItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[delegated_admin_relationship_operation.DelegatedAdminRelationshipOperation]:
        """
    ...
    def to_patch_request_information(self,body: Optional[delegated_admin_relationship_operation.DelegatedAdminRelationshipOperation] = None, request_configuration: Optional[DelegatedAdminRelationshipOperationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property operations in tenantRelationships
        Args:
            body: The request body
