...
email_methods_request_builder = lazy_import('msgraph.generated.users.item.authentication.email_methods.email_methods_request_builder')
email_authentication_method_item_request_builder = lazy_import('msgraph.generated.users.item.authentication.email_methods.item.email_authentication_method_item_request_builder')
fido2_methods_request_builder = lazy_import('msgraph.generated.users.item.authentication.fido2_methods.fido2_methods_request_builder')
fido2_authentication_method_item_request_builder = lazy_import('msgraph.generated.users.item.authentication.fido2_methods.item.fido2_authentication_method_item_request_builder')
methods_request_builder = lazy_import('msgraph.generated.users.item.authentication.methods.methods_request_builder')
authentication_method_item_request_builder = lazy_import('msgraph.generated.users.item.authentication.methods.item.authentication_method_item_request_builder')
microsoft_authenticator_methods_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.microsoft_authenticator_methods_request_builder')
microsoft_authenticator_authentication_method_item_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.microsoft_authenticator_authentication_method_item_request_builder')
operations_request_builder = lazy_import('msgraph.generated.users.item.authentication.operations.operations_request_builder')
long_running_operation_item_request_builder = lazy_import('msgraph.generated.users.item.authentication.operations.item.long_running_operation_item_request_builder')
password_methods_request_builder = lazy_import('msgraph.generated.users.item.authentication.password_methods.password_methods_request_builder')
password_authentication_method_item_request_builder = lazy_import('msgraph.generated.users.item.authentication.password_methods.item.password_authentication_method_item_request_builder')
phone_methods_request_builder = lazy_import('msgraph.generated.users.item.authentication.phone_methods.phone_methods_request_builder')
phone_authentication_method_item_request_builder = lazy_import('msgraph.generated.users.item.authentication.phone_methods.item.phone_authentication_method_item_request_builder')
software_oath_methods_request_builder = lazy_import('msgraph.generated.users.item.authentication.software_oath_methods.software_oath_methods_request_builder')
software_oath_authentication_method_item_request_builder = lazy_import('msgraph.generated.users.item.authentication.software_oath_methods.item.software_oath_authentication_method_item_request_builder')
temporary_access_pass_methods_request_builder = lazy_import('msgraph.generated.users.item.authentication.temporary_access_pass_methods.temporary_access_pass_methods_request_builder')
temporary_access_pass_authentication_method_item_request_builder = lazy_import('msgraph.generated.users.item.authentication.temporary_access_pass_methods.item.temporary_access_pass_authentication_method_item_request_builder')
windows_hello_for_business_methods_request_builder = lazy_import('msgraph.generated.users.item.authentication.windows_hello_for_business_methods.windows_hello_for_business_methods_request_builder')
windows_hello_for_business_authentication_method_item_request_builder = lazy_import('msgraph.generated.users.item.authentication.windows_hello_for_business_methods.item.windows_hello_for_business_authentication_method_item_request_builder')
