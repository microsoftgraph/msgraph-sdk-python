...
if TYPE_CHECKING:
    ...
    from .creation_options.creation_options_request_builder import CreationOptionsRequestBuilder
...
class Fido2MethodsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/authentication/fido2Methods{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_fido2_authentication_method_id(self,fido2_authentication_method_id: str) -> Fido2AuthenticationMethodItemRequestBuilder:
        """
        Provides operations to manage the fido2Methods property of the microsoft.graph.authentication entity.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[Fido2MethodsRequestBuilderGetQueryParameters]] = None) -> Optional[Fido2AuthenticationMethodCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[Fido2MethodsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Represents the FIDO2 security keys registered to a user for authentication.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> Fido2MethodsRequestBuilder:
        """
    ...
    @property
    def creation_options(self) -> CreationOptionsRequestBuilder:
        """
        Provides operations to call the creationOptions method.
        """
        from .creation_options.creation_options_request_builder import CreationOptionsRequestBuilder

        return CreationOptionsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @dataclass
    class Fido2MethodsRequestBuilderGetRequestConfiguration(RequestConfiguration[Fido2MethodsRequestBuilderGetQueryParameters]):
        """
