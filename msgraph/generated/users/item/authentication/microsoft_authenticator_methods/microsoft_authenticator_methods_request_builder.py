...
class MicrosoftAuthenticatorMethodsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/authentication/microsoftAuthenticatorMethods{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MicrosoftAuthenticatorMethodsRequestBuilderGetQueryParameters]] = None) -> Optional[MicrosoftAuthenticatorAuthenticationMethodCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[MicrosoftAuthenticatorMethodsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of the microsoftAuthenticatorAuthenticationMethod objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> MicrosoftAuthenticatorMethodsRequestBuilder:
        """
        ...
        return MicrosoftAuthenticatorMethodsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class MicrosoftAuthenticatorMethodsRequestBuilderGetRequestConfiguration(RequestConfiguration[MicrosoftAuthenticatorMethodsRequestBuilderGetQueryParameters]):
        """
