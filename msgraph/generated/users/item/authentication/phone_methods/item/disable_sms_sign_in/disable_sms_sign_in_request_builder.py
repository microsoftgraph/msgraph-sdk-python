...
class DisableSmsSignInRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> DisableSmsSignInRequestBuilder:
        """
    ...
    @dataclass
    class DisableSmsSignInRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
