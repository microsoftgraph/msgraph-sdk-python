...
microsoft_graph_disable_sms_sign_in_request_builder = lazy_import('msgraph.generated.users.item.authentication.phone_methods.item.microsoft_graph_disable_sms_sign_in.microsoft_graph_disable_sms_sign_in_request_builder')
microsoft_graph_enable_sms_sign_in_request_builder = lazy_import('msgraph.generated.users.item.authentication.phone_methods.item.microsoft_graph_enable_sms_sign_in.microsoft_graph_enable_sms_sign_in_request_builder')
...
class PhoneAuthenticationMethodItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/authentication/phoneMethods/{phoneAuthenticationMethod%2Did}{?%24select,%24expand}"
