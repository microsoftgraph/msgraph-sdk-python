...
check_member_objects_post_request_body = lazy_import('msgraph.generated.users.item.authentication.windows_hello_for_business_methods.item.device.check_member_objects.check_member_objects_post_request_body')
check_member_objects_response = lazy_import('msgraph.generated.users.item.authentication.windows_hello_for_business_methods.item.device.check_member_objects.check_member_objects_response')
