...
app_role_assignment_request_builder = lazy_import('msgraph.generated.users.item.authentication.windows_hello_for_business_methods.item.device.registered_users.app_role_assignment.app_role_assignment_request_builder')
