...
snooze_reminder_post_request_body = lazy_import('msgraph.generated.users.item.calendar.events.item.microsoft_graph_snooze_reminder.snooze_reminder_post_request_body')
