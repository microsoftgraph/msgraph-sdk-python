...
if TYPE_CHECKING:
    ...
    from .allowed_calendar_sharing_roles_with_user_response import AllowedCalendarSharingRolesWithUserResponse
...
class AllowedCalendarSharingRolesWithUserRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, user: Optional[str] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/allowedCalendarSharingRoles(User='{User}'){?%24top,%24skip,%24search,%24filter,%24count}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[AllowedCalendarSharingRolesWithUserRequestBuilderGetRequestConfiguration] = None) -> Optional[AllowedCalendarSharingRolesWithUserResponse]:
        ...
        return await self.request_adapter.send_async(request_info, AllowedCalendarSharingRolesWithUserResponse, error_mapping)
    ...
    @dataclass
    class AllowedCalendarSharingRolesWithUserRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
