...
accept_post_request_body = lazy_import('msgraph.generated.users.item.calendar_groups.item.calendars.item.events.item.microsoft_graph_accept.accept_post_request_body')
