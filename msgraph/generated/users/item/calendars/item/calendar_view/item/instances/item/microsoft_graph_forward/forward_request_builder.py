...
forward_post_request_body = lazy_import('msgraph.generated.users.item.calendars.item.calendar_view.item.instances.item.microsoft_graph_forward.forward_post_request_body')
