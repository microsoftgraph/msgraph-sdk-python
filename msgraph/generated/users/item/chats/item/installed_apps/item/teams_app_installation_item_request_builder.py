...
microsoft_graph_upgrade_request_builder = lazy_import('msgraph.generated.users.item.chats.item.installed_apps.item.microsoft_graph_upgrade.microsoft_graph_upgrade_request_builder')
teams_app_request_builder = lazy_import('msgraph.generated.users.item.chats.item.installed_apps.item.teams_app.teams_app_request_builder')
teams_app_definition_request_builder = lazy_import('msgraph.generated.users.item.chats.item.installed_apps.item.teams_app_definition.teams_app_definition_request_builder')
...
class TeamsAppInstallationItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_upgrade(self) -> microsoft_graph_upgrade_request_builder.MicrosoftGraphUpgradeRequestBuilder:
        """
        Provides operations to call the upgrade method.
        """
        return microsoft_graph_upgrade_request_builder.MicrosoftGraphUpgradeRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/installedApps/{teamsAppInstallation%2Did}{?%24select,%24expand}"
