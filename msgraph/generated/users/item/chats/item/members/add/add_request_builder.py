...
add_post_request_body = lazy_import('msgraph.generated.users.item.chats.item.members.add.add_post_request_body')
add_response = lazy_import('msgraph.generated.users.item.chats.item.members.add.add_response')
