...
send_activity_notification_post_request_body = lazy_import('msgraph.generated.users.item.chats.item.send_activity_notification.send_activity_notification_post_request_body')
...
class SendActivityNotificationRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/sendActivityNotification"
