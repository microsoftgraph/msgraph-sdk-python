...
delta_request_builder = lazy_import('msgraph.generated.users.item.contact_folders.item.child_folders.item.contacts.microsoft_graph_delta.delta_request_builder')
