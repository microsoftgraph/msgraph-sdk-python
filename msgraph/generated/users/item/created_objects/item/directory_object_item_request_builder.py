...
service_principal_request_builder = lazy_import('msgraph.generated.users.item.created_objects.item.microsoft_graph_service_principal.service_principal_request_builder')
