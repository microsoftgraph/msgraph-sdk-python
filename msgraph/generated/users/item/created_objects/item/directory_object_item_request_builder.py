...
graph_service_principal_request_builder = lazy_import('msgraph.generated.users.item.created_objects.item.graph_service_principal.graph_service_principal_request_builder')
