...
graph_org_contact_request_builder = lazy_import('msgraph.generated.users.item.direct_reports.graph_org_contact.graph_org_contact_request_builder')
graph_user_request_builder = lazy_import('msgraph.generated.users.item.direct_reports.graph_user.graph_user_request_builder')
...
class DirectReportsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/directReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
