...
graph_org_contact_request_builder = lazy_import('msgraph.generated.users.item.direct_reports.item.graph_org_contact.graph_org_contact_request_builder')
graph_user_request_builder = lazy_import('msgraph.generated.users.item.direct_reports.item.graph_user.graph_user_request_builder')
