...
content_request_builder = lazy_import('msgraph.generated.users.item.drives.item.bundles.item.content.content_request_builder')
...
class DriveItemItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/bundles/{driveItem%2Did}{?%24select,%24expand}"
