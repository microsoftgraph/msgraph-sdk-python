...
validate_permission_post_request_body = lazy_import('msgraph.generated.users.item.drives.item.root.validate_permission.validate_permission_post_request_body')
