...
class LearningCourseActivitiesWithExternalcourseActivityIdReq_93f96b28(BaseRequestBuilder):
    """
    Provides operations to manage the learningCourseActivities property of the microsoft.graph.employeeExperienceUser entity. Original name: LearningCourseActivitiesWithExternalcourseActivityIdRequestBuilder
    """
