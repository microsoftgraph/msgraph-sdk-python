...
export_personal_data_post_request_body = lazy_import('msgraph.generated.users.item.export_personal_data.export_personal_data_post_request_body')
...
class ExportPersonalDataRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/microsoft.graph.exportPersonalData"
