...
if TYPE_CHECKING:
    from ....models.reference_numeric import ReferenceNumeric

@dataclass
class FindMeetingTimesPostRequestBody_minimumAttendeePercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FindMeetingTimesPostRequestBody_minimumAttendeePercentage:
        """
        ...
        try:
            ...
            mapping_value = None
        result = FindMeetingTimesPostRequestBody_minimumAttendeePercentage()
