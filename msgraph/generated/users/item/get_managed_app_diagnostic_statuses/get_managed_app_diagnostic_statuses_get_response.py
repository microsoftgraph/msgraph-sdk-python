...
@dataclass
class GetManagedAppDiagnosticStatusesGetResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[ManagedAppDiagnosticStatus]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetManagedAppDiagnosticStatusesGetResponse:
        """
