...
@dataclass
class GetManagedAppDiagnosticStatusesGetResponse(BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[ManagedAppDiagnosticStatus]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetManagedAppDiagnosticStatusesGetResponse:
        """
        ...
        return GetManagedAppDiagnosticStatusesGetResponse()
