...
class GetManagedAppPoliciesRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetManagedAppPoliciesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetManagedAppPoliciesRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return GetManagedAppPoliciesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class GetManagedAppPoliciesRequestBuilderGetRequestConfiguration(RequestConfiguration[GetManagedAppPoliciesRequestBuilderGetQueryParameters]):
        """
