...
class GetManagedDevicesWithAppFailuresRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[GetManagedDevicesWithAppFailuresGetResponse]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetManagedDevicesWithAppFailuresRequestBuilder:
        """
