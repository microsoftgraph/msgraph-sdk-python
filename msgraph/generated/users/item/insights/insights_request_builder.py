...
class InsightsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[OfficeGraphInsights]:
        """
    ...
    async def patch(self,body: Optional[OfficeGraphInsights] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[OfficeGraphInsights]:
        """
    ...
    def to_patch_request_information(self,body: Optional[OfficeGraphInsights] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property insights in users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
