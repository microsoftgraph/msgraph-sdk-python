...
class ResourceRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[ResourceRequestBuilderGetRequestConfiguration] = None) -> Optional[entity.Entity]:
        """
        ...
        return await self.request_adapter.send_async(request_info, entity.Entity, error_mapping)
