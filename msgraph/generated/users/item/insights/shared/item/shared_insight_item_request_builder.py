...
last_shared_method_request_builder = lazy_import('msgraph.generated.users.item.insights.shared.item.last_shared_method.last_shared_method_request_builder')
resource_request_builder = lazy_import('msgraph.generated.users.item.insights.shared.item.resource.resource_request_builder')
