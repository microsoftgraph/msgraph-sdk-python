...
class TrendingItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, trending_id: Optional[str] = None) -> None:
        """
        Instantiates a new TrendingItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            trendingId: key: id of trending
        """
        ...
        url_tpl_params["trending%2Did"] = trendingId
