...
class UsedInsightItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, used_insight_id: Optional[str] = None) -> None:
        """
        Instantiates a new UsedInsightItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            usedInsightId: key: id of usedInsight
        """
        ...
        url_tpl_params["usedInsight%2Did"] = usedInsightId
