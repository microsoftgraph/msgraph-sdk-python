...
get_all_messages_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.channels.microsoft_graph_get_all_messages.get_all_messages_request_builder')
