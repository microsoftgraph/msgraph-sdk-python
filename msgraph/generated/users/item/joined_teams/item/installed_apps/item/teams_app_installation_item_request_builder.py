...
microsoft_graph_upgrade_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.installed_apps.item.microsoft_graph_upgrade.microsoft_graph_upgrade_request_builder')
