...
clone_post_request_body = lazy_import('msgraph.generated.users.item.joined_teams.item.microsoft_graph_clone.clone_post_request_body')
...
class CloneRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/microsoft.graph.clone"
