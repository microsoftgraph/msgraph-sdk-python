...
soft_delete_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.primary_channel.messages.item.soft_delete.soft_delete_request_builder')
undo_soft_delete_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.primary_channel.messages.item.undo_soft_delete.undo_soft_delete_request_builder')
