...
open_shift_change_request_item_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.open_shift_change_requests.item.open_shift_change_request_item_request_builder')
open_shifts_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.open_shifts.open_shifts_request_builder')
open_shift_item_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.open_shifts.item.open_shift_item_request_builder')
scheduling_groups_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.scheduling_groups.scheduling_groups_request_builder')
scheduling_group_item_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.scheduling_groups.item.scheduling_group_item_request_builder')
share_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.share.share_request_builder')
shifts_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.shifts.shifts_request_builder')
shift_item_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.shifts.item.shift_item_request_builder')
swap_shifts_change_requests_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.swap_shifts_change_requests.swap_shifts_change_requests_request_builder')
swap_shifts_change_request_item_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.swap_shifts_change_requests.item.swap_shifts_change_request_item_request_builder')
time_off_reasons_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.time_off_reasons.time_off_reasons_request_builder')
time_off_reason_item_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.time_off_reasons.item.time_off_reason_item_request_builder')
time_off_requests_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.time_off_requests.time_off_requests_request_builder')
time_off_request_item_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.time_off_requests.item.time_off_request_item_request_builder')
times_off_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.times_off.times_off_request_builder')
time_off_item_request_builder = lazy_import('msgraph.generated.users.item.joined_teams.item.schedule.times_off.item.time_off_item_request_builder')
