...
move_post_request_body = lazy_import('msgraph.generated.users.item.mail_folders.item.child_folders.item.messages.item.microsoft_graph_move.move_post_request_body')
