...
move_post_request_body = lazy_import('msgraph.generated.users.item.mail_folders.item.move.move_post_request_body')
...
class MoveRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/move"
