...
class MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder():
    """
    ...
    async def get(self,request_configuration: Optional[MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration] = None) -> Optional[device_and_app_management_data.DeviceAndAppManagementData]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke function exportDeviceAndAppManagementData
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration():
        """
