...
class GetManagedAppDiagnosticStatusesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[GetManagedAppDiagnosticStatusesRequestBuilderGetRequestConfiguration] = None) -> Optional[get_managed_app_diagnostic_statuses_response.GetManagedAppDiagnosticStatusesResponse]:
        """
