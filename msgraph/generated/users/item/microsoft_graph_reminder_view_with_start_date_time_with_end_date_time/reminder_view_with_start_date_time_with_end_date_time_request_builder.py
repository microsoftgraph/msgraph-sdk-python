...
reminder_view_with_start_date_time_with_end_date_time_response = lazy_import('msgraph.generated.users.item.microsoft_graph_reminder_view_with_start_date_time_with_end_date_time.reminder_view_with_start_date_time_with_end_date_time_response')
...
class ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration] = None) -> Optional[reminder_view_with_start_date_time_with_end_date_time_response.ReminderViewWithStartDateTimeWithEndDateTimeResponse]:
        """
