...
copy_to_notebook_post_request_body = lazy_import('msgraph.generated.users.item.onenote.notebooks.item.section_groups.item.sections.item.microsoft_graph_copy_to_notebook.copy_to_notebook_post_request_body')
