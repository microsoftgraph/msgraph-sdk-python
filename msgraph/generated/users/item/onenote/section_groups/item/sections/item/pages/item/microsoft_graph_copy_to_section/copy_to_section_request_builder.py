...
copy_to_section_post_request_body = lazy_import('msgraph.generated.users.item.onenote.section_groups.item.sections.item.pages.item.microsoft_graph_copy_to_section.copy_to_section_post_request_body')
