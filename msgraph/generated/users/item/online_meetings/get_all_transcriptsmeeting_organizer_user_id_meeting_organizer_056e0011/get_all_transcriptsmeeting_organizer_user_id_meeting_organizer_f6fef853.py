...
if TYPE_CHECKING:
    ...
    from .get_all_transcriptsmeeting_organizer_user_id_meeting_organizer_561b408a import GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_561b408a

class GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_f6fef853(BaseRequestBuilder):
    """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizerUserIdWithStartDateTimeWithEndDateTimeRequestBuilderGetQueryParameters]] = None) -> Optional[GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_561b408a]:
        """
        ...
        Returns: Optional[GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_561b408a]
        ...
        return await self.request_adapter.send_async(request_info, GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_561b408a, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_f6fef853:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_f6fef853
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizer_f6fef853(self.request_adapter, raw_url)
