...
class OutlookCategoryItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, outlook_category_id: Optional[str] = None) -> None:
        """
        ...
        url_tpl_params["outlookCategory%2Did"] = outlookCategoryId
    ...
    async def get(self,request_configuration: Optional[OutlookCategoryItemRequestBuilderGetRequestConfiguration] = None) -> Optional[outlook_category.OutlookCategory]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_async(request_info, outlook_category.OutlookCategory, error_mapping)
