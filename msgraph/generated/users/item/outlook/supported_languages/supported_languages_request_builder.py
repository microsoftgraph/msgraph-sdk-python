...
supported_languages_response = lazy_import('msgraph.generated.users.item.outlook.supported_languages.supported_languages_response')
...
class SupportedLanguagesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/outlook/supportedLanguages(){?%24top,%24skip,%24search,%24filter,%24count}"
