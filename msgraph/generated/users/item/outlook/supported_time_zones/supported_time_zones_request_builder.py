...
supported_time_zones_response = lazy_import('msgraph.generated.users.item.outlook.supported_time_zones.supported_time_zones_response')
...
class SupportedTimeZonesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[SupportedTimeZonesRequestBuilderGetRequestConfiguration] = None) -> Optional[supported_time_zones_response.SupportedTimeZonesResponse]:
        """
