...
class SupportedTimeZonesWithTimeZoneStandardRequestBuilder(BaseRequestBuilder):
    ...
    @dataclass
    class SupportedTimeZonesWithTimeZoneStandardRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[SupportedTimeZonesWithTimeZoneStandardRequestBuilderGetQueryParameters] = None
