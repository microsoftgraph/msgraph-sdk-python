...
app_role_assignment_request_builder = lazy_import('msgraph.generated.users.item.owned_devices.item.microsoft_graph_app_role_assignment.app_role_assignment_request_builder')
device_request_builder = lazy_import('msgraph.generated.users.item.owned_devices.item.microsoft_graph_device.device_request_builder')
endpoint_request_builder = lazy_import('msgraph.generated.users.item.owned_devices.item.microsoft_graph_endpoint.endpoint_request_builder')
