...
class PersonItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/people/{person%2Did}{?%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[PersonItemRequestBuilderGetRequestConfiguration] = None) -> Optional[Person]:
        ...
        return await self.request_adapter.send_async(request_info, Person, error_mapping)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> PersonItemRequestBuilder:
        ...
        return PersonItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class PersonItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
