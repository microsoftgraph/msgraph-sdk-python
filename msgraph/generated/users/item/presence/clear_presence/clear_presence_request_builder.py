...
clear_presence_post_request_body = lazy_import('msgraph.generated.users.item.presence.clear_presence.clear_presence_post_request_body')
...
class ClearPresenceRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/presence/microsoft.graph.clearPresence"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,body: Optional[clear_presence_post_request_body.ClearPresencePostRequestBody] = None, request_configuration: Optional[ClearPresenceRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
