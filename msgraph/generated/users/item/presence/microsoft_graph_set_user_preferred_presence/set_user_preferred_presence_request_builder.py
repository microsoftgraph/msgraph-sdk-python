...
set_user_preferred_presence_post_request_body = lazy_import('msgraph.generated.users.item.presence.microsoft_graph_set_user_preferred_presence.set_user_preferred_presence_post_request_body')
