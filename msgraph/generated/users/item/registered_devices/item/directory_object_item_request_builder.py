...
app_role_assignment_request_builder = lazy_import('msgraph.generated.users.item.registered_devices.item.app_role_assignment.app_role_assignment_request_builder')
