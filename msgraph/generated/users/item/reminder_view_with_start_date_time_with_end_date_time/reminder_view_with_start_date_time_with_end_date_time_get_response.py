...
@dataclass
class ReminderViewWithStartDateTimeWithEndDateTimeGetResponse(BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[Reminder]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ReminderViewWithStartDateTimeWithEndDateTimeGetResponse:
        """
