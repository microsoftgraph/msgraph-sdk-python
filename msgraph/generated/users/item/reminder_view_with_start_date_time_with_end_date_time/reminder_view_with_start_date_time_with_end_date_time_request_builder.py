...
class ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder(BaseRequestBuilder):
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], end_date_time: Optional[str] = None, start_date_time: Optional[str] = None) -> None:
        """
    ...
    def with_url(self,raw_url: str) -> ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder:
        """
    ...
    @dataclass
    class ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration(RequestConfiguration[ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilderGetQueryParameters]):
        """
