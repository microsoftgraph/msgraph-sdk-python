...
if TYPE_CHECKING:
    from ....models import base_collection_pagination_count_response, reminder
...
class ReminderViewWithStartDateTimeWithEndDateTimeResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[reminder.Reminder]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(reminder.Reminder)),
        }
    ...
    @property
    def value(self,) -> Optional[List[reminder.Reminder]]:
        """
        Gets the value property value. The value property
        Returns: Optional[List[reminder.Reminder]]
        """
        return self._value
    
    @value.setter
    def value(self,value: Optional[List[reminder.Reminder]] = None) -> None:
        """
