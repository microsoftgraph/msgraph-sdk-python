...
class ShiftPreferencesRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[ShiftPreferencesRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[ShiftPreferencesRequestBuilderGetRequestConfiguration] = None) -> Optional[shift_preferences.ShiftPreferences]:
        ...
        return await self.request_adapter.send_async(request_info, shift_preferences.ShiftPreferences, error_mapping)
