...
class AssociatedTeamInfoItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, associated_team_info_id: Optional[str] = None) -> None:
        """
        Instantiates a new AssociatedTeamInfoItemRequestBuilder and sets the default values.
        Args:
            associatedTeamInfoId: key: id of associatedTeamInfo
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/teamwork/associatedTeams/{associatedTeamInfo%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["associatedTeamInfo%2Did"] = associatedTeamInfoId
