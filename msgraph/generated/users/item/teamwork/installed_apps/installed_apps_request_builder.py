...
class InstalledAppsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/teamwork/installedApps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_user_scope_teams_app_installation_id(self,user_scope_teams_app_installation_id: str) -> UserScopeTeamsAppInstallationItemRequestBuilder:
        ...
        Provides operations to manage the installedApps property of the microsoft.graph.userTeamwork entity.
        Args:
            user_scope_teams_app_installation_id: The unique identifier of userScopeTeamsAppInstallation
