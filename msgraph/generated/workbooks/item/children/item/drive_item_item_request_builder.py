...
content_request_builder = lazy_import('msgraph.generated.workbooks.item.children.item.content.content_request_builder')
...
class DriveItemItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/workbooks/{driveItem%2Did}/children/{driveItem%2Did1}{?%24select,%24expand}"
